...
for rel in ["SKILL.md", "references/stage2_shadow_payroll_acceptance.md", "scripts/month_gate.py", "scripts/stage2_consensus_gate.py", "scripts/write_stage2_run_artifacts.py", "scripts/validate_database_contract.py", "scripts/resolve_stage2_source.py", "scripts/prepare_database_landing_bundle.py", "scripts/prepare_postgres_landing_loader.py", "scripts/validate_postgres_load_plan.py"]:
