...
| `PYTHONDONTWRITEBYTECODE=1 python3 -m unittest KMFA.tests.test_s05_p2_owner_decision_application -q` | PASS: Ran 4 tests; OK |
| `PYTHONDONTWRITEBYTECODE=1 python3 KMFA/tools/preview_s05_p2_owner_decision_application.py --output KMFA/stage_artifacts/S05_P2_a0_golden_fixture/machine/no_owner_decision_application_preview.json` | BLOCKED_EXPECTED: application_status=blocked, blocker=no_owner_or_authorized_decision_supplied, decision_code=none |
| `python3 -m json.tool KMFA/stage_artifacts/S05_P2_a0_golden_fixture/machine/no_owner_decision_application_preview.json >/dev/null` | PASS: parseable JSON |
| `python3 -m json.tool KMFA/stage_artifacts/S05_P2_a0_golden_fixture/machine/owner_decision_records/excel_owner_resolution_decision.json >/dev/null` | PASS: parseable JSON |
| `PYTHONDONTWRITEBYTECODE=1 python3 KMFA/tools/check_s05_p2_owner_decision_intake.py --decision KMFA/stage_artifacts/S05_P2_a0_golden_fixture/machine/owner_decision_records/excel_owner_resolution_decision.json` | PASS: validated_public_safe, decision_code=downgrade_to_cross_source_support |
...
| `PYTHONDONTWRITEBYTECODE=1 python3 -m unittest KMFA.tests.test_a0_golden_fixture KMFA.tests.test_s05_p2_excel_owner_decision KMFA.tests.test_s05_p2_owner_decision_intake KMFA.tests.test_s05_p2_owner_decision_templates KMFA.tests.test_s05_p2_completion_gate KMFA.tests.test_s05_p2_owner_decision_application KMFA.tests.test_a0_file_register KMFA.tests.test_file_import_register KMFA.tests.test_source_check_matrix KMFA.tests.test_source_priority KMFA.tests.test_amount_tools KMFA.tests.test_field_standardization KMFA.tests.test_basic_tool_boundaries -q` | PASS: Ran 49 tests; OK |
...
| `PYTHONDONTWRITEBYTECODE=1 python3 KMFA/tools/no_omission_check.py` | PASS: requirements=20, P0=9, P1=8, status_records=286, tasks=162, v1.2_html=45+ |
...
- Excel owner decision packet 定义允许决策和所需证据，并已有专门 validator 覆盖；不等同于 Q4/Q5 确认。
- Excel owner decision intake contract 验证决策记录格式、actor role、禁止明文键和 Q4/Q5 边界；active owner/授权降级决策已通过 validator。
