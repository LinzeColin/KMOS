...
| `PYTHONDONTWRITEBYTECODE=1 python3 KMFA/tools/no_omission_check.py` | PASS: requirements=20, P0=9, P1=8, status_records=281, tasks=162, v1.2_html=45+ |
...
- Excel owner decision application preview 只预演未来 active decision 的 public-safe 应用路径；当前 no-decision preview 返回 blocked，不完成 S05-P2。
