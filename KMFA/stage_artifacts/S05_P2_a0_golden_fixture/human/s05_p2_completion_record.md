...
- Excel 候选待决策状态: `awaiting_owner_or_authorized_decision`，且 owner decision packet、intake 和 template validators 已通过。

## 风险

- 当前回填、owner 决策包和 owner 决策模板都不是正式 A0 golden fixture 锁定；仍有 5 条 Excel 字段 pending，且未做 Q4 人工确认。
