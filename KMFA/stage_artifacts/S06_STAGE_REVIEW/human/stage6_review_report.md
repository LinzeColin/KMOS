...
- reviewed_head: `c66c8b44c17ae760a5a6da4b98ab5892d90d73d0`
- review_evidence_commit_before_upload_gate: `5cd284e500fec5ff215741b0e8ee164912f50268`
...
复审后下一门禁原为 `KMFA-S06-FINAL-GITHUB-UPLOAD-GATE`。该上传门禁已在 Stage 6 upload step 完成；当前下一门禁为 `KMFA-S07-P1-GATE`。

## Upload Gate Rebase Binding

Stage 6 upload gate 已在 `2026-06-30` 将 S06 review 栈 rebase 到 `origin/main` commit `fd14057e7427d7f275fdb62a33619936618d0d35`。本复审报告中的 `reviewed_head` 已从 rebase 前 S06-P3 commit 更新为 rebase 后 S06-P3 commit `c66c8b44c17ae760a5a6da4b98ab5892d90d73d0`；上传门禁证据记录在 `KMFA/stage_artifacts/S06_STAGE_REVIEW/human/github_upload_record.md` 和 `KMFA/stage_artifacts/S06_STAGE_REVIEW/machine/stage6_upload_manifest.json`。
