...
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_processed_value_source_map_completion_owner_group_decision_blocker_audit.py --generated-at 2026-07-06T00:00:00+10:00`
...
Result: PASS. Decision remains `NO_GO`; blocked audit threshold is met; no raw inbox access, response-template mutation, active authorization, source-map reapplication, raw-to-processed comparison, GitHub upload, app reinstall or business execution was performed.
