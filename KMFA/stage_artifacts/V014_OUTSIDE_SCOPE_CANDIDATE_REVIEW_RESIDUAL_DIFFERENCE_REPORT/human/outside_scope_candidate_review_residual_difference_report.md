# Outside-Scope Candidate Review Residual Difference Report

- phase_id: `V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_REPORT`
- decision: `NO_GO`
- source open closure blockers: `72`
- source closed discrepancies: `0`
- residual difference report items: `72`
- open residual differences: `72`
- closed discrepancies: `0`
- ambiguous selection required: `24`
- authoritative source reference required: `40`
- formula or non-numeric mapping required: `8`
