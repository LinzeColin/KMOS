...
- reviewed_head: `5f9504726f60e13ab558d18d7650db0671ebb27e`
...
`KMFA-S05-FINAL-GITHUB-UPLOAD-GATE`: 从项目级 KMFA worktree 或明确的 sparse upload worktree 对齐最新 `origin/main`，纳入本复审提交，复跑 Stage 5 validator 与治理检查，通过后上传 GitHub main 并生成 `github_upload_record.md` / upload manifest。
