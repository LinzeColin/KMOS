...
- CSV shape check: PASS, row_count 1224, widths [34].
- Diff whitespace check, raw-source marker scan, secret scan and ignored-runtime tracked-file scan: PASS, no matches.
