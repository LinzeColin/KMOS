...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-post-s18-whole-project-review-local` |
| 当前 Stage | `S18｜回归、压力、稳定验收与后续接入准备` |
| 当前 Phase | `Post-S18 Whole Project Final Review｜本地复审通过且 delivery NO_GO` |
| 当前 Task | `KMFA-WHOLE-PROJECT-FINAL-REVIEW-20260702` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15、Stage 16、Stage 17 和 Stage 18 均已完成三个 Phase、整体复审和 GitHub upload；Post-S18 Part 1-6 已完成本地复审；Post-S18 Whole Project Final Review 已完成本地复审和 findings 修复，但当前 Go/No-Go 仍为 `NO_GO`，`delivery_allowed=false`；lineage full check、正式报告、GitHub final upload/backup/cleanup 和业务执行仍不得跳过门禁 |
