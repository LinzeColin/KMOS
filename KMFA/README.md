...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s07p2-wps-file-adapter` |
| 当前 Stage | `S07｜文件型源适配与字段映射` |
| 当前 Phase | `S07-P3｜红圈导出后置策略 待开始` |
| 当前 Task | `KMFA-S07-P3-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5 和 Stage 6 均已完成三个 Phase、整体复审和 GitHub upload；S07-P1 和 S07-P2 已本地验证完成，下一步只执行 `S07-P3｜红圈导出后置策略` |
