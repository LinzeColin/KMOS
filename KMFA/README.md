...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s13p1-financial-operating-report` |
| 当前 Stage | `S13｜财务经营报表与回款应收扩展` |
| 当前 Phase | `S13-P2｜待开始` |
| 当前 Task | `S13PBT01-S13PBT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11 和 Stage 12 均已完成三个 Phase、整体复审和 GitHub upload；S13-P1 已本地完成，下一步只能在新 run work 中执行 S13-P2 |
