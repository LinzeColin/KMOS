...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14 和 Stage 15 均已完成三个 Phase、整体复审和 GitHub upload；S16-P1/S16-P2/S16-P3 和 Stage 16 整体复审已完成本地验证但未上传；下一步只能执行 Stage 16 GitHub upload |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14 和 Stage 15 均已完成整体复审和 GitHub upload；Stage 15 upload 证据位于 `KMFA/stage_artifacts/S15_GITHUB_UPLOAD/`。S15-P1 已完成 public-safe 绩效事实字段，S15-P2 已完成 public-safe 绩效事实表和异常项目复核事项清单，S15-P3 已完成 public-safe 事实接口预留和工资项目边界锁定，Stage 15 整体复审和 final GitHub upload 已完成。S16-P1 已完成 public-safe 外协采购归集：4 条来源线、5 条项目匹配、2 条未归集成本池记录、2 条重复付款候选和 2 条跨项目费用候选，证据位于 `KMFA/stage_artifacts/S16_P1_subcontract_procurement_aggregation/`。S16-P2 已完成 public-safe 项目状态生命周期：6 条状态来源线、4 条生命周期记录、3 条异常事项和 3 条人工 handoff guard，证据位于 `KMFA/stage_artifacts/S16_P2_project_status_lifecycle/`。S16-P3 已完成 public-safe 客户经营分析：5 条来源线、4 条客户经营摘要和 4 条异常复核事项，证据位于 `KMFA/stage_artifacts/S16_P3_customer_business_analysis/`。Stage 16 整体复审已本地通过，证据位于 `KMFA/stage_artifacts/S16_STAGE_REVIEW/`，但尚未执行 GitHub upload。当前仍显示 D 级阻断，不能作为正式经营决策、采购执行、付款审批、付款执行、银行操作、现场施工、安全签字、技术签字、开票、催收、法律决策、绩效发放、工资计算、奖金审批或薪资导出依据；lineage 完整检查、正式报告和外部接口仍未完成。下一步只能执行 Stage 16 GitHub upload。
