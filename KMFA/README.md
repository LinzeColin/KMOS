...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s06-p3-validation-evidence-output` |
| 当前 Stage | `S06｜零差异校验与差异处理队列` |
| 当前 Phase | `S06-REV｜Stage 6 整体复审待开始` |
| 当前 Task | `KMFA-S06-STAGE-REVIEW` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5 已完成三个 Phase、整体复审和 GitHub upload；S06-P1/S06-P2/S06-P3 已本地验证，下一步先做 Stage 6 整体复审 |
