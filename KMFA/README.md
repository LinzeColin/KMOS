...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s13-github-upload` |
| 当前 Stage | `S13｜财务经营报表与回款应收扩展` |
| 当前 Phase | `Stage 13 GitHub Upload｜已完成` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12 和 Stage 13 均已完成三个 Phase、整体复审和 GitHub upload；下一步只能作为新 run work 执行 S14-P1 |
...
当前 Stage 13 GitHub upload gate 验收验证:
