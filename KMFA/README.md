...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s14-stage-review` |
| 当前 Stage | `S14｜资金、开票、纳税与政策证据模块` |
| 当前 Phase | `Stage 14 整体复审｜已完成本地验证` |
| 当前 Task | `KMFA-S14-STAGE-REVIEW-20260701` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12 和 Stage 13 均已完成三个 Phase、整体复审和 GitHub upload；S14-P1、S14-P2、S14-P3 和 Stage 14 整体复审已本地验证，下一步只能作为新 run work 执行 Stage 14 GitHub upload |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12 和 Stage 13 均已完成整体复审和 GitHub upload；Stage 13 upload 证据位于 `KMFA/stage_artifacts/S13_GITHUB_UPLOAD/`。S14-P1 资金计划现金贷款已本地验证完成，生成 4 条 public-safe source lane、4 条现金压力信号、3 条贷款到期提示、3 条账户余额汇总和 1 个 HTML overview。S14-P2 开票纳税已本地验证完成，生成 3 条 public-safe source lane、3 条开票纳税候选、3 条资金汇总和 1 个 HTML overview。S14-P3 政策证据已本地验证完成，生成 5 类 public-safe 政策证据目录、5 条证据缺口、5 条风险提示和 1 个 HTML overview。Stage 14 整体复审已本地通过，证据位于 `KMFA/stage_artifacts/S14_STAGE_REVIEW/`。当前仍显示 D 级阻断，不能作为正式经营决策、正式政策资格结论、政策申报、付款、银行操作、贷款管理、纳税申报或发票开具依据；lineage 完整检查、正式报告、Stage 14 GitHub upload 和外部接口仍未完成。下一步只能作为新 run work 执行 Stage 14 GitHub upload。
