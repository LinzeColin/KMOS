...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s18p3-integration-preparation` |
| 当前 Stage | `S18｜回归、压力、稳定验收与后续接入准备` |
| 当前 Phase | `Stage 18 Review｜待开始` |
| 当前 Task | `KMFA-S18-STAGE-REVIEW-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15、Stage 16 和 Stage 17 均已完成三个 Phase、整体复审和 GitHub upload；S18-P1/S18-P2/S18-P3 已完成本地验证；S18-P2 Go/No-Go 仍为 `NO_GO`；下一步只能执行 Stage 18 整体复审 |
