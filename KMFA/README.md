...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s14p3-policy-evidence-plan` |
| 当前 Stage | `S14｜资金、开票、纳税与政策证据模块` |
| 当前 Phase | `S14-P3｜政策证据｜已完成本地验证` |
| 当前 Task | `S14PCT01-S14PCT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12 和 Stage 13 均已完成三个 Phase、整体复审和 GitHub upload；S14-P1、S14-P2 和 S14-P3 已本地验证，下一步只能作为新 run work 执行 Stage 14 整体复审 |
