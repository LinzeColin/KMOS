...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s13-stage-review` |
| 当前 Stage | `S13｜财务经营报表与回款应收扩展` |
| 当前 Phase | `Stage 13 GitHub Upload｜待开始` |
| 当前 Task | `KMFA-S13-GITHUB-UPLOAD-20260701` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11 和 Stage 12 均已完成三个 Phase、整体复审和 GitHub upload；S13-P1、S13-P2、S13-P3 和 Stage 13 整体复审已本地完成，下一步只能在新 run work 中执行 Stage 13 GitHub upload gate |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11 和 Stage 12 均已完成整体复审和 GitHub upload；Stage 12 upload 证据位于 `KMFA/stage_artifacts/S12_GITHUB_UPLOAD/`。S12-P1 人工处理事件、S12-P2 影响预览、S12-P3 重跑机制、Stage 12 整体复审和 final upload 均已完成。S13-P1 财务经营报表已本地验证完成，生成 public-safe 经营周报/月报初稿和 HTML draft。S13-P2 回款应收账龄已本地验证完成，生成 5 条 source lane、4 条优先级事项、4 条责任事项和 HTML evidence。S13-P3 跨表复核已本地验证完成，生成 4 个复核维度、4 条人工差异队列事项、1 份经营报表质量报告和 HTML evidence。Stage 13 整体复审已本地通过并修复治理状态切换 finding；当前仍显示 D 级阻断，不能作为正式经营决策依据；Stage 13 GitHub upload、lineage 完整检查、正式报告和外部接口仍未完成。下一步只能在新 run work 中执行 Stage 13 GitHub upload gate。
