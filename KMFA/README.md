...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s15-stage-review` |
| 当前 Stage | `S15｜销售绩效事实与复核清单` |
| 当前 Phase | `S15REV｜整体复审｜已完成本地验证` |
| 当前 Task | `KMFA-S15-GITHUB-UPLOAD-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成三个 Phase、整体复审和 GitHub upload；S15-P1/S15-P2/S15-P3 和 Stage 15 整体复审已完成本地验证；下一步只能执行 Stage 15 GitHub upload |
...
| `stage_artifacts/S15_STAGE_REVIEW/` | Stage 15 整体复审证据，复跑 S15-P1/P2/P3 validators、Stage 15 review validator、治理和安全门禁，未执行 upload |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成整体复审和 GitHub upload；Stage 14 upload 证据位于 `KMFA/stage_artifacts/S14_GITHUB_UPLOAD/`。S14-P1 资金计划现金贷款、S14-P2 开票纳税和 S14-P3 政策证据均已完成 public-safe planning/evidence signals。S15-P1 已完成 public-safe 绩效事实字段，S15-P2 已完成 public-safe 绩效事实表和异常项目复核事项清单，S15-P3 已完成 public-safe 事实接口预留和工资项目边界锁定，Stage 15 整体复审已完成本地验证，证据位于 `KMFA/stage_artifacts/S15_STAGE_REVIEW/`。当前仍显示 D 级阻断，不能作为正式经营决策、绩效发放、工资计算、奖金审批或薪资导出依据；lineage 完整检查、正式报告和外部接口仍未完成。下一步只能执行 Stage 15 GitHub upload。
