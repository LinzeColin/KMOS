...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s17p3-operations-sop` |
| 当前 Stage | `S17｜权限、通知、安全、审计与运维` |
| 当前 Phase | `Stage 17 整体复审｜待开始` |
| 当前 Task | `KMFA-S17-STAGE-REVIEW-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15 和 Stage 16 均已完成三个 Phase、整体复审和 GitHub upload；S17-P1/S17-P2/S17-P3 已本地完成，下一步只能执行 Stage 17 整体复审 |
