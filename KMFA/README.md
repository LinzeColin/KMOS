...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s12-stage-review` |
| 当前 Stage | `S12｜人工处理工作台与重跑机制` |
| 当前 Phase | `S12-GITHUB-UPLOAD｜待开始` |
| 当前 Task | `KMFA-S12-GITHUB-UPLOAD` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成三个 Phase、整体复审和 GitHub upload；S12-P1/P2/P3 和 Stage 12 整体复审已本地完成，下一步只能执行 Stage 12 final GitHub upload gate |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成整体复审和 GitHub upload；Stage 11 upload 证据位于 `KMFA/stage_artifacts/S11_STAGE_REVIEW/`。S12-P1 人工处理事件、S12-P2 影响预览、S12-P3 重跑机制和 Stage 12 整体复审已完成本地验证，证据位于 `KMFA/stage_artifacts/S12_P1_manual_resolution_events/`、`KMFA/stage_artifacts/S12_P2_manual_impact_preview/`、`KMFA/stage_artifacts/S12_P3_manual_rerun_mechanism/` 与 `KMFA/stage_artifacts/S12_STAGE_REVIEW/`。S10 导出物与 S11 前端页面仍显示正式报告阻断，不能作为正式经营决策依据；Stage 12 final GitHub upload、lineage 完整检查、正式报告和外部接口仍未完成。下一步只能执行 Stage 12 final GitHub upload gate。
