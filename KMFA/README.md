...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s15p1-performance-fact-fields` |
| 当前 Stage | `S15｜销售绩效事实与复核清单` |
| 当前 Phase | `S15-P1｜绩效事实字段｜已完成本地验证` |
| 当前 Task | `KMFA-S15-P2-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成三个 Phase、整体复审和 GitHub upload；S15-P1 已完成本地验证；下一步只能作为新 run work 执行 S15-P2 |
