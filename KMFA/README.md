...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s16-p3-local` |
| 当前 Stage | `S16｜外协采购、项目状态、客户经营扩展` |
| 当前 Phase | `Stage 16 整体复审｜待开始` |
| 当前 Task | `KMFA-S16-STAGE-REVIEW-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14 和 Stage 15 均已完成三个 Phase、整体复审和 GitHub upload；S16-P1/S16-P2/S16-P3 已完成本地验证但未上传；下一步只能执行 Stage 16 整体复审 |
