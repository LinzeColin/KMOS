...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s08p1-project-composite-key` |
| 当前 Stage | `S08｜业务实体与项目身份匹配` |
| 当前 Phase | `S08-P2｜业务实体模型 待开始` |
| 当前 Task | `S8PBT01-S8PBT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6 和 Stage 7 均已完成三个 Phase、整体复审和 GitHub upload；S08-P1 已本地完成并提交证据，下一步只执行 S08-P2 业务实体模型 |
