...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s18p2-full-regression` |
| 当前 Stage | `S18｜回归、压力、稳定验收与后续接入准备` |
| 当前 Phase | `S18-P3｜后续接入准备｜待开始` |
| 当前 Task | `KMFA-S18-P3-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15、Stage 16 和 Stage 17 均已完成三个 Phase、整体复审和 GitHub upload；S18-P1/S18-P2 已完成本地验证；S18-P2 Go/No-Go 为 `NO_GO`；下一步只能执行 S18-P3 |
