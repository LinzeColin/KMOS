...
| 当前 Phase | `S04-P3｜基础工具测试` |
| 当前 Task | `S4PCT01-S4PCT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；S04-P1/S04-P2/S04-P3 已本地验证，Stage 4 尚未整体复审或上传 |
