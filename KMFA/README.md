...
| 当前 Phase | `S04-STAGE-REVIEW｜整体复审` |
| 当前 Task | `KMFA-S04-STAGE-REVIEW-20260629` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；S04-P1/S04-P2/S04-P3 已本地验证，Stage 4 整体复审已通过并处于 upload-ready local-only，尚未 push GitHub |
