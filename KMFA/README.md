...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s10p1-report-templates` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8 和 Stage 9 均已完成三个 Phase、整体复审和 GitHub upload；S10-P1 已本地完成，下一步只执行 S10-P2 报告可信等级 |
