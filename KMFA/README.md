...
| 当前 Phase | `S04-GITHUB-UPLOAD｜Stage 4 上传` |
| 当前 Task | `KMFA-S04-GITHUB-UPLOAD-20260629` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 4 已完成整体复审、修复和 final GitHub upload |
