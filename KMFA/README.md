...
| 当前 Phase | `S04-P2｜字段标准化` |
| 当前 Task | `S4PBT01-S4PBT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；S04-P1/S04-P2 已本地验证，Stage 4 尚未复审或上传 |
