...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s12p1-manual-resolution-events` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成三个 Phase、整体复审和 GitHub upload；S12-P1 已本地完成，下一步只能执行 S12-P2 |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成整体复审和 GitHub upload；Stage 11 upload 证据位于 `KMFA/stage_artifacts/S11_STAGE_REVIEW/`。S12-P1 人工处理事件已完成本地验证，证据位于 `KMFA/stage_artifacts/S12_P1_manual_resolution_events/`。S10 导出物与 S11 前端页面仍显示正式报告阻断，不能作为正式经营决策依据；S12-P2/P3、lineage 完整检查、正式报告和外部接口仍未完成。下一步只能执行 `S12-P2｜影响预览`，作为独立 phase。
