...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s06-github-upload` |
| 当前 Stage | `S07｜文件型源适配与字段映射` |
| 当前 Phase | `S07-P1｜财务文件适配 待开始` |
| 当前 Task | `KMFA-S07-P1-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5 和 Stage 6 均已完成三个 Phase、整体复审和 GitHub upload；下一步只执行 `S07-P1｜财务文件适配` |
