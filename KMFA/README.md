...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-post-s18-lineage-report-gate-local` |
| 当前 Stage | `S18｜回归、压力、稳定验收与后续接入准备` |
| 当前 Phase | `Post-S18 Lineage / Report Gate｜NO_GO owner scope required` |
| 当前 Task | `KMFA-LINEAGE-REPORT-GATE-PENDING_OWNER_SCOPE-20260702` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15、Stage 16、Stage 17 和 Stage 18 均已完成三个 Phase、整体复审和 GitHub upload；Post-S18 Part 1-6、Whole Project Final Review、worktree cleanup 和 Lineage / Report Gate 已完成本地证据；当前 Go/No-Go 仍为 `NO_GO`，`delivery_allowed=false`；后续 GitHub final upload/backup 只能作为 `NO_GO governance backup only`，不得声称 delivery、release、正式报告或业务执行 |
