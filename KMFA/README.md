...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s17-github-upload` |
| 当前 Stage | `S18｜回归、压力、稳定验收与后续接入准备` |
| 当前 Phase | `S18-P1｜精度与压力测试｜待开始` |
| 当前 Task | `KMFA-S18-P1-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13、Stage 14、Stage 15、Stage 16 和 Stage 17 均已完成三个 Phase、整体复审和 GitHub upload；下一步只能执行 S18-P1 |
