...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成三个 Phase、整体复审和 GitHub upload；下一步只能执行 S12-P1 |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10 和 Stage 11 均已完成整体复审和 GitHub upload；Stage 11 upload 证据位于 `KMFA/stage_artifacts/S11_STAGE_REVIEW/`。S10 导出物与 S11 前端页面仍显示正式报告阻断，不能作为正式经营决策依据；lineage 完整检查、正式报告、外部接口和 S12 人工处理工作台仍未完成。下一步只能执行 `S12-P1｜人工处理工作台与重跑机制`，作为独立 phase。
