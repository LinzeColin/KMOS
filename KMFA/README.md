...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s14-github-upload` |
| 当前 Stage | `S15｜销售绩效事实与复核清单` |
| 当前 Phase | `S15-P1｜待开始` |
| 当前 Task | `KMFA-S15-P1-GATE` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成三个 Phase、整体复审和 GitHub upload；下一步只能作为新 run work 执行 S15-P1 |
...
当前 Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成整体复审和 GitHub upload；Stage 14 upload 证据位于 `KMFA/stage_artifacts/S14_GITHUB_UPLOAD/`。S14-P1 资金计划现金贷款已本地验证完成，生成 4 条 public-safe source lane、4 条现金压力信号、3 条贷款到期提示、3 条账户余额汇总和 1 个 HTML overview。S14-P2 开票纳税已本地验证完成，生成 3 条 public-safe source lane、3 条开票纳税候选、3 条资金汇总和 1 个 HTML overview。S14-P3 政策证据已本地验证完成，生成 5 类 public-safe 政策证据目录、5 条证据缺口、5 条风险提示和 1 个 HTML overview。Stage 14 整体复审与 upload 已完成，证据位于 `KMFA/stage_artifacts/S14_STAGE_REVIEW/` 和 `KMFA/stage_artifacts/S14_GITHUB_UPLOAD/`。当前仍显示 D 级阻断，不能作为正式经营决策、正式政策资格结论、政策申报、付款、银行操作、贷款管理、纳税申报或发票开具依据；lineage 完整检查、正式报告和外部接口仍未完成。下一步只能作为新 run work 执行 `S15-P1｜销售绩效事实与复核清单`。
