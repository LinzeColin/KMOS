...
|---|---|
| project_id | `KMFA` |
| 当前版本 | `0.1.0-s08-github-upload` |
| 当前 Stage | `S09｜项目成本计算引擎` |
| 当前 Phase | `S09-P1｜项目成本事实层 待开始` |
| 当前 Task | `S9PAT01-S9PAT03` |
...
| Stage 上传规则 | 中间 Phase 不上传 GitHub；Stage 5、Stage 6、Stage 7 和 Stage 8 均已完成三个 Phase、整体复审和 GitHub upload；下一步只执行 S09-P1 项目成本事实层 |
