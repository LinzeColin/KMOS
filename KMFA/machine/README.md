...
| `runs/` | compact public-safe receipts；完整日志与制品外置 | 已含清理交接、P0.1-P0.4、S00 Stage Review、P1.1-P1.4、S01 Stage Review、S02/P2.1-P2.4 记录 |
...
- S02/P2.2 已把 Canonical Facts 与旧业务事实按职责单向投影到恰好七文件；P2.3 又把 AC/Task DAG/Traceability 精确投影到 `05`；P2.4 对完整投影、DAG、精确七文件、禁止路径和 compact evidence fail closed。taskpack `human/*` 仅是 reference，不复制到仓库。派生规则见 `runs/S02_P21_CANONICAL_FACTS.md`，验证见 `runs/S02_P22_HUMAN_PLANE.md`、`runs/S02_P23_TRACEABILITY.md` 与 `VALIDATION_REPORT.md`。
