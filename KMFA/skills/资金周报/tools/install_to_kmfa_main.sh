...
# Install this skill into LinzeColin/KMOS/KMFA/skills/资金周报,
...
TARGET_DIR="$REPO_ROOT/KMFA/skills/资金周报"
...
git add KMFA/skills/资金周报 KMFA/metadata/fund_weekly_analysis/.gitignore KMFA/metadata/fund_weekly_analysis/README.md
