...
```bash
python3 KMFA/skills/资金周报/tools/export_owner_decision_review_csv.py \
...
```bash
python3 KMFA/skills/资金周报/tools/validate_owner_review_workbook.py \
...
```bash
python3 KMFA/skills/资金周报/tools/install_owner_decision_manifest.py \
  --repo-root /Users/linzezhang/Documents/Codex/KMOS \
  --run-id <run_id> \
