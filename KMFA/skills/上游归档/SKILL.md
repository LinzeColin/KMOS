...
Canonical repository: `LinzeColin/KMOS`, path `KMFA/skills/上游归档/`.
...
PYTHONDONTWRITEBYTECODE=1 python3 -m unittest KMFA/skills/上游归档/scripts/test_dws_output_layout.py -q
```
