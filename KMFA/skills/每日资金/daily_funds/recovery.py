    ...
    def _failure_code(step: str, result: object) -> str:
        ...
        if step == "RAW_ARCHIVE_AUDIT":
            return {
                ...
                "RAW_ARCHIVE_AUDIT_SOURCE_SCOPE_NEEDS_REVIEW": "DAILY_FUNDS_RECOVERY_AUDIT_SOURCE_SCOPE_NEEDS_REVIEW",
                "RAW_ARCHIVE_AUDIT_SOURCE_MESSAGE_NEEDS_REVIEW": "DAILY_FUNDS_RECOVERY_AUDIT_SOURCE_MESSAGE_NEEDS_REVIEW",
                "RAW_ARCHIVE_AUDIT_SOURCE_ATTACHMENT_NEEDS_REVIEW": "DAILY_FUNDS_RECOVERY_AUDIT_SOURCE_ATTACHMENT_NEEDS_REVIEW",
                "RAW_ARCHIVE_AUDIT_SOURCE_OCCURRENCE_NEEDS_REVIEW": "DAILY_FUNDS_RECOVERY_AUDIT_SOURCE_OCCURRENCE_NEEDS_REVIEW",
