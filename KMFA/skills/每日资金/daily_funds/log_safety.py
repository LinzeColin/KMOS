...
MACHINE_CODES = frozenset(
    {
        ...
        "PAYMENT_REQUEST_REFRESH_CONFIG_INVALID",
        "PAYMENT_REQUEST_REFRESH_DATE_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_DUPLICATE_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_FAILED",
        "PAYMENT_REQUEST_REFRESH_GRAND_TOTAL_LABEL_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_GRAND_TOTAL_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_LOCK_HELD",
        "PAYMENT_REQUEST_REFRESH_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_OCR_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_OCR_UNAVAILABLE",
        "PAYMENT_REQUEST_REFRESH_SOURCE_READ_FAILED",
        "PAYMENT_REQUEST_REFRESH_SOURCE_EMPTY",
        "PAYMENT_REQUEST_REFRESH_TITLE_NEEDS_REVIEW",
        "PAYMENT_REQUEST_REFRESH_VERIFIED",
        "PAYMENT_REQUEST_REFRESH_WORKBOOK_NEEDS_REVIEW",
        "RESTORE_OK",
        "RUNTIME_AUDIT_OK",
        "RAW_ARCHIVE_AUDITED",
        ...
        "RAW_ARCHIVE_AUDIT_TREE_CENSUS_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_CHECKOUT_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_OCCURRENCE_METADATA_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_SOURCE_ENVELOPE_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_SOURCE_SCOPE_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_SOURCE_MESSAGE_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_SOURCE_ATTACHMENT_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_SOURCE_OCCURRENCE_NEEDS_REVIEW",
        "RAW_ARCHIVE_AUDIT_BATCH_BINDING_NEEDS_REVIEW",
        "RAW_COVERAGE_REPAIRED",
        "RAW_COVERAGE_REPAIR_GIT_WRITER_LOCK_HELD",
        "RAW_COVERAGE_REPAIR_INCOMPLETE",
        "RAW_COVERAGE_REPAIR_LOCK_HELD",
        "RAW_COVERAGE_REPAIR_NEEDS_REVIEW",
        "RAW_COVERAGE_RECEIPT_REQUIRED",
        "RAW_COVERAGE_RECEIPT_STALE",
        "RAW_COVERAGE_VERIFIED",
        "RAW_FACT_REPLAY_LOCK_HELD",
        "RAW_FACT_REPLAY_GIT_WRITER_LOCK_HELD",
        "RAW_FACT_REPLAY_NEEDS_REVIEW",
        "RAW_FACT_REPLAY_NO_COMPLETE_PAIR",
        "RAW_FACT_REPLAY_PUBLISHED",
        "RAW_FACT_REPLAY_PUBLISHED_NEEDS_REVIEW",
