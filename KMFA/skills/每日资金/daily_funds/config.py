...
class DailyFundsConfig:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> "DailyFundsConfig":
        ...
        return cls(
            ...
            dws_client_secret=_nonempty(source, "DAILY_FUNDS_DWS_CLIENT_SECRET"),
    ...
    def missing(self, *, include_storage: bool = True) -> tuple[str, ...]:
        required = {
            ...
            "DAILY_FUNDS_DWS_CLIENT_SECRET": self.dws_client_secret,
    ...
    def validate(self, *, include_storage: bool = True) -> None:
        ...
        if "github.com" not in self.private_repo or "Private-Database" not in self.private_repo:
