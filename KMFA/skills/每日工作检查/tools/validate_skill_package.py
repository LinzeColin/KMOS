...
REQUIRED_FILES = [
    "KMFA/skills/每日工作检查/SKILL.md",
    "KMFA/skills/每日工作检查/README.md",
    "KMFA/skills/每日工作检查/references/runbook.md",
    "KMFA/skills/每日工作检查/references/configuration.md",
    "KMFA/skills/每日工作检查/references/rules.md",
    "KMFA/skills/每日工作检查/references/data_contract.md",
    "KMFA/skills/每日工作检查/references/database_governance.md",
    "KMFA/skills/每日工作检查/templates/env.local.example",
    "KMFA/skills/每日工作检查/templates/notification_targets.local.example.json",
...
def main() -> int:
    ...
    for base in [REPO_ROOT / "KMFA" / "skills" / "每日工作检查", REPO_ROOT / "KMFA" / "metadata" / "daily_routine_check"]:
        if base.exists():
