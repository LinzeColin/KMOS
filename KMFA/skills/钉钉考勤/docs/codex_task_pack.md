...
KMFA/skills/钉钉考勤/references/operating_contract.md
KMFA/skills/钉钉考勤/references/source_of_truth_contract.md
KMFA/skills/钉钉考勤/references/stage2_shadow_payroll_acceptance.md
KMFA/skills/钉钉考勤/references/database_schema_contract.md
KMFA/skills/钉钉考勤/references/payroll_baseline_contract.md
```
...
1. Copy `KMFA/skills/钉钉考勤` into repo root.
...
```text
KMFA/skills/钉钉考勤/scripts/run_stage2_evening.sh
```
...
```bash
python3 -m py_compile KMFA/skills/钉钉考勤/scripts/*.py
python3 KMFA/skills/钉钉考勤/scripts/month_gate.py --run-slot evening --today 2026-08-01 --print-json
python3 KMFA/skills/钉钉考勤/scripts/month_gate.py --run-slot morning --today 2026-08-01 --print-json
...
1. Remove `KMFA/skills/钉钉考勤` directory.
