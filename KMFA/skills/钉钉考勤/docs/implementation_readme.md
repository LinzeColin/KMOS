...
cp -R /path/to/kmfa-dingtalk-attendance_task_pack/KMFA/skills/钉钉考勤 .agents/skills/
chmod +x KMFA/skills/钉钉考勤/scripts/*.sh
chmod +x KMFA/skills/钉钉考勤/scripts/*.py
```
...
cp KMFA/skills/钉钉考勤/templates/env.local.example \
  metadata/dingtalk_attendance/private_runtime/.env.local
cp KMFA/skills/钉钉考勤/templates/kmfa.attendance.config.example.json \
...
```bash
KMFA/skills/钉钉考勤/scripts/preflight.sh
KMFA/skills/钉钉考勤/scripts/inspect_runtime.sh
KMFA/skills/钉钉考勤/scripts/validate_offline.sh
```

## Test month gate

```bash
KMFA_RUN_SLOT=evening python3 KMFA/skills/钉钉考勤/scripts/month_gate.py --today 2026-08-01 --print-json
KMFA_RUN_SLOT=morning python3 KMFA/skills/钉钉考勤/scripts/month_gate.py --today 2026-08-01 --print-json
KMFA_RUN_SLOT=evening python3 KMFA/skills/钉钉考勤/scripts/month_gate.py --today 2026-08-06 --print-json
```
