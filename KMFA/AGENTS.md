...
- 当前 Phase: `v0.1.4 S08-P1 项目组合键已完成本地验证；8 个 hash-only 组件、4 个 profiles、3 个 match results、2 条 manual review queue、1 条 strong auto match、10000 bps 权重总和、8500/7000/5000 bps 阈值已锁定；下一步只能另起 run work 执行 S08-P2，不执行 S08-P3、Stage 8 review、GitHub upload、raw value matching、lineage full check 或正式报告`
...
- v0.1.4 S08-P1 项目组合键已完成；下一轮只能在用户明确开启后执行 `S08-P2 业务实体模型`。不得直接执行 S08-P3、Stage 8 review、GitHub upload、raw value matching、lineage full check、正式报告、live connector、OpMe 深度耦合或任何业务动作。
