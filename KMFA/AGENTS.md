...
- 当前 Phase: `S04-P1 金额精度与基础工具已完成本地验证；amount normalization/no-float public-safe evidence 已锁定；不执行 S04-P2、S04-P3、Stage 4 review、GitHub upload、raw value matching 或正式报告`
...
- v0.1.4 S04-P1 已完成；下一轮只能在用户明确开启后执行 `S04-P2｜字段标准化`。不得直接执行 S04-P3、Stage 4 review、GitHub upload、raw value matching、正式报告、live connector、OpMe 深度耦合或任何业务动作。
