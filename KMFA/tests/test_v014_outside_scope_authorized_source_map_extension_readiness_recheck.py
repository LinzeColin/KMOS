...
from KMFA.tools import v014_outside_scope_authorized_source_map_extension_readiness_recheck as generator
from KMFA.tools.check_v014_outside_scope_authorized_source_map_extension_readiness_recheck import validate
...
class OutsideScopeAuthorizedSourceMapExtensionReadinessRecheckTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_readiness_counts(self) -> None:
    ...
    def test_source_map_application_is_not_ready(self) -> None:
        summary = self.manifest["summary"]
