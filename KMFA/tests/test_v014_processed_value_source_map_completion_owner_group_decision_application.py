...
from KMFA.tools import v014_processed_value_source_map_completion_owner_group_decision_application as generator
from KMFA.tools.check_v014_processed_value_source_map_completion_owner_group_decision_application import validate


class ProcessedValueSourceMapCompletionOwnerGroupDecisionApplicationTest(unittest.TestCase):
    @classmethod
    ...
    def test_group_decisions_are_still_pending(self) -> None:
        summary = self.manifest["summary"]
        self.assertEqual(summary["decision"], "NO_GO")
        self.assertEqual(summary["review_group_count"], 22)
        self.assertEqual(summary["response_row_count"], 113)
        self.assertEqual(summary["pending_group_decision_row_count"], 113)
        self.assertEqual(summary["valid_group_decision_row_count"], 0)
        self.assertEqual(summary["invalid_group_decision_row_count"], 0)
    ...
    def test_validator_accepts_private_diagnostic(self) -> None:
        ...
        self.assertEqual(manifest["summary"]["pending_group_decision_row_count"], 113)
