...
class AuthorizedSourceReferenceOrExclusionApplicationOwnerOrAgentActionIntakeBlockerBlockedHandoffExternalActionReadinessAfterFinalThresholdTest(
    unittest.TestCase
):
    ...
    def test_external_action_readiness_remains_blocked_without_owner_or_agent_actions(self) -> None:
        ...
        source_paths = [
            ...
            generator.SOURCE_PRIVATE_ACTION_INTAKE_BLOCKER_BLOCKED_HANDOFF_DIAGNOSTIC_PATH,
            generator.SOURCE_PRIVATE_ACTION_INTAKE_BLOCKER_BLOCKED_HANDOFF_RECORDS_PATH,
            generator.SOURCE_PRIVATE_ACTION_INTAKE_BLOCKER_OWNER_ACTION_QUEUE_PATH,
            generator.SOURCE_PRIVATE_ACTION_INTAKE_BLOCKER_BLOCKED_HANDOFF_REPORT_PATH,
        ]
        artifact_paths = [
        ...
        self.assertTrue(summary["source_action_intake_blocked_audit_threshold_met"])
        ...
        self.assertTrue(
            all(
                ...
                == "blocked_waiting_for_owner_or_authorized_agent_external_action_after_final_threshold"
