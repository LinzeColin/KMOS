...
class TestV013S07P2WpsFileAdapterReplay(unittest.TestCase):
    def test_wps_file_adapter_replay_stays_public_safe_and_local_only(self) -> None:
        ...
        self.assertEqual(result["phase_scope"], "v013_s07_p2_wps_file_adapter_replay_only")
        self.assertTrue(result["s06_stage_review_dependency_validated"])
        self.assertTrue(result["s07_p1_dependency_validated"])
        self.assertTrue(result["legacy_s07_p2_dependency_validated"])
        ...
        self.assertEqual(result["source_header_hash_count"], 20)
        self.assertEqual(result["native_conversion_required_count"], 4)
        self.assertEqual(result["active_mapping_rule_version"], "MAP-SRC-kmfa-wps-file-adapter-s07p2-v0.1.0")
        ...
        self.assertIn("S07-P3", result["next_required_step"])
