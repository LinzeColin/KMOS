...
class FundWeeklyAnalysisSkillContractTest(unittest.TestCase):
    ...
    def test_skill_package_uses_sydney_weekly_monday_saturday_1100_local_schedule_and_real_input(self) -> None:
    ...
    def test_codex_app_automation_contract_mirrors_weekly_monday_saturday_1100_local_cron(self) -> None:
