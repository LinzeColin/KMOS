...
from KMFA.tools import v014_processed_value_source_map_completion_owner_group_partial_application as generator
from KMFA.tools.check_v014_processed_value_source_map_completion_owner_group_partial_application import validate


class ProcessedValueSourceMapCompletionOwnerGroupPartialApplicationTest(unittest.TestCase):
    @classmethod
    ...
    def test_private_partial_application_counts(self) -> None:
        summary = self.manifest["summary"]
        self.assertEqual(summary["decision"], "NO_GO")
        self.assertEqual(summary["source_response_row_count"], 113)
        self.assertEqual(summary["private_partial_application_group_count"], 19)
        self.assertEqual(summary["private_partial_application_target_slot_count"], 101)
        self.assertEqual(summary["private_blocked_group_count"], 3)
        self.assertEqual(summary["private_blocked_target_slot_count"], 12)
        self.assertEqual(
            summary["row_decision_code_counts"],
            {
        ...
        self.assertTrue(summary["private_partial_application_staged"])
    ...
    def test_validator_accepts_private_application(self) -> None:
        ...
        self.assertEqual(manifest["summary"]["private_partial_application_target_slot_count"], 101)
        self.assertEqual(manifest["summary"]["private_blocked_target_slot_count"], 12)
