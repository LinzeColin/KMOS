...
from KMFA.tools import v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_audit as generator
from KMFA.tools.check_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_audit import (
    validate,
)
...
class OutsideScopePostDelegationBlockerAuditTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_records_second_post_delegation_observation(self) -> None:
        summary = self.manifest["summary"]
        self.assertEqual(summary["decision"], "NO_GO")
        self.assertEqual(summary["prior_post_delegation_blocker_observation_count"], 1)
        self.assertEqual(summary["post_delegation_blocker_observation_count"], 2)
