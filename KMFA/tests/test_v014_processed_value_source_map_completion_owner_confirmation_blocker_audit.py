...
class ProcessedValueSourceMapCompletionOwnerConfirmationBlockerAuditTest(unittest.TestCase):
    ...
    def test_confirmation_missing_blocker_is_recorded(self) -> None:
        ...
        self.assertEqual(
            summary["blocker_condition"],
            "owner_or_authorized_delegate_confirmation_code_not_supplied",
        )
        ...
        self.assertFalse(summary["confirmation_record_found"])
        self.assertFalse(summary["owner_confirmation_supplied"])
