#!/usr/bin/env python3
"""Recheck the post-delegation outside-scope source-map extension blocker threshold.

This phase records the third post-delegation observation that the delegated
KEEP_PENDING decision still does not authorize source-map extension application,
meeting the strict blocked-goal audit threshold for this resumed blocker chain.
...
PHASE_ID = "V014_OUTSIDE_SCOPE_AUTHORIZED_SOURCE_MAP_EXTENSION_POST_DELEGATION_BLOCKER_THRESHOLD_RECHECK"
TASK_ID = "KMFA-V014-OUTSIDE-SCOPE-AUTHORIZED-SOURCE-MAP-EXTENSION-POST-DELEGATION-BLOCKER-THRESHOLD-RECHECK-20260706"
ACCEPTANCE_ID = "ACC-V014-OUTSIDE-SCOPE-AUTHORIZED-SOURCE-MAP-EXTENSION-POST-DELEGATION-BLOCKER-THRESHOLD-RECHECK"
...
DECISION = "NO_GO"
DIAGNOSTIC_CONCLUSION = "post_delegation_keep_pending_blocker_threshold_met_without_authorized_extension"
NEXT_REQUIRED_INPUT = "strong_authorized_source_map_extension_evidence_before_source_map_application_or_keep_no_go"
NEXT_RECOMMENDED_PHASE = "BLOCKED_UNTIL_STRONG_AUTHORIZED_SOURCE_MAP_EXTENSION_EVIDENCE"

ARTIFACT_DIR = PROJECT_ROOT / "stage_artifacts" / PHASE_ID
MACHINE_DIR = ARTIFACT_DIR / "machine"
HUMAN_DIR = ARTIFACT_DIR / "human"
SUMMARY_PATH = MACHINE_DIR / "outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_summary.json"
MANIFEST_PATH = MACHINE_DIR / "outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_manifest.json"
GO_NO_GO_PATH = MACHINE_DIR / "outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_go_no_go_report.json"
MATRIX_PATH = MACHINE_DIR / "outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_matrix_public_safe.json"
REPORT_PATH = HUMAN_DIR / "outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_report.md"
...
METADATA_MANIFEST_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_manifest.json"
)
...
METADATA_MATRIX_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_matrix_public_safe.json"
)
...
PRIOR_PRIVATE_DIAGNOSTIC_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_audit/private_post_delegation_blocker_audit_diagnostic.json"
)
PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck"
)
PRIVATE_DIAGNOSTIC_PATH = PRIVATE_OUTPUT_DIR / "private_post_delegation_blocker_threshold_recheck_diagnostic.json"
...
def _build_summary(
    *, generated_at: str, prior_summary: dict[str, Any], prior_private_diagnostic: dict[str, Any]
    ...
    return {
        "schema_version": "kmfa.v014_outside_scope_post_delegation_blocker_threshold_recheck_summary.v1",
        "record_type": "v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_summary",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ("prior_phase_is_post_delegation_blocker_audit", summary["prior_phase_id"].endswith("POST_DELEGATION_BLOCKER_AUDIT")),
        ("prior_observation_count_two", summary["prior_post_delegation_blocker_observation_count"] == 2),
        ("current_observation_count_three", summary["post_delegation_blocker_observation_count"] == 3),
        ("blocked_threshold_met", summary["post_delegation_blocked_audit_threshold_met"] is True),
    ...
    return {
        "schema_version": "kmfa.v014_outside_scope_post_delegation_blocker_threshold_recheck_matrix_public_safe.v1",
        "record_type": "v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_matrix_public_safe",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        "generated_at": summary["generated_at"],
        "post_delegation_blocker_threshold_recheck_check_count": len(rows),
        "post_delegation_blocker_threshold_recheck_check_pass_count": pass_count,
        "post_delegation_blocker_threshold_recheck_check_fail_count": len(rows) - pass_count,
        "decision": DECISION,
        "checks": rows,
    }
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_outside_scope_post_delegation_blocker_threshold_recheck_go_no_go.v1",
        "record_type": "v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_go_no_go",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _write_human_artifacts(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    report = f"""# V014 Outside-Scope Post-Delegation Blocker Threshold Recheck
...
The same post-delegation blocker remains present for the third consecutive resumed/post-delegation observation. The blocked-goal threshold is met for this blocker chain. Application, comparison, reconciliation, release, upload, reinstall and business execution stay closed.
"""
...
- `PYTHONDONTWRITEBYTECODE=1 python3 -m py_compile KMFA/tools/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py KMFA/tools/check_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py KMFA/tests/test_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py --generated-at 2026-07-06T00:00:00+10:00`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py --require-private-diagnostic`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck`

Current generated check matrix: `{matrix["post_delegation_blocker_threshold_recheck_check_pass_count"]}` pass / `{matrix["post_delegation_blocker_threshold_recheck_check_fail_count"]}` fail.
"""
    risk_register = """# Risk Register

- R1: A blocked-goal recommendation could be mistaken for permission to apply source-map extensions.
...
def _append_development_event(manifest: dict[str, Any]) -> None:
    event_id = "DEV-KMFA-20260706-V014-OUTSIDE-SCOPE-POST-DELEGATION-BLOCKER-THRESHOLD-RECHECK"
    ...
    event = {
        ...
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        "iteration_id": "ITER-20260706-KMFA-V014-OUTSIDE-SCOPE-POST-DELEGATION-BLOCKER-THRESHOLD-RECHECK",
        ...
        "summary": "Rechecked the third post-delegation outside-scope source-map extension blocker observation, met the blocked threshold, and kept application blocked.",
        ...
        + [
            ...
            "KMFA/tests/test_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py",
            "KMFA/tools/check_v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py",
            "KMFA/tools/v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck.py",
        ],
    }
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    manifest = {
        "schema_version": "kmfa.v014_outside_scope_post_delegation_blocker_threshold_recheck_manifest.v1",
        "record_type": "v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_manifest",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "private_artifact_refs": ["private:post_delegation_blocker_threshold_recheck_diagnostic"],
        "validator": (
    ...
    diagnostic = {
        "schema_version": "kmfa.private.v014_outside_scope_post_delegation_blocker_threshold_recheck.v1",
        "classification": "private_post_delegation_blocker_threshold_recheck_diagnostic_do_not_commit",
        "record_type": "v014_outside_scope_authorized_source_map_extension_post_delegation_blocker_threshold_recheck_diagnostic",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def main() -> int:
    ...
    summary = manifest["summary"]
    print(
        "PASS: KMFA v0.1.4 outside-scope post-delegation blocker threshold rechecked "
