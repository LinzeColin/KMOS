#!/usr/bin/env python3
"""Intake owner authorization for residual-difference source-map correction.

This phase records the owner's current-thread authorization for Codex to
prepare private source-map correction or authoritative value resolution for the
72 residual differences. It does not read raw inbox files, write source-map
corrections, close discrepancies, compare values, upload, reinstall, or execute
business steps.
"""
...
PHASE_ID = "V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_AUTHORIZATION_INTAKE"
TASK_ID = (
    "KMFA-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-"
    "SOURCE-MAP-CORRECTION-AUTHORIZATION-INTAKE-20260707"
)
ACCEPTANCE_ID = (
    "ACC-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-"
    "SOURCE-MAP-CORRECTION-AUTHORIZATION-INTAKE"
)
...
DECISION = "NO_GO"
AUTHORIZATION_BASIS = (
    "owner_current_thread_direct_authorization_codex_may_prepare_private_resolution_"
    "under_raw_immutability_and_final_discrepancy_reporting"
)
INTAKE_CONCLUSION = "owner_authorization_intaken_private_resolution_ready_for_application_readiness"
NEXT_REQUIRED_INPUT = (
    "run_private_source_map_correction_or_authoritative_value_resolution_application_readiness_"
    "before_full_raw_to_processed_comparison"
)
NEXT_RECOMMENDED_PHASE = (
    "V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_APPLICATION_READINESS"
)

ARTIFACT_DIR = PROJECT_ROOT / "stage_artifacts" / PHASE_ID
MACHINE_DIR = ARTIFACT_DIR / "machine"
HUMAN_DIR = ARTIFACT_DIR / "human"
SUMMARY_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake_summary.json"
MANIFEST_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake_manifest.json"
GO_NO_GO_PATH = (
    MACHINE_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake_go_no_go_report.json"
)
MATRIX_PATH = (
    MACHINE_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake_matrix_public_safe.json"
)
REPORT_PATH = HUMAN_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake.md"
...
SOURCE_PRIVATE_FINAL_THRESHOLD_DIAGNOSTIC_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_final_threshold_recheck/private_source_map_correction_blocker_final_threshold_recheck_diagnostic.json"
)
SOURCE_PRIVATE_FINAL_THRESHOLD_QUEUE_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_final_threshold_recheck/private_source_map_correction_blocker_final_threshold_queue.jsonl"
)
SOURCE_PRIVATE_FINAL_THRESHOLD_REPORT_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_final_threshold_recheck/private_source_map_correction_blocker_final_threshold_recheck_report.md"
)

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake"
)
PRIVATE_ACTIVE_RECORD_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_authorization_active_record.json"
PRIVATE_AUTHORIZATION_QUEUE_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_authorization_queue.jsonl"
PRIVATE_DIAGNOSTIC_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_authorization_intake_diagnostic.json"
PRIVATE_REPORT_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_authorization_intake.md"
...
def _public_safety() -> dict[str, bool]:
    return {
        ...
        "private_source_final_threshold_diagnostic_committed": False,
        "private_source_final_threshold_queue_committed": False,
        ...
        "source_map_correction_detail_committed": False,
...
def _build_authorization_queue(*, generated_at: str, source_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for index, row in enumerate(source_rows, start=1):
        rows.append(
            {
                "authorization_item_id": f"OSCR-SMC-AUTH-{index:03d}",
                "phase_id": PHASE_ID,
                "task_id": TASK_ID,
                ...
                "owner_authorization_decision_code": "AUTHORIZE_CODEX_PREPARE_PRIVATE_RESOLUTION",
                "authorization_basis": AUTHORIZATION_BASIS,
                "private_resolution_preparation_allowed_next_phase": True,
                "source_map_correction_application_allowed_by_this_phase": False,
                "authoritative_value_resolution_application_allowed_by_this_phase": False,
                "source_map_correction_written_by_this_phase": False,
...
def _build_active_record(
    *, generated_at: str, source_summary: dict[str, Any], authorization_rows: list[dict[str, Any]]
    ...
    return {
        "schema_version": "kmfa.private.v014_residual_difference_source_map_correction_authorization_active_record.v1",
        "classification": "private_source_map_correction_authorization_do_not_commit",
        "record_type": "v014_residual_difference_source_map_correction_authorization_active_record",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_summary(
    *,
    ...
    track_counts = Counter(row.get("diagnostic_track") for row in authorization_rows)
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_authorization_intake_summary.v1",
        "record_type": "v014_residual_difference_source_map_correction_authorization_intake_summary",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_final_threshold_met": source_summary.get("source_map_correction_blocked_audit_threshold_met"),
        ...
        "source_map_correction_blocker_count": source_summary.get("source_map_correction_blocker_count"),
        ...
        "private_resolution_preparation_allowed_next_phase": True,
        "source_map_correction_application_readiness_allowed_next_phase": True,
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ...
        ("private_resolution_next_phase_only", summary["private_resolution_preparation_allowed_next_phase"] is True),
        ("no_source_map_write_this_phase", summary["source_map_correction_written_by_this_phase"] is False),
        ("no_discrepancy_closure_this_phase", summary["closed_discrepancy_count"] == 0),
    ...
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_authorization_intake_matrix_public_safe.v1",
        "record_type": "v014_residual_difference_source_map_correction_authorization_intake_matrix_public_safe",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_authorization_intake_go_no_go.v1",
        "record_type": "v014_residual_difference_source_map_correction_authorization_intake_go_no_go",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _write_private_outputs(
    ...
    diagnostic = {
        "schema_version": "kmfa.private.v014_residual_difference_source_map_correction_authorization_intake.v1",
        "classification": "private_source_map_correction_authorization_intake_do_not_commit",
        "record_type": "v014_residual_difference_source_map_correction_authorization_intake_diagnostic",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
    ...
    _write_text(
        ...
        "\n".join(
            [
                "# Private Residual Difference Source-Map Correction Authorization Intake",
                "",
                f"- phase_id: `{PHASE_ID}`",
                f"- authorization_item_count: `{len(authorization_rows)}`",
                "- source_map_correction_application_allowed_by_this_phase: `false`",
                "- next phase may run private application readiness only.",
                "",
            ]
        ),
    )
...
def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    report = f"""# V014 Residual Difference Source-Map Correction Authorization Intake
...
- Decision: `{DECISION}`
- Status: `{STATUS}`
- Source: prior public-safe final blocker threshold evidence plus ignored private final threshold queue.
...
This phase records authorization only. It does not write source-map correction, apply authoritative values, close discrepancies, run raw-to-processed comparison, reconcile values, verify business consistency, upload GitHub, reinstall the app or execute business steps.
...
- Reason: authorization was intaken, but no source-map correction or authoritative value resolution was applied in this phase.
...
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake.py --generated-at 2026-07-07T00:00:00+10:00`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake.py --require-private-authorization`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_outside_scope_candidate_review_residual_difference_source_map_correction_authorization_intake`
...
- Risk: authorization intake is mistaken for source-map correction.
- Control: source-map correction and authoritative value application remain false in all public gate flags.
...
- Risk: raw data is modified during resolution preparation.
- Control: this phase does not read or mutate raw inbox; later phases must preserve the same immutable raw boundary.
"""
    rollback = f"""# Rollback Plan

Remove the artifacts for `{PHASE_ID}`, metadata copies, private authorization outputs, tool, validator, focused test and governance entries. Do not touch prior threshold evidence or raw inbox files.
"""
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_authorization_intake_manifest.v1",
        "record_type": "v014_residual_difference_source_map_correction_authorization_intake_manifest",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "private_artifact_refs": [
            ...
            "private:source_map_correction_authorization_diagnostic",
            "private:source_map_correction_authorization_report",
        ],
        "raw_boundary": summary["raw_boundary"],
...
def _write_governance_events(generated_at: str, manifest: dict[str, Any]) -> None:
    event = {
        "event_id": "DEV-KMFA-20260707-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-AUTHORIZATION-INTAKE",
        ...
        "iteration_id": "ITER-20260707-KMFA-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-AUTHORIZATION-INTAKE",
        "task_id": TASK_ID,
        "version": VERSION,
        "go_no_go": DECISION,
        "result_commit": "PENDING",
        "summary": "Recorded owner authorization for private residual-difference source-map correction or authoritative value resolution readiness without applying corrections.",
        "authorization_item_count": 72,
        "source_map_correction_blocker_count": 72,
        "source_map_correction_ready": False,
        "source_map_correction_written": False,
    ...
    _upsert_jsonl(
        ...
        {
            "acceptance_id": ACCEPTANCE_ID,
            "acceptance_output": "Residual difference source-map correction authorization intake manifest summary Go No-Go public-safe matrix private ignored authorization record queue diagnostic report validator focused test and governance records",
            ...
            "name": "v0.1.4 residual difference source-map correction authorization intake",
            "phase_goal": "record owner authorization for private resolution readiness without applying source-map correction or reading raw data",
            "phase_id": PHASE_ID,
            "project_id": "KMFA",
            "raw_data_committed": False,
            "record_type": "v014_phase",
            "roadmap_phase_id": "OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_AUTHORIZATION_INTAKE",
...
def main() -> int:
    ...
    print(
        "PASS: generated V014 residual-difference source-map correction authorization intake "
