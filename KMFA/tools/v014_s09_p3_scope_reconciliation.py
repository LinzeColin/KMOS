#!/usr/bin/env python3
"""Generate KMFA v0.1.4 S09-P3 scope reconciliation evidence.

This validates the v0.1.4 S09-P2 dependency, reuses the public-safe
...
PUBLIC_OUTPUT_DIR = Path("KMFA/stage_artifacts/V014_S09_P3_SCOPE_RECONCILIATION")
MANIFEST_PATH = PUBLIC_OUTPUT_DIR / "machine/scope_reconciliation_manifest.json"
REPORT_PATH = PUBLIC_OUTPUT_DIR / "human/scope_reconciliation_report.md"
...
ACCEPTANCE_ID = "ACC-V014-S09-P3-SCOPE-RECONCILIATION"
SCHEMA_VERSION = "kmfa.v014_s09_p3_scope_reconciliation.v1"
PHASE_SCOPE = "v014_s09_p3_scope_reconciliation_only"
RAW_INBOX_REF = "operator-designated raw/private inbox outside repository"
NEXT_REQUIRED_STEP = (
    "Start v0.1.4 Stage 9 review as a separate run only after user instruction. "
    "Do not perform GitHub upload, raw value matching, lineage full check, formal report release, "
    "live connector, app reinstall, OpMe deep coupling, Redcircle automatic connector, or business "
    "execution in the S09-P3 run. GitHub main upload remains deferred until v1.4 Stage 1-18 are "
    "complete, overall review has passed, and findings are fixed."
)
...
def validate_s09_p2_dependency() -> dict[str, Any]:
    ...
    if result.get("stage_id") != "S09" or result.get("phase_id") != "S09-P2":
        raise RuntimeError("v0.1.4 S09-P3 requires validated S09-P2 dependency")
    if result.get("status") != "completed_validated_local_only_no_go_upload_deferred_margin_cash_margin":
        raise RuntimeError("v0.1.4 S09-P3 requires completed S09-P2 dependency")
...
def build_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "stage_id": "S09",
        "phase_id": "S09-P3",
        "phase_name": "v0.1.4 scope reconciliation",
        "task_id": TASK_ID,
        ...
        "artifact_refs": {
            **legacy["artifact_refs"],
            ...
            "generator": "KMFA/tools/v014_s09_p3_scope_reconciliation.py",
            "validator": "KMFA/tools/check_v014_s09_p3_scope_reconciliation.py",
            "unit_test": "KMFA/tests/test_v014_s09_p3_scope_reconciliation.py",
        },
        "validators": [
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_s09_p3_scope_reconciliation.py",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_s09_p3_scope_reconciliation.py",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_s09_p3_scope_reconciliation -q",
        ...
        "evidence_refs": [
            ...
            "KMFA/tools/v014_s09_p3_scope_reconciliation.py",
            "KMFA/tools/check_v014_s09_p3_scope_reconciliation.py",
            "KMFA/tests/test_v014_s09_p3_scope_reconciliation.py",
        ],
...
def write_report(manifest: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        (
            ...
            "or write generated files inside the local finance inbox. It only reused "
...
def write_risk_register() -> None:
    lines = [
        "# KMFA v0.1.4 S09-P3 Risk Register",
        "",
        f"- task_id: `{TASK_ID}`",
        "- R1: pending owner or authorized difference review remains open; derived metric rerun is blocked.",
        "- R2: public evidence must stay aggregate/hash/ref/status only; raw values, source filenames, field headers and business amounts are forbidden.",
        "- R3: Stage 9 review must be a separate run; this phase cannot imply review, upload, formal report, or business execution readiness.",
        "- R4: raw/private inbox access was not required for this phase; any future raw evidence check needs an explicit phase gate and private runtime output.",
        "",
    ]
...
def main() -> int:
    ...
    summary = manifest["legacy_s09_p3_summary"]
    print(
        "PASS: KMFA v0.1.4 S09-P3 scope reconciliation generated "
