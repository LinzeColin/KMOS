#!/usr/bin/env python3
"""Prepare blocked handoff after external-action final-threshold reminder.
...
TASK_ID = (
    ...
    "AGENT-EXTERNAL-ACTION-FINAL-THRESHOLD-BLOCKED-HANDOFF-AFTER-REMINDER-20260708"
)
ACCEPTANCE_ID = (
    "ACC-V014-RESIDUAL-DIFFERENCE-AUTHORIZED-SOURCE-REFERENCE-OR-EXCLUSION-APPLICATION-OWNER-OR-"
    "AGENT-EXTERNAL-ACTION-FINAL-THRESHOLD-BLOCKED-HANDOFF-AFTER-REMINDER"
)
VERSION = (
    "0.1.4-residual-difference-authorized-source-reference-or-exclusion-application-owner-or-agent-"
    "external-action-final-threshold-blocked-handoff-after-reminder"
)
STATUS = (
    "completed_validated_local_only_authorized_source_reference_or_exclusion_application_owner_or_agent_"
    "external_action_final_threshold_blocked_handoff_after_reminder_no_go_blocked"
)
DECISION = "NO_GO"
HANDOFF_CONCLUSION = "blocked_after_external_action_final_threshold_requires_owner_or_authorized_agent_action"
...
SOURCE_EXTERNAL_ACTION_FINAL_THRESHOLD_SUMMARY_PATH = SOURCE_FINAL_THRESHOLD_SUMMARY_PATH
SOURCE_EXTERNAL_ACTION_FINAL_THRESHOLD_MANIFEST_PATH = SOURCE_FINAL_THRESHOLD_MANIFEST_PATH
SOURCE_EXTERNAL_ACTION_FINAL_THRESHOLD_GO_NO_GO_PATH = SOURCE_FINAL_THRESHOLD_GO_NO_GO_PATH
SOURCE_EXTERNAL_ACTION_FINAL_THRESHOLD_MATRIX_PATH = SOURCE_FINAL_THRESHOLD_MATRIX_PATH
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_DIAGNOSTIC_PATH = (
    source_final_threshold.PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_DIAGNOSTIC_PATH
)
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_RECORDS_PATH = (
    source_final_threshold.PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_RECORDS_PATH
)
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_REPORT_PATH = (
    source_final_threshold.PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_REPORT_PATH
)

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder"
)
...
PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH = (
    PRIVATE_OUTPUT_DIR / "private_owner_or_agent_external_action_blocked_handoff_owner_action_queue.jsonl"
)
PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_PACKET_PATH = PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH
PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_REPORT_PATH = (
    PRIVATE_OUTPUT_DIR / "private_owner_or_agent_external_action_blocked_handoff_report.md"
)
...
def _phase_public_files() -> list[str]:
    return [
        ...
        "KMFA/tests/test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder.py",
        "KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder.py",
        "KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder.py",
        "KMFA/功能清单.md",
        "KMFA/开发记录.md",
        "KMFA/模型参数文件.md",
    ]
...
def _raw_boundary() -> dict[str, bool]:
    return {
        ...
        "source_external_action_final_threshold_public_artifacts_read_by_this_phase": True,
        "source_final_threshold_manifest_read_by_this_phase": True,
        "source_external_action_final_threshold_manifest_read_by_this_phase": True,
        "source_final_threshold_go_no_go_read_by_this_phase": True,
        "source_external_action_final_threshold_go_no_go_read_by_this_phase": True,
        "source_final_threshold_matrix_read_by_this_phase": True,
        "source_external_action_final_threshold_matrix_read_by_this_phase": True,
        "source_private_external_action_final_threshold_diagnostic_read_by_this_phase": True,
        "source_private_external_action_final_threshold_records_read_by_this_phase": True,
        "source_private_external_action_final_threshold_report_existence_checked_by_this_phase": True,
        ...
        "private_external_action_owner_action_queue_written_by_this_phase": True,
        "private_external_action_owner_action_packet_written_by_this_phase": True,
        "private_external_action_blocked_handoff_report_written_by_this_phase": True,
        "source_private_external_action_final_threshold_diagnostic_mutated_by_this_phase": False,
        "source_private_external_action_final_threshold_records_mutated_by_this_phase": False,
        "source_private_external_action_final_threshold_report_mutated_by_this_phase": False,
...
def _public_safety() -> dict[str, bool]:
    return {
        ...
        "source_private_external_action_final_threshold_diagnostic_committed": False,
        "source_private_external_action_final_threshold_records_committed": False,
        "source_private_external_action_final_threshold_report_committed": False,
        ...
        "private_external_action_owner_action_queue_committed": False,
        "private_external_action_blocked_handoff_report_committed": False,
...
def _build_private_records(
    *, generated_at: str, final_rows: list[dict[str, Any]]
    ...
    for index, row in enumerate(final_rows, start=1):
        ...
        if row.get("external_action_final_threshold_status") != source_final_threshold.FINAL_THRESHOLD_CONCLUSION:
            raise ValueError("source final-threshold row is not blocked")
        if row.get("external_action_blocker_observation_count") != 3:
            raise ValueError("source final-threshold row must be third observation")
        if row.get("external_action_blocked_audit_threshold_met") is not True:
        ...
        owner_action_item_id = f"ASR-OE-APP-OWNER-AGENT-EXTERNAL-ACTION-OWNER-ACTION-{index:03d}"
        handoff = {
            "blocked_handoff_item_id": f"ASR-OE-APP-OWNER-AGENT-EXTERNAL-ACTION-BLOCKED-HANDOFF-{index:03d}",
            "owner_action_item_id": owner_action_item_id,
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
            "generated_at": generated_at,
            "source_external_action_final_threshold_item_id": row.get(
                "external_action_final_threshold_item_id"
            ),
            "source_external_action_blocked_handoff_item_id": row.get(
                "source_external_action_blocked_handoff_item_id"
            ),
            "source_owner_action_reminder_item_id": row.get("source_owner_action_reminder_item_id"),
...
def _validate_sources(
    *,
    ...
    if source_summary.get("external_owner_action_blocker_count") != 48:
        raise ValueError("source external-action final-threshold count must be 48")
    if source_summary.get("external_owner_action_ready_count") != 0:
        raise ValueError("source external-action ready count must be 0")
    if source_summary.get("external_action_blocked_audit_threshold_met") is not True:
...
def _build_summary(
    *,
    ...
    return {
        "schema_version": (
            "kmfa.v014_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_"
            "blocker_blocked_handoff_after_final_threshold_summary.v1"
        ),
        "record_type": (
            "v014_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_"
        ...
        "source_external_action_final_threshold_item_count": source_summary.get(
            "private_final_threshold_records_item_count"
        ),
        "source_external_action_final_threshold_recheck_item_count": source_summary.get(
            "private_final_threshold_records_item_count"
        ),
        ...
        "source_owner_external_action_count": source_summary.get("external_owner_action_blocker_count"),
        "source_owner_external_action_ready_count": source_summary.get("external_owner_action_ready_count"),
        "source_private_external_action_final_threshold_records_item_count": len(final_rows),
        ...
        "owner_action_packet_item_count": len(owner_action_rows),
        "owner_action_required_count": len(owner_action_rows),
        "goal_status_recommendation": "blocked",
        "external_action_blocked_audit_threshold_met": True,
        "external_owner_action_ready_count": 0,
        "external_owner_action_blocker_count": len(handoff_rows),
        "owner_external_action_ready_count": 0,
        "owner_external_action_count": len(handoff_rows),
        "valid_owner_external_action_count": len(handoff_rows),
        ...
        "binding_ready_after_final_threshold_blocked_handoff_count": 0,
        "comparison_retry_ready_after_final_threshold_blocked_handoff_count": 0,
        ...
        "private_external_action_owner_action_queue_written": True,
        "private_external_action_blocked_handoff_report_written": True,
        "private_external_action_blocked_handoff_diagnostic_gitignored": _git_check_ignored(
            PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_DIAGNOSTIC_PATH
        ),
        "private_external_action_blocked_handoff_records_gitignored": _git_check_ignored(PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_RECORDS_PATH),
        "private_external_action_owner_action_queue_gitignored": _git_check_ignored(PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH),
        "private_external_action_owner_action_packet_gitignored": _git_check_ignored(PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_PACKET_PATH),
        "private_external_action_blocked_handoff_report_gitignored": _git_check_ignored(PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_REPORT_PATH),
        "source_private_external_action_final_threshold_diagnostic_gitignored": _git_check_ignored(
            SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_DIAGNOSTIC_PATH
        ),
        "source_private_external_action_final_threshold_records_gitignored": _git_check_ignored(
            SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_RECORDS_PATH
        ),
        "source_private_external_action_final_threshold_report_gitignored": _git_check_ignored(
            SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_REPORT_PATH
        ),
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ...
        (
            ...
            summary["source_external_action_final_threshold_recheck_item_count"] == 48,
        ),
        ("source_blockers_complete", summary["source_external_owner_action_blocker_count"] == 48),
        (
            "source_private_final_threshold_records_complete",
            summary["source_private_external_action_final_threshold_records_item_count"] == 48,
        ),
        ("blocked_handoff_complete", summary["blocked_handoff_item_count"] == 48),
        ("owner_action_queue_complete", summary["owner_action_packet_item_count"] == 48),
        (
            "blocked_goal_preserved",
            summary["goal_status_recommendation"] == "blocked"
            and summary["external_action_blocked_audit_threshold_met"] is True,
        ),
        (
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "owner_action_packet_item_count": summary["owner_action_packet_item_count"],
        "owner_action_required_count": summary["owner_action_required_count"],
        "goal_status_recommendation": "blocked",
        "external_action_blocked_audit_threshold_met": True,
        "external_owner_action_ready_count": 0,
        "external_owner_action_blocker_count": summary["external_owner_action_blocker_count"],
        "owner_external_action_ready_count": 0,
        "owner_external_action_count": summary["owner_external_action_count"],
        "actionable_owner_resolution_count": 0,
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "source_artifacts": {
            ...
            "source_private_external_action_final_threshold_diagnostic": "ignored_private_runtime",
            "source_private_external_action_final_threshold_records": "ignored_private_runtime",
            "source_private_external_action_final_threshold_report": "ignored_private_runtime",
        },
        ...
        "private_artifact_refs": [
            ...
            "private:owner_or_agent_external_action_blocked_handoff_owner_action_queue",
            "private:owner_or_agent_external_action_blocked_handoff_report",
        ],
        "raw_boundary": summary["raw_boundary"],
        "public_safety": summary["public_safety"],
        "test_commands": [
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder.py --generated-at 2026-07-08T00:00:00+10:00",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder.py --require-private-blocked-handoff",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder",
        ],
        "git": {
...
def _write_private_outputs(
    *,
    ...
    _write_json(
        ...
        {
            "schema_version": (
                "kmfa.private.v014_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_"
    ...
    _write_jsonl(PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH, owner_action_rows)
    _write_text(
        PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_REPORT_PATH,
        "\n".join(
            [
                "# Private External Action Final-Threshold Blocked Handoff After Reminder Report",
                "",
                f"- phase_id: `{PHASE_ID}`",
...
def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    _write_text(
        REPORT_PATH,
        f"""# V014 External Action Final-Threshold Blocked Handoff After Reminder
...
- Source final-threshold items: `{summary["source_external_action_final_threshold_recheck_item_count"]}`
- Source external-action final-threshold blockers: `{summary["source_external_owner_action_blocker_count"]}`
- Source private final-threshold records: `{summary["source_private_external_action_final_threshold_records_item_count"]}`
- Blocked handoff items: `{summary["blocked_handoff_item_count"]}`
- Owner action packet items: `{summary["owner_action_packet_item_count"]}`
- Goal status recommendation: `{summary["goal_status_recommendation"]}`
- External action blocked audit threshold met: `{str(summary["external_action_blocked_audit_threshold_met"]).lower()}`
...
- Binding ready after final-threshold blocked handoff: `{summary["binding_ready_after_final_threshold_blocked_handoff_count"]}`
- Comparison retry ready after final-threshold blocked handoff: `{summary["comparison_retry_ready_after_final_threshold_blocked_handoff_count"]}`
...
def _write_governance_events(generated_at: str, summary: dict[str, Any]) -> None:
    ...
    _upsert_jsonl(
        DEVELOPMENT_EVENTS_PATH,
        {
            ...
            "summary": (
                ...
                "external-action final-threshold blockers; binding, comparison and upload gates remain closed."
            ),
    ...
    _upsert_jsonl(
        TASK_STATUS_PATH,
        {
            ...
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
            "name": "v0.1.4 owner/agent external-action final-threshold blocked handoff after final threshold",
            "status": STATUS,
            ...
            "stage_id": "VALUE-CONSISTENCY",
            "phase_goal": "prepare blocked handoff and owner action queue after final external-action final-threshold threshold",
            "task_count": 3,
            "acceptance_output": (
    ...
    for suffix, task_goal in (
        ...
        ("T2", "write ignored private blocked-handoff records and owner-action queue for 48 external-action final-thresholds"),
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    final_rows = _read_jsonl(SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_RECORDS_PATH)
    if not SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_DIAGNOSTIC_PATH.exists():
        raise FileNotFoundError(SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_DIAGNOSTIC_PATH)
    if not SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_REPORT_PATH.exists():
        raise FileNotFoundError(SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_REPORT_PATH)
    _validate_sources(
    ...
    return {
        ...
        "private_external_action_owner_action_queue": owner_action_rows,
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: generated V014 owner/agent external-action final-threshold blocked handoff after final threshold "
