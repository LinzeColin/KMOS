#!/usr/bin/env python3
"""Generate KMFA v0.1.3 S04-P1 amount precision evidence.

This phase replays existing S04-P1 amount normalization and no-float behavior
with synthetic public-safe values only. It does not read the local raw data
inbox, perform raw value matching, run Stage 4 review, upload to GitHub, or
...
PUBLIC_OUTPUT_DIR = Path("KMFA/stage_artifacts/V013_S04_P1_AMOUNT_PRECISION")
...
SCHEMA_VERSION = "kmfa.v013_s04_p1_amount_precision.v1"
...
def replay_amount_precision_capability() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="kmfa-v013-s04p1-") as tmp:
...
def build_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "phase_id": "S04-P1",
        "phase_name": "amount precision and no-float replay",
        ...
        "s03_stage_review_dependency_ref": "KMFA/stage_artifacts/V013_S03_STAGE_REVIEW/machine/stage3_review_manifest.json",
        ...
        "validators": [
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v013_s04_p1_amount_precision.py",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v013_s04_p1_amount_precision.py",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v013_s04_p1_amount_precision -q",
        ...
        "evidence_refs": [
            ...
            "KMFA/tools/v013_s04_p1_amount_precision.py",
            "KMFA/tools/check_v013_s04_p1_amount_precision.py",
            "KMFA/tests/test_v013_s04_p1_amount_precision.py",
            "KMFA/tools/amount_tools.py",
            "KMFA/tools/check_no_float_money.py",
            "KMFA/tests/test_amount_tools.py",
        ...
        "next_required_step": (
            "Proceed to v0.1.3 S04-P2 field standardization replay as a separate run; do not perform "
            "Stage 4 review, GitHub upload, raw value matching, lineage full check, formal report release, "
            "live connector, or business execution in S04-P1."
        ),
    }
...
def write_pending_test_results() -> None:
    ...
    lines = [
        ...
        "- red_step: `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v013_s04_p1_amount_precision -q` failed before validator implementation with missing module.",
...
def main() -> int:
    manifest = generate()
    print(
        "PASS: KMFA v0.1.3 S04-P1 amount precision evidence generated "
