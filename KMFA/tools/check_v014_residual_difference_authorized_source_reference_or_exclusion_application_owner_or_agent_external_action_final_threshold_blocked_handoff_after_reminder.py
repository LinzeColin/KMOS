#!/usr/bin/env python3
"""Validate blocked handoff after external-action final-threshold final threshold."""
...
from KMFA.tools.v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder import (  # noqa: E402
    ACCEPTANCE_ID,
    DECISION,
...
def _check_raw_boundary(raw_boundary: dict[str, Any]) -> None:
    true_keys = (
        ...
        "source_private_external_action_final_threshold_diagnostic_read_by_this_phase",
        "source_private_external_action_final_threshold_records_read_by_this_phase",
        "source_private_external_action_final_threshold_report_existence_checked_by_this_phase",
        ...
        "private_external_action_owner_action_queue_written_by_this_phase",
        "private_external_action_blocked_handoff_report_written_by_this_phase",
    )
    false_keys = (
        "source_private_external_action_final_threshold_diagnostic_mutated_by_this_phase",
        "source_private_external_action_final_threshold_records_mutated_by_this_phase",
        "source_private_external_action_final_threshold_report_mutated_by_this_phase",
...
def _check_summary(
    ...
    _require_equal(
        ...
        summary.get("source_external_action_final_threshold_recheck_item_count"),
        48,
    )
    _require_equal("summary.source blockers", summary.get("source_owner_external_action_count"), 48)
    _require_equal("summary.source ready", summary.get("source_owner_external_action_ready_count"), 0)
    _require_equal(
        "summary.source private final threshold records",
        summary.get("source_private_external_action_final_threshold_records_item_count"),
        48,
    )
    ...
    _require_true("summary.threshold", summary.get("external_action_blocked_audit_threshold_met"))
    _require_equal("summary.ready", summary.get("owner_external_action_ready_count"), 0)
    _require_equal("summary.blocker", summary.get("owner_external_action_count"), 48)
    _require_equal("summary.valid", summary.get("valid_owner_external_action_count"), 48)
    ...
    for key in (
        ...
        "private_external_action_owner_action_queue_written",
        "private_external_action_blocked_handoff_report_written",
        "private_external_action_blocked_handoff_diagnostic_gitignored",
        "private_external_action_blocked_handoff_records_gitignored",
        "private_external_action_owner_action_queue_gitignored",
        "private_external_action_blocked_handoff_report_gitignored",
        "source_private_external_action_final_threshold_diagnostic_gitignored",
        "source_private_external_action_final_threshold_records_gitignored",
        "source_private_external_action_final_threshold_report_gitignored",
    ...
    _require_true("go_no_go.threshold", go_no_go.get("external_action_blocked_audit_threshold_met"))
    _require_equal("go_no_go.ready", go_no_go.get("owner_external_action_ready_count"), 0)
    _require_equal("go_no_go.blocker", go_no_go.get("owner_external_action_count"), 48)
...
def _check_private_artifacts() -> None:
    ...
    owner_action_rows = _read_jsonl(PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH)
    ...
    for row in handoff_rows:
        ...
        _require_true("private threshold met", row.get("external_action_blocked_audit_threshold_met"))
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: validated V014 owner/agent external-action final-threshold blocked handoff after final threshold "
