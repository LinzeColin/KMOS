#!/usr/bin/env python3
"""Validate owner or authorized-agent action intake blocker blocked handoff external action readiness after final threshold."""
...
from KMFA.tools.v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_action_intake_blocker_blocked_handoff_external_action_readiness_after_final_threshold import (  # noqa: E402
    ACCEPTANCE_ID,
    DECISION,
...
def _check_summary(
    ...
    _require_true("summary.source threshold", summary.get("source_action_intake_blocked_audit_threshold_met"))
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: validated V014 owner/authorized-agent action intake blocker blocked handoff external action readiness after final threshold "
