#!/usr/bin/env python3
"""Validate blocked handoff after generated diagnostic response final threshold."""
...
from KMFA.tools.v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_generated_diagnostic_response_blocked_handoff_after_final_threshold import (  # noqa: E402
    ACCEPTANCE_ID,
    DECISION,
...
def _check_raw_boundary(raw_boundary: dict[str, Any]) -> None:
    true_keys = (
        ...
        "source_private_actionability_final_threshold_diagnostic_read_by_this_phase",
        "source_private_actionability_final_threshold_records_read_by_this_phase",
        "source_private_actionability_final_threshold_report_existence_checked_by_this_phase",
        "private_blocked_handoff_diagnostic_written_by_this_phase",
        "private_blocked_handoff_records_written_by_this_phase",
        "private_owner_action_queue_written_by_this_phase",
        "private_blocked_handoff_report_written_by_this_phase",
    )
    false_keys = (
        "source_private_actionability_final_threshold_diagnostic_mutated_by_this_phase",
        "source_private_actionability_final_threshold_records_mutated_by_this_phase",
        "source_private_actionability_final_threshold_report_mutated_by_this_phase",
...
def _check_summary(
    ...
    _require_equal(
        ...
        summary.get("source_actionability_blocker_final_threshold_recheck_item_count"),
        48,
    )
    _require_equal("summary.source blockers", summary.get("source_actionability_blocker_count"), 48)
    _require_equal(
        "summary.source private final threshold records",
        summary.get("source_private_actionability_final_threshold_records_item_count"),
        48,
    )
    ...
    for key in (
        "private_blocked_handoff_diagnostic_written",
        "private_blocked_handoff_records_written",
        "private_owner_action_queue_written",
        "private_blocked_handoff_report_written",
        "private_blocked_handoff_diagnostic_gitignored",
        "private_blocked_handoff_records_gitignored",
        "private_owner_action_queue_gitignored",
        "private_blocked_handoff_report_gitignored",
        "source_private_actionability_final_threshold_diagnostic_gitignored",
        "source_private_actionability_final_threshold_records_gitignored",
        "source_private_actionability_final_threshold_report_gitignored",
    ...
    _require_true("go_no_go.threshold", go_no_go.get("actionability_blocked_audit_threshold_met"))
...
def _check_private_artifacts() -> None:
    ...
    diagnostic = _read_json(PRIVATE_BLOCKED_HANDOFF_DIAGNOSTIC_PATH)
    handoff_rows = _read_jsonl(PRIVATE_BLOCKED_HANDOFF_RECORDS_PATH)
    owner_action_rows = _read_jsonl(PRIVATE_OWNER_ACTION_QUEUE_PATH)
    ...
    for row in owner_action_rows:
        ...
        _require_true("actionable resolution required", row.get("actionable_resolution_required"))
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: validated V014 generated owner/agent diagnostic response blocked handoff after final threshold "
