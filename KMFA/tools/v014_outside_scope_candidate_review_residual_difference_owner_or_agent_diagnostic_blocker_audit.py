#!/usr/bin/env python3
"""Audit residual-difference owner/agent diagnostic blockers.

This phase consumes the previous public-safe readiness evidence plus the
ignored private readiness diagnostic and blocker queue. It records the second
consecutive observation that all 72 residual differences still lack valid
owner/agent diagnostic responses. It does not read or mutate the raw inbox,
close discrepancies, correct source maps, compare values, upload, reinstall,
...
ACCEPTANCE_ID = "ACC-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-OWNER-OR-AGENT-DIAGNOSTIC-BLOCKER-AUDIT"
...
DECISION = "NO_GO"
AUDIT_CONCLUSION = "private_owner_or_agent_diagnostic_blocker_observed_second_time_without_valid_response"
NEXT_REQUIRED_INPUT = (
...
SUMMARY_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_summary.json"
MANIFEST_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_manifest.json"
GO_NO_GO_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_go_no_go_report.json"
MATRIX_PATH = MACHINE_DIR / "outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_matrix_public_safe.json"
REPORT_PATH = HUMAN_DIR / "outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit.md"
GO_NO_GO_RECORD_PATH = HUMAN_DIR / "go_no_go_record.md"
TEST_RESULTS_PATH = HUMAN_DIR / "test_results.md"
RISK_REGISTER_PATH = HUMAN_DIR / "risk_register.md"
ROLLBACK_PATH = HUMAN_DIR / "rollback_plan.md"

METADATA_SUMMARY_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_summary.json"
METADATA_MANIFEST_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_manifest.json"
METADATA_GO_NO_GO_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_go_no_go_report.json"
METADATA_MATRIX_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit_matrix_public_safe.json"

SOURCE_PUBLIC_SUMMARY_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_readiness_recheck_summary.json"
SOURCE_PUBLIC_MANIFEST_PATH = PROJECT_ROOT / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_readiness_recheck_manifest.json"
SOURCE_PRIVATE_READINESS_DIAGNOSTIC_PATH = PROJECT_ROOT / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_readiness_recheck/private_owner_or_agent_diagnostic_readiness_recheck_diagnostic.json"
SOURCE_PRIVATE_BLOCKER_QUEUE_PATH = PROJECT_ROOT / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_readiness_recheck/private_owner_or_agent_diagnostic_readiness_blocker_queue.jsonl"

PRIVATE_OUTPUT_DIR = PROJECT_ROOT / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit"
PRIVATE_AUDIT_DIAGNOSTIC_PATH = PRIVATE_OUTPUT_DIR / "private_owner_or_agent_diagnostic_blocker_audit_diagnostic.json"
...
def _build_summary(
    *, generated_at: str, source_summary: dict[str, Any], source_private_diagnostic: dict[str, Any], blocker_queue: list[dict[str, Any]]
) -> dict[str, Any]:
    prior_observation_count = 1 if source_summary.get("diagnostic_response_blocker_count") == 72 else 0
    observation_count = prior_observation_count + 1
    threshold_met = observation_count >= 3
    return {
        "schema_version": "kmfa.v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_summary.v1",
        "record_type": "v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_summary",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_private_diagnostic_response_template_item_count": source_summary.get("source_private_diagnostic_response_template_item_count"),
        "source_private_diagnostic_pending_queue_item_count": source_summary.get("source_private_diagnostic_pending_queue_item_count"),
        "source_private_readiness_blocker_queue_item_count": len(blocker_queue),
        "diagnostic_response_ready_count": source_summary.get("diagnostic_response_ready_count"),
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ("source_phase_is_diagnostic_readiness_recheck", summary["source_phase_id"] == "V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_OWNER_OR_AGENT_DIAGNOSTIC_READINESS_RECHECK"),
        ("prior_observation_count_one", summary["prior_diagnostic_blocker_observation_count"] == 1),
        ("current_observation_count_two", summary["diagnostic_blocker_observation_count"] == 2),
        ("blocked_threshold_not_met", summary["diagnostic_blocked_audit_threshold_met"] is False),
    ...
    return {
        "schema_version": "kmfa.v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_matrix_public_safe.v1",
        "record_type": "v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_matrix_public_safe",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_go_no_go.v1",
        "record_type": "v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_go_no_go",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _write_private_diagnostic(generated_at: str, summary: dict[str, Any]) -> dict[str, Any]:
    diagnostic = {
        "schema_version": "kmfa.private.v014_residual_difference_owner_or_agent_diagnostic_blocker_audit.v1",
        "classification": "private_owner_or_agent_diagnostic_blocker_audit_do_not_commit",
        "record_type": "v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_diagnostic",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    report = f"""# V014 Residual Difference Owner / Agent Diagnostic Blocker Audit
...
- Decision: `{DECISION}`
- Status: `{STATUS}`
- Source: prior public-safe diagnostic-readiness evidence plus ignored private readiness diagnostic and blocker queue.
...
- Reason: all 72 residual differences still lack valid owner/agent diagnostic responses.
...
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit.py --generated-at 2026-07-07T00:00:00+10:00`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit.py --require-private-diagnostic`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_outside_scope_candidate_review_residual_difference_owner_or_agent_diagnostic_blocker_audit`

Expected matrix result: {matrix["blocker_audit_check_pass_count"]}/{matrix["blocker_audit_check_count"]} PASS.
"""
    risk_register = """# Risk Register

- Risk: blocker audit may be mistaken for permission to auto-close discrepancies.
...
Remove the artifacts for `{PHASE_ID}`, metadata copies, private audit diagnostic, tool, validator, focused test and governance entries. Do not touch prior private diagnostics, blocker queues or raw inbox files.
"""
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_manifest.v1",
        "record_type": "v014_residual_difference_owner_or_agent_diagnostic_blocker_audit_manifest",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_artifacts": {
            ...
            "prior_private_readiness_blocker_queue": "ignored_private_runtime",
        },
        ...
        "private_artifact_refs": ["private:owner_or_agent_diagnostic_blocker_audit_diagnostic"],
        "raw_boundary": summary["raw_boundary"],
...
def _write_governance_events(generated_at: str, manifest: dict[str, Any]) -> None:
    event = {
        "event_id": "DEV-KMFA-20260707-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-OWNER-OR-AGENT-DIAGNOSTIC-BLOCKER-AUDIT",
        ...
        "iteration_id": "ITER-20260707-KMFA-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-OWNER-OR-AGENT-DIAGNOSTIC-BLOCKER-AUDIT",
        "task_id": TASK_ID,
        "version": VERSION,
        "go_no_go": DECISION,
        "result_commit": "PENDING",
        "summary": "Recorded the second residual-difference owner or agent diagnostic blocker observation and kept all downstream gates closed.",
        ...
        "diagnostic_blocker_observation_count": 2,
        "diagnostic_blocked_audit_threshold_met": False,
        "source_map_correction_ready": False,
    ...
    _append_jsonl(
        ...
        {
            "acceptance_id": ACCEPTANCE_ID,
            "acceptance_output": "Residual difference owner or agent diagnostic blocker audit manifest summary Go No-Go public-safe matrix private ignored diagnostic validator focused test and governance records",
            ...
            "name": "v0.1.4 residual difference owner or agent diagnostic blocker audit",
            "phase_goal": "record the second diagnostic-response blocker observation without accepting a valid response or closing differences",
            "phase_id": PHASE_ID,
            "project_id": "KMFA",
            "raw_data_committed": False,
            "record_type": "v014_phase",
            "roadmap_phase_id": "OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_OWNER_OR_AGENT_DIAGNOSTIC_BLOCKER_AUDIT",
    ...
    for index, task_goal in enumerate(
        [
            "read prior public-safe readiness evidence and ignored private blocker queue read-only",
            "record second diagnostic blocker observation while threshold remains unmet",
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    blocker_queue = _read_jsonl(SOURCE_PRIVATE_BLOCKER_QUEUE_PATH)
...
def main() -> int:
    ...
    print(
        "PASS: generated V014 residual-difference owner/agent diagnostic blocker audit "
