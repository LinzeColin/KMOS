#!/usr/bin/env python3
"""Audit owner/agent diagnostic blockers after readiness recheck.

This phase consumes the prior public-safe readiness recheck evidence plus the
ignored private readiness diagnostic, blocker queue and report. It records the
second observation that all 48 owner/agent diagnostic responses remain blocked.
...
TASK_ID = (
    ...
    "OWNER-OR-AGENT-DIAGNOSTIC-BLOCKER-AUDIT-AFTER-READINESS-RECHECK-20260708"
)
ACCEPTANCE_ID = (
    "ACC-V014-RESIDUAL-DIFFERENCE-AUTHORIZED-SOURCE-REFERENCE-OR-EXCLUSION-APPLICATION-"
    "OWNER-OR-AGENT-DIAGNOSTIC-BLOCKER-AUDIT-AFTER-READINESS-RECHECK"
)
VERSION = (
...
STATUS = (
    ...
    "owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_no_go"
)
DECISION = "NO_GO"
AUDIT_CONCLUSION = "owner_or_agent_diagnostic_blocker_audited_second_observation_no_valid_response"
...
SOURCE_PUBLIC_SUMMARY_PATH = source_readiness.METADATA_SUMMARY_PATH
SOURCE_PUBLIC_MANIFEST_PATH = source_readiness.METADATA_MANIFEST_PATH
SOURCE_PUBLIC_GO_NO_GO_PATH = source_readiness.METADATA_GO_NO_GO_PATH
SOURCE_PUBLIC_MATRIX_PATH = source_readiness.METADATA_MATRIX_PATH
SOURCE_PRIVATE_READINESS_DIAGNOSTIC_PATH = source_readiness.PRIVATE_READINESS_DIAGNOSTIC_PATH
SOURCE_PRIVATE_BLOCKER_QUEUE_PATH = source_readiness.PRIVATE_BLOCKER_QUEUE_PATH
SOURCE_PRIVATE_READINESS_REPORT_PATH = source_readiness.PRIVATE_READINESS_REPORT_PATH

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck"
)
PRIVATE_AUDIT_DIAGNOSTIC_PATH = PRIVATE_OUTPUT_DIR / "private_owner_or_agent_diagnostic_blocker_audit_diagnostic.json"
PRIVATE_AUDIT_QUEUE_PATH = PRIVATE_OUTPUT_DIR / "private_owner_or_agent_diagnostic_blocker_audit_queue.jsonl"
PRIVATE_AUDIT_REPORT_PATH = PRIVATE_OUTPUT_DIR / "private_owner_or_agent_diagnostic_blocker_audit_report.md"
...
def _phase_public_files() -> list[str]:
    return [
        ...
        "KMFA/tests/test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py",
        "KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py",
        "KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py",
        "KMFA/功能清单.md",
        "KMFA/开发记录.md",
        "KMFA/模型参数文件.md",
    ]
...
def _build_audit_rows(*, generated_at: str, blocker_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    rows: list[dict[str, Any]] = []
    for index, blocker in enumerate(blocker_rows, start=1):
        rows.append(
            {
                "audit_item_id": f"ASR-OE-APP-OWNER-AGENT-BLOCKER-AUDIT-{index:03d}",
                "phase_id": PHASE_ID,
                "task_id": TASK_ID,
                "generated_at": generated_at,
                "source_blocker_item_id": blocker.get("blocker_item_id"),
...
def _build_summary(
    *,
    ...
    diagnostic_counts = Counter(str(row.get("diagnostic_kind")) for row in audit_rows)
    prior_observation_count = (
        1
        if source_summary.get("diagnostic_response_blocker_count") == 48
        and source_summary.get("valid_diagnostic_response_count") == 0
        else 0
    )
    observation_count = prior_observation_count + 1
    threshold_met = observation_count >= 3
    return {
        "schema_version": "kmfa.v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_summary.v1",
        "record_type": "v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_summary",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_private_readiness_blocker_queue_item_count": len(source_blocker_rows),
        ...
        "diagnostic_response_blocker_count": len(audit_rows),
        "private_audit_queue_item_count": len(audit_rows),
        "pending_diagnostic_response_count": len(audit_rows),
        ...
        "binding_ready_after_blocker_audit_count": 0,
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ("source_readiness_loaded", summary["source_phase_id"] == source_readiness.PHASE_ID),
        ...
        ("source_blocker_queue_loaded", summary["source_private_readiness_blocker_queue_item_count"] == 48),
    ...
    return {
        "schema_version": "kmfa.v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_matrix_public_safe.v1",
        "record_type": "v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_matrix_public_safe",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_go_no_go.v1",
        "record_type": "v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_go_no_go",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_manifest.v1",
        "record_type": "v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_manifest",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_artifacts": {
            ...
            "source_private_blocker_queue": "ignored_private_runtime",
            "source_private_readiness_report": "ignored_private_runtime",
        },
        ...
        "private_artifact_refs": [
            "private:owner_or_agent_diagnostic_blocker_audit_diagnostic",
            "private:owner_or_agent_diagnostic_blocker_audit_queue",
            "private:owner_or_agent_diagnostic_blocker_audit_report",
        ],
        "raw_boundary": summary["raw_boundary"],
        "public_safety": summary["public_safety"],
        "test_commands": [
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py --generated-at 2026-07-08T00:00:00+10:00",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py --require-private-audit",
            "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck",
        ],
        "git": {
...
def _write_private_outputs(*, generated_at: str, summary: dict[str, Any], audit_rows: list[dict[str, Any]]) -> None:
    _write_json(
        ...
        {
            "schema_version": "kmfa.private.v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.v1",
            "classification": "private_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_do_not_commit",
            "record_type": "v014_authorized_resolution_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck_private_diagnostic",
            "project_id": "KMFA",
            "version": VERSION,
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
    ...
    _write_text(
        ...
        "\n".join(
            [
                "# Private Owner Or Agent Diagnostic Blocker Audit After Readiness Recheck",
                "",
                f"- phase_id: `{PHASE_ID}`",
                ...
                "",
                "This private audit output may contain private handles and must remain ignored.",
                "",
            ]
        ),
    )
...
def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    _write_text(
        REPORT_PATH,
        f"""# V014 Authorized Source Reference Or Exclusion Application Owner Or Agent Diagnostic Blocker Audit After Readiness Recheck
...
- RED: `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck` failed before implementation because the generator module did not exist.
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py --generated-at 2026-07-08T00:00:00+10:00`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck.py --require-private-audit`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_diagnostic_blocker_audit_after_readiness_recheck`
...
Remove artifacts for `{PHASE_ID}`, metadata copies, private audit outputs,
tool, validator, focused test and governance rows. Do not touch source readiness
...
def _write_governance_events(generated_at: str, summary: dict[str, Any]) -> None:
    ...
    _upsert_jsonl(
        DEVELOPMENT_EVENTS_PATH,
        {
            ...
            "decision": DECISION,
            "go_no_go": DECISION,
            "summary": "Audited owner/agent diagnostic blockers after readiness recheck; all 48 items remain blocked.",
    ...
    _upsert_jsonl(
        TASK_STATUS_PATH,
        {
            ...
            "phase_id": PHASE_ID,
            "name": "v0.1.4 authorized source reference or exclusion application owner/agent diagnostic blocker audit after readiness recheck",
            "status": STATUS,
            ...
            "stage_id": "VALUE-CONSISTENCY",
            "phase_goal": "audit the 48 owner/agent diagnostic blockers after readiness recheck without importing responses",
            "task_count": 3,
            "acceptance_output": "Owner/agent diagnostic blocker audit manifest, summary, Go No-Go, private audit queue, validator, focused test and governance records",
        },
        ("phase_id", "record_type", "task_id"),
    )
    for task_suffix, task_goal in (
        ("T1", "read prior owner/agent diagnostic readiness public artifacts and ignored private blocker queue read-only"),
        ("T2", "write ignored private owner/agent diagnostic blocker audit queue"),
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    if not SOURCE_PRIVATE_READINESS_REPORT_PATH.exists():
        raise FileNotFoundError(SOURCE_PRIVATE_READINESS_REPORT_PATH)
    audit_rows = _build_audit_rows(generated_at=generated, blocker_rows=source_blocker_rows)
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        f"owner/agent diagnostic blocker audit decision={summary['decision']} "
