...
PRIVATE_DIAGNOSTIC_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_processed_value_source_map_completion_application/private_completion_application_diagnostic.json"
)
...
PUBLIC_ARTIFACTS = [
    ...
    MANIFEST_PATH,
    GO_NO_GO_PATH,
    HUMAN_DIR / "processed_value_source_map_completion_application_report.md",
    HUMAN_DIR / "owner_agent_completion_application_packet.md",
    HUMAN_DIR / "go_no_go_record.md",
    HUMAN_DIR / "risk_register.md",
    HUMAN_DIR / "rollback_plan.md",
    QUALITY_DIR / "v014_processed_value_source_map_completion_application_summary.json",
    QUALITY_DIR / "v014_processed_value_source_map_completion_application_manifest.json",
    QUALITY_DIR / "v014_processed_value_source_map_completion_application_go_no_go_report.json",
]
...
def validate(*, require_private_diagnostic: bool = False) -> dict[str, Any]:
    ...
    _require_equal("summary.source_input_kit_decision", summary.get("source_input_kit_decision"), "NO_GO")
    ...
    _require_false("summary.source_map_completion_application_ready", summary.get("source_map_completion_application_ready"))
    _require_true("summary.source_map_completion_application_performed", summary.get("source_map_completion_application_performed"))
...
def main() -> None:
    ...
    print(
        "PASS: KMFA v0.1.4 processed value source-map completion application validated "
