#!/usr/bin/env python3
"""Recheck residual-difference source-map correction blocker threshold.

This phase consumes the previous public-safe source-map blocker audit plus its
ignored private blocker queue. It records the second source-map correction
blocker observation. It does not read or mutate the raw inbox, correct source
maps, close discrepancies, compare values, upload, reinstall, or execute
business steps.
"""
...
PHASE_ID = "V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_BLOCKER_THRESHOLD_RECHECK"
TASK_ID = "KMFA-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-BLOCKER-THRESHOLD-RECHECK-20260707"
ACCEPTANCE_ID = "ACC-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-BLOCKER-THRESHOLD-RECHECK"
...
DECISION = "NO_GO"
AUDIT_CONCLUSION = "source_map_correction_blocker_second_observation_after_response_import_readiness_recheck"
...
NEXT_RECOMMENDED_PHASE = (
    "V014_OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_BLOCKER_FINAL_THRESHOLD_RECHECK"
)
...
SUMMARY_PATH = (
    MACHINE_DIR
    / "outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck_summary.json"
)
MANIFEST_PATH = (
    MACHINE_DIR
    / "outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck_manifest.json"
)
GO_NO_GO_PATH = (
    MACHINE_DIR
    / "outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck_go_no_go_report.json"
)
MATRIX_PATH = (
    MACHINE_DIR
    / "outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck_matrix_public_safe.json"
)
REPORT_PATH = (
    HUMAN_DIR / "outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck.md"
)
...
SOURCE_SUMMARY_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit_summary.json"
)
SOURCE_MANIFEST_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit_manifest.json"
)
SOURCE_GO_NO_GO_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit_go_no_go_report.json"
)
SOURCE_MATRIX_PATH = (
    PROJECT_ROOT
    / "metadata/quality/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit_matrix_public_safe.json"
)
SOURCE_PRIVATE_AUDIT_DIAGNOSTIC_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit/private_source_map_correction_blocker_audit_diagnostic.json"
)
SOURCE_PRIVATE_AUDIT_QUEUE_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit/private_source_map_correction_blocker_queue.jsonl"
)
SOURCE_PRIVATE_AUDIT_REPORT_PATH = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_audit/private_source_map_correction_blocker_audit_report.md"
)

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_outside_scope_candidate_review_residual_difference_source_map_correction_blocker_threshold_recheck"
)
PRIVATE_THRESHOLD_DIAGNOSTIC_PATH = (
    PRIVATE_OUTPUT_DIR / "private_source_map_correction_blocker_threshold_recheck_diagnostic.json"
)
PRIVATE_THRESHOLD_QUEUE_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_blocker_threshold_queue.jsonl"
PRIVATE_THRESHOLD_REPORT_PATH = PRIVATE_OUTPUT_DIR / "private_source_map_correction_blocker_threshold_recheck_report.md"
...
def _raw_boundary() -> dict[str, bool]:
    return {
        ...
        "source_private_blocker_audit_queue_read_by_this_phase": True,
        ...
        "private_threshold_recheck_queue_written_by_this_phase": True,
        "private_threshold_recheck_report_written_by_this_phase": True,
        "source_private_blocker_audit_diagnostic_mutated_by_this_phase": False,
        "source_private_blocker_audit_queue_mutated_by_this_phase": False,
...
def _public_safety() -> dict[str, bool]:
    return {
        ...
        "source_private_blocker_audit_queue_committed": False,
        "source_private_blocker_audit_report_committed": False,
        "private_threshold_recheck_diagnostic_committed": False,
        "private_threshold_recheck_queue_committed": False,
        "private_threshold_recheck_report_committed": False,
...
def _build_private_threshold_queue(*, generated_at: str, source_audit_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    rows: list[dict[str, Any]] = []
    for index, row in enumerate(source_audit_rows, start=1):
        rows.append(
            {
                "threshold_item_id": f"OSCR-SMC-THRESHOLD-{index:03d}",
                "phase_id": PHASE_ID,
                "task_id": TASK_ID,
                ...
                "source_map_correction_ready_after_threshold_recheck": False,
                "discrepancy_closed_after_threshold_recheck": False,
                "blocker_reason_code": "second_observation_non_actionable_response_has_no_source_map_correction_authority",
                "audit_observation_count_after_this_phase": 2,
...
def _build_summary(
    *,
    ...
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_blocker_threshold_recheck_summary.v1",
        "record_type": "v014_residual_difference_source_map_correction_blocker_threshold_recheck_summary",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_blocker_audit_passed": source_matrix.get("check_fail_count") == 0,
        "source_private_audit_queue_item_count": len(source_audit_rows),
        "source_map_correction_blocker_threshold_recheck_performed": True,
        ...
        "source_map_correction_blocker_count": len(threshold_rows),
        ...
        "private_threshold_recheck_queue_written": True,
        "private_threshold_recheck_report_written": True,
        "private_threshold_recheck_diagnostic_gitignored": _git_check_ignored(PRIVATE_THRESHOLD_DIAGNOSTIC_PATH),
        "private_threshold_recheck_queue_gitignored": _git_check_ignored(PRIVATE_THRESHOLD_QUEUE_PATH),
        "private_threshold_recheck_report_gitignored": _git_check_ignored(PRIVATE_THRESHOLD_REPORT_PATH),
        "next_required_input": NEXT_REQUIRED_INPUT,
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ("source_blocker_audit_loaded", summary["source_phase_id"].endswith("SOURCE_MAP_CORRECTION_BLOCKER_AUDIT")),
        ("source_blocker_audit_valid", summary["source_go_no_go_decision"] == "NO_GO" and summary["source_matrix_check_fail_count"] == 0),
        ...
        ("prior_observation_count_one", summary["prior_source_map_correction_blocker_observation_count"] == 1),
        ("current_observation_count_two", summary["source_map_correction_blocker_observation_count"] == 2),
        ("threshold_not_met_on_second_observation", summary["source_map_correction_blocked_audit_threshold_met"] is False),
    ...
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_blocker_threshold_recheck_matrix_public_safe.v1",
        "record_type": "v014_residual_difference_source_map_correction_blocker_threshold_recheck_matrix_public_safe",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_blocker_threshold_recheck_go_no_go.v1",
        "record_type": "v014_residual_difference_source_map_correction_blocker_threshold_recheck_go_no_go",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
...
def _write_private_outputs(generated_at: str, summary: dict[str, Any], threshold_rows: list[dict[str, Any]]) -> dict[str, Any]:
    diagnostic = {
        "schema_version": "kmfa.private.v014_residual_difference_source_map_correction_blocker_threshold_recheck.v1",
        "classification": "private_source_map_correction_blocker_threshold_recheck_do_not_commit",
        "record_type": "v014_residual_difference_source_map_correction_blocker_threshold_recheck_diagnostic",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
    ...
    _write_text(
        ...
        "\n".join(
            [
                "# Private Source-Map Correction Blocker Threshold Recheck",
                "",
                f"- phase_id: `{PHASE_ID}`",
                ...
                "- conclusion: second observation remains below blocked threshold and supplies no correction authority.",
                "",
            ]
        ),
    )
...
def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    report = f"""# V014 Residual Difference Source-Map Correction Blocker Threshold Recheck
...
- Reason: source-map correction remains blocked, and the second observation is below the strict blocked threshold.
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": "kmfa.v014_residual_difference_source_map_correction_blocker_threshold_recheck_manifest.v1",
        "record_type": "v014_residual_difference_source_map_correction_blocker_threshold_recheck_manifest",
        "project_id": "KMFA",
        "version": VERSION,
        "phase_id": PHASE_ID,
        "task_id": TASK_ID,
        ...
        "source_artifacts": {
            ...
            "prior_blocker_audit_go_no_go": "public_safe_metadata_copy",
            "prior_blocker_audit_matrix": "public_safe_metadata_copy",
            "prior_private_blocker_audit_diagnostic": "ignored_private_runtime",
            "prior_private_blocker_audit_queue": "ignored_private_runtime",
        },
        ...
        "private_artifact_refs": [
            "private:source_map_correction_blocker_threshold_recheck_diagnostic",
            "private:source_map_correction_blocker_threshold_queue",
            "private:source_map_correction_blocker_threshold_recheck_report",
        ],
        "raw_boundary": summary["raw_boundary"],
...
def _write_governance_events(generated_at: str, manifest: dict[str, Any]) -> None:
    event = {
        "event_id": "DEV-KMFA-20260707-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-BLOCKER-THRESHOLD-RECHECK",
        ...
        "iteration_id": "ITER-20260707-KMFA-V014-OUTSIDE-SCOPE-CANDIDATE-REVIEW-RESIDUAL-DIFFERENCE-SOURCE-MAP-CORRECTION-BLOCKER-THRESHOLD-RECHECK",
        "task_id": TASK_ID,
        "version": VERSION,
        "go_no_go": DECISION,
        "result_commit": "PENDING",
        "summary": "Recorded the second residual-difference source-map correction blocker observation and kept the strict blocked threshold false.",
        "valid_diagnostic_response_count": 72,
        "missing_response_blocker_cleared": True,
        "source_map_correction_blocker_count": 72,
        "source_map_correction_blocker_observation_count": 2,
        "source_map_correction_blocked_audit_threshold_met": False,
        "goal_status_recommendation": "continue_waiting_for_source_map_correction_or_authoritative_value_resolution",
        "source_map_correction_ready": False,
    ...
    _upsert_jsonl(
        ...
        {
            "acceptance_id": ACCEPTANCE_ID,
            "acceptance_output": "Residual difference source-map correction blocker threshold recheck manifest summary Go No-Go public-safe matrix private ignored diagnostic queue report validator focused test and governance records",
            ...
            "name": "v0.1.4 residual difference source-map correction blocker threshold recheck",
            "phase_goal": "record the second source-map correction blocker observation while keeping threshold false and downstream gates closed",
            "phase_id": PHASE_ID,
            "project_id": "KMFA",
            "raw_data_committed": False,
            "record_type": "v014_phase",
            "roadmap_phase_id": "OUTSIDE_SCOPE_CANDIDATE_REVIEW_RESIDUAL_DIFFERENCE_SOURCE_MAP_CORRECTION_BLOCKER_THRESHOLD_RECHECK",
    ...
    for index, task_goal in enumerate(
        [
            "read prior public-safe blocker audit evidence and ignored private audit queue read-only",
            "record second source-map correction blocker observation with threshold false",
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    _ = SOURCE_PRIVATE_AUDIT_REPORT_PATH.read_text(encoding="utf-8")
    source_audit_rows = _read_jsonl(SOURCE_PRIVATE_AUDIT_QUEUE_PATH)
    threshold_rows = _build_private_threshold_queue(generated_at=generated, source_audit_rows=source_audit_rows)
    ...
    private_diagnostic = _write_private_outputs(generated, summary, threshold_rows)
    summary["private_threshold_recheck_diagnostic_gitignored"] = _git_check_ignored(PRIVATE_THRESHOLD_DIAGNOSTIC_PATH)
    summary["private_threshold_recheck_queue_gitignored"] = _git_check_ignored(PRIVATE_THRESHOLD_QUEUE_PATH)
    summary["private_threshold_recheck_report_gitignored"] = _git_check_ignored(PRIVATE_THRESHOLD_REPORT_PATH)
...
def main() -> int:
    ...
    print(
        "PASS: generated V014 residual-difference source-map correction blocker threshold recheck "
