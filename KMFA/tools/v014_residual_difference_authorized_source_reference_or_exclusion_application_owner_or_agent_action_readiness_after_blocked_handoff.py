#!/usr/bin/env python3
"""Check owner or authorized-agent action readiness after blocked handoff.
...
SOURCE_PRIVATE_BLOCKED_HANDOFF_DIAGNOSTIC_PATH = (
    source_blocked_handoff.PRIVATE_BLOCKED_HANDOFF_DIAGNOSTIC_PATH
)
SOURCE_PRIVATE_BLOCKED_HANDOFF_RECORDS_PATH = source_blocked_handoff.PRIVATE_BLOCKED_HANDOFF_RECORDS_PATH
SOURCE_PRIVATE_OWNER_ACTION_QUEUE_PATH = source_blocked_handoff.PRIVATE_OWNER_ACTION_QUEUE_PATH
SOURCE_PRIVATE_BLOCKED_HANDOFF_REPORT_PATH = source_blocked_handoff.PRIVATE_BLOCKED_HANDOFF_REPORT_PATH

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_action_readiness_after_blocked_handoff"
)
PRIVATE_ACTION_READINESS_DIAGNOSTIC_PATH = PRIVATE_OUTPUT_DIR / "private_owner_or_agent_action_readiness_diagnostic.json"
PRIVATE_ACTION_READINESS_BLOCKER_RECORDS_PATH = (
    PRIVATE_OUTPUT_DIR / "private_owner_or_agent_action_readiness_blocker_records.jsonl"
)
PRIVATE_ACTION_READINESS_QUESTION_LIST_PATH = (
    PRIVATE_OUTPUT_DIR / "private_owner_or_agent_action_readiness_question_list.md"
)
...
def _phase_public_files() -> list[str]:
    return [
        ...
        (
            ...
            "owner_or_agent_action_readiness_after_blocked_handoff.py"
        ),
        (
...
def _raw_boundary() -> dict[str, bool]:
    return {
        ...
        "private_action_readiness_diagnostic_written_by_this_phase": True,
        "private_action_readiness_blocker_records_written_by_this_phase": True,
        "private_action_readiness_question_list_written_by_this_phase": True,
...
def _public_safety() -> dict[str, bool]:
    return {
        ...
        "private_action_readiness_diagnostic_committed": False,
        "private_action_readiness_blocker_records_committed": False,
        "private_action_readiness_question_list_committed": False,
        ...
        records.append(
            {
                ...
                "owner_action_readiness_status": READINESS_CONCLUSION,
                "owner_action_status": row.get("owner_action_status"),
                "owner_action_type": row.get("owner_action_type"),
                "owner_action_ready": False,
                "owner_action_blocker": True,
                "owner_action_blocker_reason": _blocker_reason(diagnostic_kind),
                "actionable_owner_resolution_ready": False,
                "binding_ready_after_owner_action_readiness": False,
                "comparison_retry_ready_after_owner_action_readiness": False,
...
def _build_summary(
    *,
    ...
    return {
        ...
        "source_actionability_blocked_audit_threshold_met": source_summary.get(
            "actionability_blocked_audit_threshold_met"
        ),
        "goal_status_recommendation": "blocked",
        "owner_action_ready_count": 0,
        "owner_action_blocker_count": len(blocker_rows),
        "actionable_owner_resolution_count": 0,
        "source_reference_or_owner_exclusion_owner_action_blocker_count": counts[
            SOURCE_REFERENCE_DIAGNOSTIC_KIND
        ],
        "formula_or_non_numeric_mapping_owner_action_blocker_count": counts[FORMULA_MAPPING_DIAGNOSTIC_KIND],
        ...
        "private_action_readiness_diagnostic_written": True,
        "private_action_readiness_blocker_records_written": True,
        "private_action_readiness_question_list_written": True,
        "private_action_readiness_diagnostic_gitignored": _git_check_ignored(
            PRIVATE_ACTION_READINESS_DIAGNOSTIC_PATH
        ),
        "private_action_readiness_blocker_records_gitignored": _git_check_ignored(
            PRIVATE_ACTION_READINESS_BLOCKER_RECORDS_PATH
        ),
        "private_action_readiness_question_list_gitignored": _git_check_ignored(
            PRIVATE_ACTION_READINESS_QUESTION_LIST_PATH
        ),
        ...
        "owner_action_readiness_checked_by_this_phase": True,
        "owner_or_agent_action_completed_by_this_phase": False,
        "authoritative_binding_application_ready": False,
        "authoritative_binding_applied_by_this_phase": False,
        "raw_candidate_fingerprint_bound_by_this_phase": False,
...
def _build_matrix(summary: dict[str, Any]) -> dict[str, Any]:
    checks = [
        ...
        ("owner_action_readiness_checked", summary["owner_action_readiness_checked_by_this_phase"] is True),
        ("owner_action_blockers_locked", summary["owner_action_blocker_count"] == 48),
        (
            "diagnostic_kind_owner_action_counts_locked",
            summary["source_reference_or_owner_exclusion_owner_action_blocker_count"] == 40
            and summary["formula_or_non_numeric_mapping_owner_action_blocker_count"] == 8,
        ),
...
def _build_go_no_go(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "goal_status_recommendation": "blocked",
        "owner_action_ready_count": 0,
        "owner_action_blocker_count": summary["owner_action_blocker_count"],
        "actionable_owner_resolution_count": 0,
        "source_reference_or_owner_exclusion_owner_action_blocker_count": summary[
            "source_reference_or_owner_exclusion_owner_action_blocker_count"
        ],
        "formula_or_non_numeric_mapping_owner_action_blocker_count": summary[
            "formula_or_non_numeric_mapping_owner_action_blocker_count"
        ],
...
def _build_manifest(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "private_artifact_refs": [
            "private:owner_or_agent_action_readiness_diagnostic",
            "private:owner_or_agent_action_readiness_blocker_records",
            "private:owner_or_agent_action_readiness_question_list",
        ],
        ...
        "test_commands": [
            (
                ...
                "KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_action_readiness_after_blocked_handoff.py --generated-at "
                "2026-07-08T00:00:00+10:00"
            ),
            (
                "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 "
                "KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_action_readiness_after_blocked_handoff.py --require-private-action-readiness"
            ),
            (
                "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest "
                "KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_action_readiness_after_blocked_handoff"
            ),
        ],
        "git": {
...
def _write_private_outputs(
    *, generated_at: str, summary: dict[str, Any], blocker_rows: list[dict[str, Any]]
    ...
    _write_json(
        PRIVATE_ACTION_READINESS_DIAGNOSTIC_PATH,
        {
            "schema_version": "kmfa.private.v014_owner_agent_action_readiness_after_blocked_handoff.v1",
            "classification": "private_owner_or_agent_action_readiness_do_not_commit",
            "record_type": "v014_owner_agent_action_readiness_after_blocked_handoff_private_diagnostic",
            "project_id": "KMFA",
            "version": VERSION,
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
            ...
            "summary_private": {
                ...
                "formula_or_non_numeric_mapping_owner_action_blocker_count": counts[
    ...
    _write_jsonl(PRIVATE_ACTION_READINESS_BLOCKER_RECORDS_PATH, blocker_rows)
    question_lines = [
        "# owner/授权代理 action readiness 问题清单",
        "",
        f"- phase_id: `{PHASE_ID}`",
        f"- owner_action_blocker_count: `{len(blocker_rows)}`",
    ...
    _write_text(PRIVATE_ACTION_READINESS_QUESTION_LIST_PATH, "\n".join(question_lines))


def _write_human(summary: dict[str, Any], matrix: dict[str, Any], go_no_go: dict[str, Any]) -> None:
    _write_text(
        REPORT_PATH,
        f"""# V014 Owner / Authorized Agent Action Readiness After Blocked Handoff
...
- Owner action ready count: `{summary["owner_action_ready_count"]}`
- Owner action blocker count: `{summary["owner_action_blocker_count"]}`
- Actionable owner resolution count: `{summary["actionable_owner_resolution_count"]}`
- Source reference or owner exclusion blockers: `{summary["source_reference_or_owner_exclusion_owner_action_blocker_count"]}`
- Formula or non-numeric mapping blockers: `{summary["formula_or_non_numeric_mapping_owner_action_blocker_count"]}`
- Binding ready after owner action readiness: `{summary["binding_ready_after_owner_action_readiness_count"]}`
- Comparison retry ready after owner action readiness: `{summary["comparison_retry_ready_after_owner_action_readiness_count"]}`
...
def _write_governance_events(generated_at: str, summary: dict[str, Any]) -> None:
    ...
    _upsert_jsonl(
        DEVELOPMENT_EVENTS_PATH,
        {
            ...
            "owner_action_ready_count": summary["owner_action_ready_count"],
            "owner_action_blocker_count": summary["owner_action_blocker_count"],
            "goal_status_recommendation": "blocked",
            "actionable_owner_resolution_count": 0,
            "unresolved_difference_count": summary["unresolved_difference_count"],
    ...
    _upsert_jsonl(
        TASK_STATUS_PATH,
        {
            ...
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
            "name": "v0.1.4 owner or authorized agent action readiness after blocked handoff",
            "status": STATUS,
            ...
            "stage_id": "VALUE-CONSISTENCY",
            "phase_goal": "check owner or authorized-agent action readiness after blocked handoff",
            "task_count": 3,
            "acceptance_output": (
...
def generate(*, generated_at: str | None = None, write_governance_event: bool = True) -> dict[str, Any]:
    ...
    return {
        ...
        "go_no_go": go_no_go,
        "manifest": manifest,
        "private_action_readiness_blocker_records": blocker_rows,
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: generated V014 owner/authorized-agent action readiness after blocked handoff "
        f"ready={summary['owner_action_ready_count']} "
        f"blockers={summary['owner_action_blocker_count']} "
