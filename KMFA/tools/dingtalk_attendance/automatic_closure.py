...
ATTENDANCE_RUNTIME_STATIC_PATHS = (
    ...
    Path("KMFA/metadata/dingtalk_attendance/codex_automation/morning_0801.prompt.md"),
    Path("KMFA/metadata/dingtalk_attendance/codex_automation/evening_1731.prompt.md"),
...
class R6Coordinator:
    ...
    def _write(self) -> None:
        ...
        lines = [
            ...
            "- 本机计划：晨间 08:01；晚间 17:31（仅记录实际计划，未修改 scheduler）",
