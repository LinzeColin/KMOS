...
def _check_private_intake() -> None:
    ...
    _require_equal("diagnostic.pending_group_decision_count", diagnostic.get("pending_group_decision_count"), 22)
    _require_equal("diagnostic.valid_group_decision_count", diagnostic.get("valid_group_decision_count"), 0)
    ...
    _require_equal(
        ...
        diagnostic.get("owner_group_decision_code_counts", {}).get(PENDING_DECISION_CODE),
        22,
    )
    _require_false("diagnostic.owner_group_decisions_supplied", diagnostic.get("owner_group_decisions_supplied"))
    ...
    _require_equal("pending_queue.pending_group_decision_count", pending_queue.get("pending_group_decision_count"), 22)
    ...
    _require_equal("pending_queue.pending_groups length", len(groups), 22)
...
def validate(*, require_private_intake: bool = False) -> dict[str, Any]:
    ...
    _require_equal("go_no_go.pending_group_decision_count", go_no_go.get("pending_group_decision_count"), 22)
    _require_equal("go_no_go.valid_group_decision_count", go_no_go.get("valid_group_decision_count"), 0)
    _require_equal("go_no_go.invalid_group_decision_count", go_no_go.get("invalid_group_decision_count"), 0)
    _require_false("go_no_go.owner_group_decisions_supplied", go_no_go.get("owner_group_decisions_supplied"))
