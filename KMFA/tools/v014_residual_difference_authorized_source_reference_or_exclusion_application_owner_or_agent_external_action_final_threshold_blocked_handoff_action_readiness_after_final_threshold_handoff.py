#!/usr/bin/env python3
"""Check owner or authorized-agent external action final-threshold blocked handoff action readiness after final-threshold handoff.
...
from KMFA.tools import (  # noqa: E402
    v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_after_reminder
...
PHASE_ID = (
    ...
    "EXTERNAL_ACTION_FINAL_THRESHOLD_BLOCKED_HANDOFF_ACTION_READINESS_AFTER_FINAL_THRESHOLD_HANDOFF"
)
TASK_ID = (
    "KMFA-V014-RESIDUAL-DIFFERENCE-AUTHORIZED-SOURCE-REFERENCE-OR-EXCLUSION-APPLICATION-OWNER-OR-"
    "AGENT-EXTERNAL-ACTION-FINAL-THRESHOLD-BLOCKED-HANDOFF-ACTION-READINESS-AFTER-FINAL-THRESHOLD-HANDOFF-20260708"
)
ACCEPTANCE_ID = (
    "ACC-V014-RESIDUAL-DIFFERENCE-AUTHORIZED-SOURCE-REFERENCE-OR-EXCLUSION-APPLICATION-OWNER-OR-"
    "AGENT-EXTERNAL-ACTION-FINAL-THRESHOLD-BLOCKED-HANDOFF-ACTION-READINESS-AFTER-FINAL-THRESHOLD-HANDOFF"
)
VERSION = (
    "0.1.4-residual-difference-authorized-source-reference-or-exclusion-application-owner-or-agent-"
    "external-action-final-threshold-blocked-handoff-action-readiness-after-final-threshold-handoff"
)
STATUS = (
    "completed_validated_local_only_authorized_source_reference_or_exclusion_application_owner_or_agent_"
    "external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff_no_go_blocked"
)
DECISION = "NO_GO"
READINESS_CONCLUSION = "blocked_waiting_for_owner_or_authorized_agent_external_action_after_final_threshold_handoff"
...
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_BLOCKED_HANDOFF_DIAGNOSTIC_PATH = (
    source_blocked_handoff.PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_DIAGNOSTIC_PATH
)
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_BLOCKED_HANDOFF_RECORDS_PATH = (
    source_blocked_handoff.PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_RECORDS_PATH
)
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_OWNER_ACTION_QUEUE_PATH = (
    source_blocked_handoff.PRIVATE_EXTERNAL_ACTION_OWNER_ACTION_QUEUE_PATH
)
SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_BLOCKED_HANDOFF_REPORT_PATH = (
    source_blocked_handoff.PRIVATE_EXTERNAL_ACTION_BLOCKED_HANDOFF_REPORT_PATH
)
...
SOURCE_PRIVATE_OWNER_ACTION_QUEUE_PATH = SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_OWNER_ACTION_QUEUE_PATH
SOURCE_PRIVATE_BLOCKED_HANDOFF_REPORT_PATH = (
    SOURCE_PRIVATE_EXTERNAL_ACTION_FINAL_THRESHOLD_BLOCKED_HANDOFF_REPORT_PATH
)

PRIVATE_OUTPUT_DIR = (
    PROJECT_ROOT
    / ".codex_private_runtime/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff"
)
...
def _phase_public_files() -> list[str]:
    return [
        ...
        (
            ...
            "owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.py"
        ),
        (
...
def _validate_sources(
    *,
    ...
    if source_summary.get("owner_action_packet_item_count") != 48:
        raise ValueError("source owner-action item count must be 48")
    if source_summary.get("owner_action_required_count") != 48:
        raise ValueError("source owner-action required count must be 48")
...
def _build_summary(
    *,
    ...
    return {
        ...
        "source_blocked_handoff_item_count": source_summary.get("external_action_blocked_handoff_item_count"),
        "source_owner_action_item_count": source_summary.get("owner_action_packet_item_count"),
        "source_external_action_final_threshold_blocked_handoff_item_count": source_summary.get(
            "external_action_blocked_handoff_item_count"
        ),
        "source_owner_action_packet_item_count": source_summary.get("owner_action_packet_item_count"),
        "source_owner_action_required_count": source_summary.get("owner_action_required_count"),
        ...
        "source_external_action_blocked_audit_threshold_met": source_summary.get(
            "external_action_blocked_audit_threshold_met"
        ),
    ...
    return {
        ...
        "test_commands": [
            (
                ...
                "KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.py --generated-at "
                "2026-07-08T00:00:00+10:00"
            ),
            (
                "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 "
                "KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.py --require-private-external-action-readiness"
            ),
            (
                "PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest "
                "KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_"
                "owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff"
            ),
        ],
        "git": {
...
def _write_private_outputs(
    *, generated_at: str, summary: dict[str, Any], blocker_rows: list[dict[str, Any]]
    ...
    _write_json(
        PRIVATE_EXTERNAL_ACTION_READINESS_DIAGNOSTIC_PATH,
        {
            "schema_version": "kmfa.private.v014_owner_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.v1",
            "classification": "private_owner_or_agent_external_action_readiness_do_not_commit",
            "record_type": "v014_owner_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff_private_diagnostic",
            "project_id": "KMFA",
            "version": VERSION,
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
...
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.py --generated-at 2026-07-08T00:00:00+10:00`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 KMFA/tools/check_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff.py --require-private-external-action-readiness`
- `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. python3 -m unittest KMFA.tests.test_v014_residual_difference_authorized_source_reference_or_exclusion_application_owner_or_agent_external_action_final_threshold_blocked_handoff_action_readiness_after_final_threshold_handoff`
...
def _write_governance_events(generated_at: str, summary: dict[str, Any]) -> None:
    ...
    _upsert_jsonl(
        TASK_STATUS_PATH,
        {
            ...
            "phase_id": PHASE_ID,
            "task_id": TASK_ID,
            "name": "v0.1.4 owner or authorized agent external action final-threshold blocked handoff action readiness after final-threshold handoff",
            "status": STATUS,
            ...
            "stage_id": "VALUE-CONSISTENCY",
            "phase_goal": "check owner or authorized-agent external action final-threshold blocked handoff action readiness after final-threshold handoff",
            "task_count": 3,
            "acceptance_output": (
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "PASS: generated V014 owner/authorized-agent external action final-threshold blocked handoff action readiness after final-threshold handoff "
