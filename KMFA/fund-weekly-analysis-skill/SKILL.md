...
* `Australia/Sydney` local time is the scheduler source of truth. Beijing time must not be used as the scheduler timezone because daylight-saving offsets can change.
* Input directory:
