...
| Schedule | Current owner-approved schedule is daily 11:30 `Australia/Sydney` |
...
| Stale schedule conflict | Any older Monday/Saturday 11:00 wording is stale unless explicitly re-approved in the current owner instruction | Current repo contract and local automation drift check |
