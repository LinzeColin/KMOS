...
The local scheduler uses Sydney local time. Monday and Saturday at 11:00 Australia/Sydney is the operational schedule. Beijing time must not be used as the scheduler timezone because daylight-saving offsets can change.
