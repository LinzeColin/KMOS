...
The local scheduler uses Sydney local time. Daily at 11:30 Australia/Sydney is the operational schedule. Beijing 09:30 is reference wording only for the current UTC+10 offset and must not be used as the scheduler timezone.
