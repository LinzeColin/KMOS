...
40. Build daily balance continuity and company-bank matrix.
41. Build tax/loan/project-cost/wealth-management/deposit risk tables.
42. Promote reviewed facts into Excel with exact sheet order and style spec.
43. Hide audit/review sheets.
44. Run validation checks.
45. Write run summary.
46. Commit/push skill or automation changes to GitHub main only after validation passes.
