...
17. Put adjacent real OCR text sidecars into `ocr_text_candidates.csv`, put detected date/amount candidates into `ocr_value_candidates.csv`, index real DingTalk `chat_records.csv` finance text into `chat_text_candidates.csv`, put detected date/amount candidates into `chat_value_candidates.csv`, and create pending-review exception tasks; do not promote OCR/chat text or value candidates into ledger amounts until human/cross review passes.
