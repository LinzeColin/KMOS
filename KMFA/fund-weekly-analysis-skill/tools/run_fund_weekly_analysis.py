    ...
    return [
        automation_readiness_row(
            ...
            next_action=(
                ...
                if ready
                else "Sync local Codex automation to the tracked weekly Monday/Saturday 11:00 Australia/Sydney contract"
            ),
        )
    ]
...
def write_runtime_rules_to_workbook(
    ...
    rows = [
        ...
        [("A", "schedule_rrule"), ("B", schedule_rrule), ("C", "automation"), ("D", "expected weekly Monday/Saturday 11:00 Sydney")],
