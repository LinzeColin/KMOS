...
Stage 5 GitHub upload is complete on `origin/main`. S06-P1 is local-only and must not be uploaded until the whole Stage 6 review/fix/upload gate is completed.
