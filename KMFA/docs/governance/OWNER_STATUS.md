...
KMFA 已在 v1.2 FULL_HTML_NO_OMISSION 基线上完成 Stage 4 final GitHub upload、Stage 5 全部 Phase/复审/upload，以及 `S06-P1｜零差异校验器` 和 `S06-P2｜跨源差异队列` 本地验证。S06-P1 已建立 public-safe 整数分逐字段校验，S06-P2 已建立 PDF/Excel 同项目冲突人工队列和 A 级报告阻断。S06-P3、事实层、lineage 和报告仍未完成，项目仍不是可用业务系统。
...
- 不能认为 S06 Stage 已经完成；当前只完成 S06-P1/S06-P2，不含 S06-P3 metadata/quality 运行时证据输出。
...
下一步只执行 `S06-P3｜校验证据输出`；不得扩大到 UI、正式报告、事实层或自动接口。
