...
- project_id: `KMFA`
- version: `0.1.3-s03-stage-review`
- current_stage: `S03`
- current_phase: `v0.1.3 Stage 3｜整体复审`
- status: `local_s03_stage_review_passed_no_go_upload_ready_next_gate`
- production_ready: `false`
- github_upload_ready: `true_next_gate_only_not_pushed`
...
- v0.1.3 Stage 3 整体复审已本地完成；下一轮只能执行 `v0.1.3 Stage 3 GitHub upload` 或用户明确指定的单一 phase，不得跳到正式报告、lineage full check、raw value matching、live connector 或业务执行；GitHub upload 尚未执行。
