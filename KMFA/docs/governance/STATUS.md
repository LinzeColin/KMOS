...
- project_id: `KMFA`
- version: `0.1.3-s03p3-source-priority`
- current_stage: `S03`
- current_phase: `v0.1.3 S03-P3｜源优先级与差异队列入口`
- status: `local_s03p3_source_priority_passed_no_go_overall_upload_deferred`
...
- v0.1.3 S03-P3 已本地完成；下一轮只能执行 `v0.1.3 Stage 3 整体复审` 或用户明确指定的单一 phase，不得跳到 GitHub upload、正式报告、lineage full check、raw value matching、live connector 或业务执行；GitHub upload 延后到整体完成 gate。
