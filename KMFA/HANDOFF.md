...
- 下一步：继续围绕 owner 授权清单复核、正式 fact promotion 执行路径设计或 owner review 影响预览推进；当前 source readiness、automation readiness 和 dry-run 预览已具备，但正式账本、fact promotion 和管理结论仍保持 fail-closed。
