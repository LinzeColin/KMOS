...
v1.2 FULL_HTML_NO_OMISSION 完整任务包已成为 KMFA 后续开发基线，并已按 v1.2 重新走完 Stage 1。Stage 2、Stage 3、Stage 4、Stage 5、Stage 6、Stage 7 和 Stage 8 均已完成本地实现、验证、整体复审和 GitHub main 上传。Stage 5 已完成 `S05-P1｜A0 文件登记`、`S05-P2｜字段级黄金基准`、`S05-P3｜权威基准锁定`、Stage 5 整体复审和 final GitHub upload。S05-P3 基于 S05-P2 active owner/授权降级决策，锁定 40 条 PDF 字段 hash/source-anchor 记录为 public-safe Q5 calculation baseline，并将 5 条 Excel 字段排除为 `cross_source_support_only`。Stage 6 已完成 `S06-P1｜零差异校验器`、`S06-P2｜跨源差异队列`、`S06-P3｜校验证据输出`、整体复审和 final GitHub upload。Stage 7 已完成财务文件适配、WPS 文件适配、红圈导出后置策略、整体复审和 final GitHub upload。Stage 8 已完成 `项目组合键`、`业务实体模型`、`匹配质量测试`、整体复审和 final GitHub upload。S09-P1 已完成 public-safe 项目成本事实层，S09-P2 已完成 public-safe 毛利与现金毛利计算层，S09-P3 已完成 public-safe 口径转换与差异核对层、validator、metadata 和证据，证据在 `KMFA/stage_artifacts/S09_P3_scope_reconciliation/`。下一轮只能做 `Stage 9 整体复审`，不能跳到 GitHub upload、UI、报告、lineage 或外部接口。
