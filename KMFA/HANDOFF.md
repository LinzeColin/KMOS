...
下一步若继续开发，只执行 `S12-P1｜人工处理工作台与重跑机制`：先确认 git root、branch、remote、HEAD、status；读取 taskpack/roadmap 中 S12-P1 范围；不得执行 S12-P2/P3、Stage 12 review、GitHub upload、正式报告、lineage full check、差异关闭或自动接口。不得提交 raw Excel/PDF/zip/private CSV、真实金额、真实账号或字段明文。
