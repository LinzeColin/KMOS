...
v1.2 FULL_HTML_NO_OMISSION 完整任务包已成为 KMFA 后续开发基线，并已按 v1.2 重新走完 Stage 1。Stage 2、Stage 3、Stage 4、Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成本地实现、验证、整体复审和 GitHub main 上传。S14-P1 资金计划现金贷款、S14-P2 开票纳税、S14-P3 政策证据、Stage 14 整体复审和 Stage 14 GitHub upload 均已完成，证据分别在 `KMFA/stage_artifacts/S14_P1_fund_cash_loan_plan/`、`KMFA/stage_artifacts/S14_P2_invoice_tax_plan/`、`KMFA/stage_artifacts/S14_P3_policy_evidence_plan/`、`KMFA/stage_artifacts/S14_STAGE_REVIEW/` 和 `KMFA/stage_artifacts/S14_GITHUB_UPLOAD/`；本轮未执行 S15、lineage full check、正式报告、差异关闭、政策资格结论、政策申报、纳税申报、发票开具、付款、银行、税务、贷款管理、法务催收或外部接口。下一轮只能作为新 run work 执行 `S15-P1｜销售绩效事实与复核清单`，且必须重新确认 git/root/status 并读取 v1.2 task pack / roadmap。
...
下一步若继续开发，只执行 `S15-P1｜销售绩效事实与复核清单`：先确认 git root、branch、remote、HEAD、status，并读取 v1.2 task pack / roadmap；不得直接进入 lineage full check、正式报告、差异关闭、业务 release 或自动接口；不得提交 raw Excel/PDF/zip/private CSV、真实金额、真实账号、真实客户/项目明细、银行流水、合同、薪资、税务申报、credentials 或字段明文。
