...
v1.2 FULL_HTML_NO_OMISSION 完整任务包已成为 KMFA 后续开发基线，并已按 v1.2 重新走完 Stage 1。Stage 2、Stage 3、Stage 4、Stage 5、Stage 6、Stage 7、Stage 8、Stage 9、Stage 10、Stage 11、Stage 12、Stage 13 和 Stage 14 均已完成本地实现、验证、整体复审和 GitHub main 上传。S15-P1 绩效事实字段、S15-P2 绩效复核清单、S15-P3 工资项目边界和 Stage 15 整体复审均已完成本地验证，证据在 `KMFA/stage_artifacts/S15_P1_performance_fact_fields/`、`KMFA/stage_artifacts/S15_P2_performance_review_list/`、`KMFA/stage_artifacts/S15_P3_salary_boundary/` 和 `KMFA/stage_artifacts/S15_STAGE_REVIEW/`；本轮未执行 GitHub upload、S16、lineage full check、正式报告、工资计算、奖金审批、薪资导出、最终发放或外部接口。下一轮只能执行 Stage 15 GitHub upload，且必须重新确认 git/root/status、对齐最新 origin/main、复跑 S15-P1/P2/P3 validators、Stage 15 review validator、治理 validator 和安全扫描。
...
下一步若继续开发，只执行 `Stage 15 GitHub upload`：先确认 git root、branch、remote、HEAD、status，对齐最新 `origin/main`，复跑 S15-P1/P2/P3 validators、Stage 15 review validator、治理 validator、全量 tests、raw/secret scan 和 parse checks；不得直接进入 S16、lineage full check、正式报告、工资计算、奖金审批、薪资导出、业务 release 或自动接口；不得提交 raw Excel/PDF/zip/private CSV、真实金额、真实账号、真实客户/项目明细、银行流水、合同、薪资、税务申报、credentials 或字段明文。
