...
v1.2 FULL_HTML_NO_OMISSION 完整任务包已成为 KMFA 后续开发基线，并已按 v1.2 重新走完 Stage 1。Stage 2、Stage 3、Stage 4、Stage 5、Stage 6、Stage 7 和 Stage 8 均已完成本地实现、验证、整体复审和 GitHub main 上传。Stage 5 已完成 `S05-P1｜A0 文件登记`、`S05-P2｜字段级黄金基准`、`S05-P3｜权威基准锁定`、Stage 5 整体复审和 final GitHub upload。S05-P3 基于 S05-P2 active owner/授权降级决策，锁定 40 条 PDF 字段 hash/source-anchor 记录为 public-safe Q5 calculation baseline，并将 5 条 Excel 字段排除为 `cross_source_support_only`。Stage 6 已完成 `S06-P1｜零差异校验器`、`S06-P2｜跨源差异队列`、`S06-P3｜校验证据输出`、整体复审和 final GitHub upload。Stage 7 已完成财务文件适配、WPS 文件适配、红圈导出后置策略、整体复审和 final GitHub upload。Stage 8 已完成 `项目组合键`、`业务实体模型`、`匹配质量测试`、整体复审和 final GitHub upload。S09-P1 已完成 public-safe 项目成本事实层、validator、metadata 和证据，证据在 `KMFA/stage_artifacts/S09_P1_project_cost_fact_layer/`。下一轮只能做 `S09-P2｜毛利与现金毛利`，不能跳到 S09-P3、Stage 9 review、UI、报告、lineage 或外部接口。
...
- S06-P1 zero-delta validator、S06-P2 cross-source difference queue、S06-P3 validation evidence output、Stage 6 review/upload、S07-P1 finance adapter、S07-P2 WPS adapter、S07-P3 redcircle postponement policy、Stage 7 review/upload、S08-P1 project composite key、S08-P2 business entity model、S08-P3 entity matching quality、Stage 8 review/upload 和 S09-P1 public-safe fact layer 已完成；S09-P2/S09-P3、lineage 和报告发布门禁仍未完成。
...
- S05-P3、Stage 5 review/upload、S06-P1、S06-P2、S06-P3、Stage 6 review/upload、Stage 7 review/upload、Stage 8 review/upload 和 S09-P1 只完成 A0 authority baseline lock、校验/差异/适配/匹配、结构化 fact layer、整体复审和上传；不能把它扩展解释为 S09-P2 毛利、差异关闭、lineage 或报告发布。
- S09-P2 毛利与现金毛利、S09-P3 口径转换、lineage 完整检查和运行时报告生成尚未实现。
...
下一步若继续开发，只执行 `S09-P2｜毛利与现金毛利`：先确认 git root、branch、remote、HEAD、status；读取 v1.2 roadmap S09-P2、S05-P3 authority baseline、S06 validation evidence、S08 entity matching evidence 和 S09-P1 fact layer evidence；只建立 public-safe gross margin/cash gross margin 计算证据、validator、metadata 和证据；不得提交 raw Excel/PDF/zip/private CSV，不得扩大到 S09-P3、Stage 9 review、UI、正式报告、lineage 或自动接口。
