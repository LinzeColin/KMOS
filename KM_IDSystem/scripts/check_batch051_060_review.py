...
def _governance_checks(batch: Mapping[str, Any], roadmap: Mapping[str, Any]) -> dict[str, bool]:
    ...
    return {
        ...
        "roadmap_current_route_exact": (
            ...
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE094"
                and roadmap.get("current_phase_id") == "IDS-STAGE094-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE094-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE094-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage094_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE094",
                    "current_phase_id": "IDS-STAGE094-P2",
                    "current_task_id": "IDS-V0_1-STAGE094-P2",
                    "next_gate_id": "IDS-STAGE094-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE094"
                and roadmap.get("current_phase_id") == "IDS-STAGE094-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE094-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE094-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage094_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE094",
                    "current_phase_id": "IDS-STAGE094-P3",
                    "current_task_id": "IDS-V0_1-STAGE094-P3",
                    "next_gate_id": "IDS-STAGE094-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE094"
                and roadmap.get("current_phase_id") == "IDS-STAGE094-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE094-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE094-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage094_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE094",
                    "current_phase_id": "IDS-STAGE094-P4",
                    "current_task_id": "IDS-V0_1-STAGE094-P4",
                    "next_gate_id": "IDS-STAGE094-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE094"
                and roadmap.get("current_phase_id") == "IDS-STAGE094-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE094-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE095-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage094_review_state")
                == {
                    "current_stage_id": "IDS-STAGE094",
                    "current_phase_id": "IDS-STAGE094-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE094-REVIEW",
                    "next_gate_id": "IDS-STAGE095-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE095"
                and roadmap.get("current_phase_id") == "IDS-STAGE095-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE095-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE095-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage095_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE095",
                    "current_phase_id": "IDS-STAGE095-P1",
                    "current_task_id": "IDS-V0_1-STAGE095-P1",
                    "next_gate_id": "IDS-STAGE095-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE095"
                and roadmap.get("current_phase_id") == "IDS-STAGE095-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE095-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE095-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage095_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE095",
                    "current_phase_id": "IDS-STAGE095-P2",
                    "current_task_id": "IDS-V0_1-STAGE095-P2",
                    "next_gate_id": "IDS-STAGE095-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE095"
                and roadmap.get("current_phase_id") == "IDS-STAGE095-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE095-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE095-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage095_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE095",
                    "current_phase_id": "IDS-STAGE095-P3",
                    "current_task_id": "IDS-V0_1-STAGE095-P3",
                    "next_gate_id": "IDS-STAGE095-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE095"
                and roadmap.get("current_phase_id") == "IDS-STAGE095-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE095-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE095-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage095_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE095",
                    "current_phase_id": "IDS-STAGE095-P4",
                    "current_task_id": "IDS-V0_1-STAGE095-P4",
                    "next_gate_id": "IDS-STAGE095-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE095"
                and roadmap.get("current_phase_id") == "IDS-STAGE095-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE095-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE096-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage095_review_state")
                == {
                    "current_stage_id": "IDS-STAGE095",
                    "current_phase_id": "IDS-STAGE095-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE095-REVIEW",
                    "next_gate_id": "IDS-STAGE096-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE096"
                and roadmap.get("current_phase_id") == "IDS-STAGE096-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE096-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE096-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage096_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE096",
                    "current_phase_id": "IDS-STAGE096-P1",
                    "current_task_id": "IDS-V0_1-STAGE096-P1",
                    "next_gate_id": "IDS-STAGE096-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE096"
                and roadmap.get("current_phase_id") == "IDS-STAGE096-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE096-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE096-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage096_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE096",
                    "current_phase_id": "IDS-STAGE096-P2",
                    "current_task_id": "IDS-V0_1-STAGE096-P2",
                    "next_gate_id": "IDS-STAGE096-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE096"
                and roadmap.get("current_phase_id") == "IDS-STAGE096-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE096-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE096-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage096_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE096",
                    "current_phase_id": "IDS-STAGE096-P3",
                    "current_task_id": "IDS-V0_1-STAGE096-P3",
                    "next_gate_id": "IDS-STAGE096-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE096"
                and roadmap.get("current_phase_id") == "IDS-STAGE096-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE096-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE096-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage096_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE096",
                    "current_phase_id": "IDS-STAGE096-P4",
                    "current_task_id": "IDS-V0_1-STAGE096-P4",
                    "next_gate_id": "IDS-STAGE096-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE096"
                and roadmap.get("current_phase_id") == "IDS-STAGE096-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE096-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE097-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage096_review_state")
                == {
                    "current_stage_id": "IDS-STAGE096",
                    "current_phase_id": "IDS-STAGE096-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE096-REVIEW",
                    "next_gate_id": "IDS-STAGE097-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE097"
                and roadmap.get("current_phase_id") == "IDS-STAGE097-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE097-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE097-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage097_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE097",
                    "current_phase_id": "IDS-STAGE097-P1",
                    "current_task_id": "IDS-V0_1-STAGE097-P1",
                    "next_gate_id": "IDS-STAGE097-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE097"
                and roadmap.get("current_phase_id") == "IDS-STAGE097-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE097-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE097-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage097_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE097",
                    "current_phase_id": "IDS-STAGE097-P2",
                    "current_task_id": "IDS-V0_1-STAGE097-P2",
                    "next_gate_id": "IDS-STAGE097-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE097"
                and roadmap.get("current_phase_id") == "IDS-STAGE097-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE097-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE097-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage097_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE097",
                    "current_phase_id": "IDS-STAGE097-P3",
                    "current_task_id": "IDS-V0_1-STAGE097-P3",
                    "next_gate_id": "IDS-STAGE097-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE097"
                and roadmap.get("current_phase_id") == "IDS-STAGE097-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE097-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE097-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage097_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE097",
                    "current_phase_id": "IDS-STAGE097-P4",
                    "current_task_id": "IDS-V0_1-STAGE097-P4",
                    "next_gate_id": "IDS-STAGE097-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE097"
                and roadmap.get("current_phase_id") == "IDS-STAGE097-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE097-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE098-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage097_review_state")
                == {
                    "current_stage_id": "IDS-STAGE097",
                    "current_phase_id": "IDS-STAGE097-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE097-REVIEW",
                    "next_gate_id": "IDS-STAGE098-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE098"
                and roadmap.get("current_phase_id") == "IDS-STAGE098-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE098-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE098-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage098_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE098",
                    "current_phase_id": "IDS-STAGE098-P1",
                    "current_task_id": "IDS-V0_1-STAGE098-P1",
                    "next_gate_id": "IDS-STAGE098-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE098"
                and roadmap.get("current_phase_id") == "IDS-STAGE098-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE098-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE098-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage098_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE098",
                    "current_phase_id": "IDS-STAGE098-P2",
                    "current_task_id": "IDS-V0_1-STAGE098-P2",
                    "next_gate_id": "IDS-STAGE098-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE098"
                and roadmap.get("current_phase_id") == "IDS-STAGE098-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE098-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE098-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage098_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE098",
                    "current_phase_id": "IDS-STAGE098-P3",
                    "current_task_id": "IDS-V0_1-STAGE098-P3",
                    "next_gate_id": "IDS-STAGE098-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE098"
                and roadmap.get("current_phase_id") == "IDS-STAGE098-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE098-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE098-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage098_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE098",
                    "current_phase_id": "IDS-STAGE098-P4",
                    "current_task_id": "IDS-V0_1-STAGE098-P4",
                    "next_gate_id": "IDS-STAGE098-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE098"
                and roadmap.get("current_phase_id") == "IDS-STAGE098-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE098-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE099-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage098_review_state")
                == {
                    "current_stage_id": "IDS-STAGE098",
                    "current_phase_id": "IDS-STAGE098-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE098-REVIEW",
                    "next_gate_id": "IDS-STAGE099-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE099"
                and roadmap.get("current_phase_id") == "IDS-STAGE099-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE099-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE099-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage099_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE099",
                    "current_phase_id": "IDS-STAGE099-P1",
                    "current_task_id": "IDS-V0_1-STAGE099-P1",
            ...
            or (
                ...
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage099_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE099",
                    "current_phase_id": "IDS-STAGE099-P2",
                    "current_task_id": "IDS-V0_1-STAGE099-P2",
                    "next_gate_id": "IDS-STAGE099-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE099"
                and roadmap.get("current_phase_id") == "IDS-STAGE099-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE099-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE099-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage099_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE099",
            ...
            or (
                ...
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage099_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE099",
            ...
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE099"
                and roadmap.get("current_phase_id") == "IDS-STAGE099-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE099-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE100-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage099_review_state")
                == {
                    "current_stage_id": "IDS-STAGE099",
                    "current_phase_id": "IDS-STAGE099-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE099-REVIEW",
                    "next_gate_id": "IDS-STAGE100-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE100"
                and roadmap.get("current_phase_id") == "IDS-STAGE100-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE100-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE100-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage100_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE100",
                    "current_phase_id": "IDS-STAGE100-P1",
                    "current_task_id": "IDS-V0_1-STAGE100-P1",
                    "next_gate_id": "IDS-STAGE100-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE100"
                and roadmap.get("current_phase_id") == "IDS-STAGE100-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE100-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE100-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage100_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE100",
                    "current_phase_id": "IDS-STAGE100-P2",
                    "current_task_id": "IDS-V0_1-STAGE100-P2",
                    "next_gate_id": "IDS-STAGE100-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE100"
                and roadmap.get("current_phase_id") == "IDS-STAGE100-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE100-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE100-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage100_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE100",
                    "current_phase_id": "IDS-STAGE100-P3",
                    "current_task_id": "IDS-V0_1-STAGE100-P3",
                    "next_gate_id": "IDS-STAGE100-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE100"
                and roadmap.get("current_phase_id") == "IDS-STAGE100-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE100-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE100-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage100_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE100",
                    "current_phase_id": "IDS-STAGE100-P4",
                    "current_task_id": "IDS-V0_1-STAGE100-P4",
                    "next_gate_id": "IDS-STAGE100-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE100"
                and roadmap.get("current_phase_id") == "IDS-STAGE100-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE100-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE101-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage100_review_state")
                == {
                    "current_stage_id": "IDS-STAGE100",
                    "current_phase_id": "IDS-STAGE100-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE100-REVIEW",
                    "next_gate_id": "IDS-STAGE101-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE101"
                and roadmap.get("current_phase_id") == "IDS-STAGE101-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE101-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE101-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage101_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE101",
                    "current_phase_id": "IDS-STAGE101-P1",
                    "current_task_id": "IDS-V0_1-STAGE101-P1",
                    "next_gate_id": "IDS-STAGE101-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE101"
                and roadmap.get("current_phase_id") == "IDS-STAGE101-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE101-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE101-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage101_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE101",
                    "current_phase_id": "IDS-STAGE101-P2",
                    "current_task_id": "IDS-V0_1-STAGE101-P2",
                    "next_gate_id": "IDS-STAGE101-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE101"
                and roadmap.get("current_phase_id") == "IDS-STAGE101-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE101-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE101-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage101_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE101",
                    "current_phase_id": "IDS-STAGE101-P3",
                    "current_task_id": "IDS-V0_1-STAGE101-P3",
                    "next_gate_id": "IDS-STAGE101-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE101"
                and roadmap.get("current_phase_id") == "IDS-STAGE101-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE101-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE101-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage101_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE101",
                    "current_phase_id": "IDS-STAGE101-P4",
                    "current_task_id": "IDS-V0_1-STAGE101-P4",
                    "next_gate_id": "IDS-STAGE101-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE101"
                and roadmap.get("current_phase_id") == "IDS-STAGE101-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE101-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE102-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage101_review_state")
                == {
                    "current_stage_id": "IDS-STAGE101",
                    "current_phase_id": "IDS-STAGE101-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE101-REVIEW",
                    "next_gate_id": "IDS-STAGE102-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE102"
                and roadmap.get("current_phase_id") == "IDS-STAGE102-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE102-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE102-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage102_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE102",
                    "current_phase_id": "IDS-STAGE102-P1",
                    "current_task_id": "IDS-V0_1-STAGE102-P1",
                    "next_gate_id": "IDS-STAGE102-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE102"
                and roadmap.get("current_phase_id") == "IDS-STAGE102-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE102-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE102-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage102_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE102",
                    "current_phase_id": "IDS-STAGE102-P2",
                    "current_task_id": "IDS-V0_1-STAGE102-P2",
                    "next_gate_id": "IDS-STAGE102-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE102"
                and roadmap.get("current_phase_id") == "IDS-STAGE102-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE102-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE102-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage102_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE102",
                    "current_phase_id": "IDS-STAGE102-P3",
                    "current_task_id": "IDS-V0_1-STAGE102-P3",
                    "next_gate_id": "IDS-STAGE102-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE102"
                and roadmap.get("current_phase_id") == "IDS-STAGE102-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE102-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE102-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage102_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE102",
                    "current_phase_id": "IDS-STAGE102-P4",
                    "current_task_id": "IDS-V0_1-STAGE102-P4",
                    "next_gate_id": "IDS-STAGE102-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE102"
                and roadmap.get("current_phase_id") == "IDS-STAGE102-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE102-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE103-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage102_review_state")
                == {
                    "current_stage_id": "IDS-STAGE102",
                    "current_phase_id": "IDS-STAGE102-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE102-REVIEW",
                    "next_gate_id": "IDS-STAGE103-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE103"
                and roadmap.get("current_phase_id") == "IDS-STAGE103-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE103-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE103-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage103_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE103",
                    "current_phase_id": "IDS-STAGE103-P1",
                    "current_task_id": "IDS-V0_1-STAGE103-P1",
                    "next_gate_id": "IDS-STAGE103-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE103"
                and roadmap.get("current_phase_id") == "IDS-STAGE103-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE103-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE103-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage103_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE103",
                    "current_phase_id": "IDS-STAGE103-P2",
                    "current_task_id": "IDS-V0_1-STAGE103-P2",
                    "next_gate_id": "IDS-STAGE103-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE103"
                and roadmap.get("current_phase_id") == "IDS-STAGE103-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE103-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE103-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage103_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE103",
                    "current_phase_id": "IDS-STAGE103-P3",
                    "current_task_id": "IDS-V0_1-STAGE103-P3",
                    "next_gate_id": "IDS-STAGE103-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE103"
                ...
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage103_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE103",
                    "current_phase_id": "IDS-STAGE103-P4",
                    "current_task_id": "IDS-V0_1-STAGE103-P4",
                    "next_gate_id": "IDS-STAGE103-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE103"
                and roadmap.get("current_phase_id") == "IDS-STAGE103-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE103-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE104-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage103_review_state")
                == {
                    "current_stage_id": "IDS-STAGE103",
                    "current_phase_id": "IDS-STAGE103-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE103-REVIEW",
                    "next_gate_id": "IDS-STAGE104-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE104"
                and roadmap.get("current_phase_id") == "IDS-STAGE104-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE104-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE104-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage104_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE104",
                    "current_phase_id": "IDS-STAGE104-P1",
                    "current_task_id": "IDS-V0_1-STAGE104-P1",
                    "next_gate_id": "IDS-STAGE104-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE104"
                and roadmap.get("current_phase_id") == "IDS-STAGE104-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE104-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE104-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage104_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE104",
                    "current_phase_id": "IDS-STAGE104-P2",
                    "current_task_id": "IDS-V0_1-STAGE104-P2",
                    "next_gate_id": "IDS-STAGE104-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE104"
                and roadmap.get("current_phase_id") == "IDS-STAGE104-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE104-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE104-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage104_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE104",
                    "current_phase_id": "IDS-STAGE104-P3",
                    "current_task_id": "IDS-V0_1-STAGE104-P3",
                    "next_gate_id": "IDS-STAGE104-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE104"
                and roadmap.get("current_phase_id") == "IDS-STAGE104-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE104-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE104-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage104_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE104",
                    "current_phase_id": "IDS-STAGE104-P4",
                    "current_task_id": "IDS-V0_1-STAGE104-P4",
                    "next_gate_id": "IDS-STAGE104-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE104"
                and roadmap.get("current_phase_id") == "IDS-STAGE104-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE104-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE105-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage104_review_state")
                == {
                    "current_stage_id": "IDS-STAGE104",
                    "current_phase_id": "IDS-STAGE104-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE104-REVIEW",
                    "next_gate_id": "IDS-STAGE105-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE105"
                and roadmap.get("current_phase_id") == "IDS-STAGE105-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE105-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE105-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage105_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE105",
                    "current_phase_id": "IDS-STAGE105-P1",
                    "current_task_id": "IDS-V0_1-STAGE105-P1",
                    "next_gate_id": "IDS-STAGE105-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE105"
                and roadmap.get("current_phase_id") == "IDS-STAGE105-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE105-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE105-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage105_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE105",
                    "current_phase_id": "IDS-STAGE105-P2",
                    "current_task_id": "IDS-V0_1-STAGE105-P2",
                    "next_gate_id": "IDS-STAGE105-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE105"
                and roadmap.get("current_phase_id") == "IDS-STAGE105-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE105-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE105-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage105_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE105",
                    "current_phase_id": "IDS-STAGE105-P3",
                    "current_task_id": "IDS-V0_1-STAGE105-P3",
                    "next_gate_id": "IDS-STAGE105-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE105"
                and roadmap.get("current_phase_id") == "IDS-STAGE105-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE105-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE105-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage105_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE105",
                    "current_phase_id": "IDS-STAGE105-P4",
                    "current_task_id": "IDS-V0_1-STAGE105-P4",
                    "next_gate_id": "IDS-STAGE105-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE105"
                and roadmap.get("current_phase_id") == "IDS-STAGE105-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE105-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE106-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage105_review_state")
                == {
                    "current_stage_id": "IDS-STAGE105",
                    "current_phase_id": "IDS-STAGE105-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE105-REVIEW",
                    "next_gate_id": "IDS-STAGE106-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE106"
                and roadmap.get("current_phase_id") == "IDS-STAGE106-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE106-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE106-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage106_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE106",
                    "current_phase_id": "IDS-STAGE106-P1",
                    "current_task_id": "IDS-V0_1-STAGE106-P1",
                    "next_gate_id": "IDS-STAGE106-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE106"
                and roadmap.get("current_phase_id") == "IDS-STAGE106-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE106-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE106-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage106_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE106",
                    "current_phase_id": "IDS-STAGE106-P2",
                    "current_task_id": "IDS-V0_1-STAGE106-P2",
            ...
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE106"
                and roadmap.get("current_phase_id") == "IDS-STAGE106-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE106-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE106-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage106_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE106",
                    "current_phase_id": "IDS-STAGE106-P4",
                    "current_task_id": "IDS-V0_1-STAGE106-P4",
                    "next_gate_id": "IDS-STAGE106-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE106"
                and roadmap.get("current_phase_id") == "IDS-STAGE106-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE106-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE107-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage106_review_state")
                == {
                    "current_stage_id": "IDS-STAGE106",
                    "current_phase_id": "IDS-STAGE106-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE106-REVIEW",
                    "next_gate_id": "IDS-STAGE107-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE107"
                and roadmap.get("current_phase_id") == "IDS-STAGE107-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE107-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE107-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage107_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE107",
                    "current_phase_id": "IDS-STAGE107-P1",
                    "current_task_id": "IDS-V0_1-STAGE107-P1",
                    "next_gate_id": "IDS-STAGE107-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE107"
                and roadmap.get("current_phase_id") == "IDS-STAGE107-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE107-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE107-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage107_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE107",
                    "current_phase_id": "IDS-STAGE107-P2",
                    "current_task_id": "IDS-V0_1-STAGE107-P2",
                    "next_gate_id": "IDS-STAGE107-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE107"
                and roadmap.get("current_phase_id") == "IDS-STAGE107-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE107-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE107-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage107_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE107",
                    "current_phase_id": "IDS-STAGE107-P3",
                    "current_task_id": "IDS-V0_1-STAGE107-P3",
                    "next_gate_id": "IDS-STAGE107-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE107"
                and roadmap.get("current_phase_id") == "IDS-STAGE107-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE107-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE107-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage107_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE107",
                    "current_phase_id": "IDS-STAGE107-P4",
                    "current_task_id": "IDS-V0_1-STAGE107-P4",
                    "next_gate_id": "IDS-STAGE107-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE107"
                and roadmap.get("current_phase_id") == "IDS-STAGE107-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE107-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE108-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage107_review_state")
                == {
                    "current_stage_id": "IDS-STAGE107",
                    "current_phase_id": "IDS-STAGE107-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE107-REVIEW",
                    "next_gate_id": "IDS-STAGE108-P1-GATE",
                }
            )
            or (
                ...
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage108_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE108",
                    "current_phase_id": "IDS-STAGE108-P1",
            ...
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE108"
                and roadmap.get("current_phase_id") == "IDS-STAGE108-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE108-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE108-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage108_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE108",
            ...
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE108"
                and roadmap.get("current_phase_id") == "IDS-STAGE108-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE108-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE108-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage108_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE108",
                    "current_phase_id": "IDS-STAGE108-P3",
                    "current_task_id": "IDS-V0_1-STAGE108-P3",
                    "next_gate_id": "IDS-STAGE108-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE108"
                and roadmap.get("current_phase_id") == "IDS-STAGE108-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE108-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE108-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage108_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE108",
                    "current_phase_id": "IDS-STAGE108-P4",
                    "current_task_id": "IDS-V0_1-STAGE108-P4",
                    "next_gate_id": "IDS-STAGE108-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE108"
                and roadmap.get("current_phase_id") == "IDS-STAGE108-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE108-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE109-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage108_review_state")
                == {
                    "current_stage_id": "IDS-STAGE108",
                    "current_phase_id": "IDS-STAGE108-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE108-REVIEW",
                    "next_gate_id": "IDS-STAGE109-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE109"
                and roadmap.get("current_phase_id") == "IDS-STAGE109-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE109-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE109-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage109_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE109",
                    "current_phase_id": "IDS-STAGE109-P1",
                    "current_task_id": "IDS-V0_1-STAGE109-P1",
                    "next_gate_id": "IDS-STAGE109-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE109"
                and roadmap.get("current_phase_id") == "IDS-STAGE109-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE109-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE109-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage109_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE109",
                    "current_phase_id": "IDS-STAGE109-P2",
                    "current_task_id": "IDS-V0_1-STAGE109-P2",
                    "next_gate_id": "IDS-STAGE109-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE109"
                and roadmap.get("current_phase_id") == "IDS-STAGE109-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE109-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE109-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage109_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE109",
                    "current_phase_id": "IDS-STAGE109-P3",
                    "current_task_id": "IDS-V0_1-STAGE109-P3",
                    "next_gate_id": "IDS-STAGE109-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE109"
                and roadmap.get("current_phase_id") == "IDS-STAGE109-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE109-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE109-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage109_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE109",
                    "current_phase_id": "IDS-STAGE109-P4",
                    "current_task_id": "IDS-V0_1-STAGE109-P4",
                    "next_gate_id": "IDS-STAGE109-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE109"
                and roadmap.get("current_phase_id") == "IDS-STAGE109-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE109-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE110-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage109_review_state")
                == {
                    "current_stage_id": "IDS-STAGE109",
                    "current_phase_id": "IDS-STAGE109-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE109-REVIEW",
                    "next_gate_id": "IDS-STAGE110-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE110"
                and roadmap.get("current_phase_id") == "IDS-STAGE110-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE110-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE110-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage110_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE110",
                    "current_phase_id": "IDS-STAGE110-P1",
                    "current_task_id": "IDS-V0_1-STAGE110-P1",
                    "next_gate_id": "IDS-STAGE110-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE110"
                and roadmap.get("current_phase_id") == "IDS-STAGE110-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE110-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE110-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage110_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE110",
                    "current_phase_id": "IDS-STAGE110-P2",
                    "current_task_id": "IDS-V0_1-STAGE110-P2",
                    "next_gate_id": "IDS-STAGE110-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE110"
                and roadmap.get("current_phase_id") == "IDS-STAGE110-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE110-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE110-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage110_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE110",
                    "current_phase_id": "IDS-STAGE110-P3",
                    "current_task_id": "IDS-V0_1-STAGE110-P3",
                    "next_gate_id": "IDS-STAGE110-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE110"
                and roadmap.get("current_phase_id") == "IDS-STAGE110-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE110-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE110-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage110_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE110",
                    "current_phase_id": "IDS-STAGE110-P4",
                    "current_task_id": "IDS-V0_1-STAGE110-P4",
                    "next_gate_id": "IDS-STAGE110-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE110"
                and roadmap.get("current_phase_id") == "IDS-STAGE110-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE110-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE111-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage110_review_state")
                == {
                    "current_stage_id": "IDS-STAGE110",
                    "current_phase_id": "IDS-STAGE110-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE110-REVIEW",
                    "next_gate_id": "IDS-STAGE111-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE111"
                and roadmap.get("current_phase_id") == "IDS-STAGE111-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE111-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE111-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage111_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE111",
                    "current_phase_id": "IDS-STAGE111-P1",
                    "current_task_id": "IDS-V0_1-STAGE111-P1",
                    "next_gate_id": "IDS-STAGE111-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE111"
                and roadmap.get("current_phase_id") == "IDS-STAGE111-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE111-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE111-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage111_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE111",
                    "current_phase_id": "IDS-STAGE111-P2",
                    "current_task_id": "IDS-V0_1-STAGE111-P2",
                    "next_gate_id": "IDS-STAGE111-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE111"
                and roadmap.get("current_phase_id") == "IDS-STAGE111-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE111-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE111-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage111_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE111",
                    "current_phase_id": "IDS-STAGE111-P3",
                    "current_task_id": "IDS-V0_1-STAGE111-P3",
                    "next_gate_id": "IDS-STAGE111-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE111"
                and roadmap.get("current_phase_id") == "IDS-STAGE111-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE111-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE111-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage111_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE111",
                    "current_phase_id": "IDS-STAGE111-P4",
                    "current_task_id": "IDS-V0_1-STAGE111-P4",
                    "next_gate_id": "IDS-STAGE111-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE111"
                and roadmap.get("current_phase_id") == "IDS-STAGE111-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE111-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE112-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage111_review_state")
                == {
                    "current_stage_id": "IDS-STAGE111",
                    "current_phase_id": "IDS-STAGE111-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE111-REVIEW",
                    "next_gate_id": "IDS-STAGE112-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE112"
                and roadmap.get("current_phase_id") == "IDS-STAGE112-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE112-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE112-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage112_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE112",
                    "current_phase_id": "IDS-STAGE112-P1",
                    "current_task_id": "IDS-V0_1-STAGE112-P1",
                    "next_gate_id": "IDS-STAGE112-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE112"
                and roadmap.get("current_phase_id") == "IDS-STAGE112-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE112-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE112-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage112_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE112",
                    "current_phase_id": "IDS-STAGE112-P2",
                    "current_task_id": "IDS-V0_1-STAGE112-P2",
                    "next_gate_id": "IDS-STAGE112-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE112"
                and roadmap.get("current_phase_id") == "IDS-STAGE112-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE112-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE112-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage112_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE112",
                    "current_phase_id": "IDS-STAGE112-P3",
                    "current_task_id": "IDS-V0_1-STAGE112-P3",
                    "next_gate_id": "IDS-STAGE112-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE112"
                and roadmap.get("current_phase_id") == "IDS-STAGE112-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE112-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE112-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage112_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE112",
                    "current_phase_id": "IDS-STAGE112-P4",
                    "current_task_id": "IDS-V0_1-STAGE112-P4",
                    "next_gate_id": "IDS-STAGE112-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE112"
                and roadmap.get("current_phase_id") == "IDS-STAGE112-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE112-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE113-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage112_review_state")
                == {
                    "current_stage_id": "IDS-STAGE112",
                    "current_phase_id": "IDS-STAGE112-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE112-REVIEW",
                    "next_gate_id": "IDS-STAGE113-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE113"
                and roadmap.get("current_phase_id") == "IDS-STAGE113-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE113-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE113-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage113_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE113",
                    "current_phase_id": "IDS-STAGE113-P1",
                    "current_task_id": "IDS-V0_1-STAGE113-P1",
                    "next_gate_id": "IDS-STAGE113-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE113"
                and roadmap.get("current_phase_id") == "IDS-STAGE113-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE113-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE113-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage113_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE113",
                    "current_phase_id": "IDS-STAGE113-P2",
                    "current_task_id": "IDS-V0_1-STAGE113-P2",
                    "next_gate_id": "IDS-STAGE113-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE113"
                and roadmap.get("current_phase_id") == "IDS-STAGE113-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE113-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE113-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage113_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE113",
                    "current_phase_id": "IDS-STAGE113-P3",
                    "current_task_id": "IDS-V0_1-STAGE113-P3",
                    "next_gate_id": "IDS-STAGE113-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE113"
                and roadmap.get("current_phase_id") == "IDS-STAGE113-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE113-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE113-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage113_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE113",
                    "current_phase_id": "IDS-STAGE113-P4",
                    "current_task_id": "IDS-V0_1-STAGE113-P4",
                    "next_gate_id": "IDS-STAGE113-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE113"
                and roadmap.get("current_phase_id") == "IDS-STAGE113-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE113-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE114-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage113_review_state")
                == {
                    "current_stage_id": "IDS-STAGE113",
                    "current_phase_id": "IDS-STAGE113-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE113-REVIEW",
                    "next_gate_id": "IDS-STAGE114-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE114"
                and roadmap.get("current_phase_id") == "IDS-STAGE114-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE114-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE114-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage114_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE114",
                    "current_phase_id": "IDS-STAGE114-P1",
                    "current_task_id": "IDS-V0_1-STAGE114-P1",
                    "next_gate_id": "IDS-STAGE114-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE114"
                and roadmap.get("current_phase_id") == "IDS-STAGE114-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE114-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE114-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage114_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE114",
                    "current_phase_id": "IDS-STAGE114-P2",
                    "current_task_id": "IDS-V0_1-STAGE114-P2",
                    "next_gate_id": "IDS-STAGE114-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE114"
                and roadmap.get("current_phase_id") == "IDS-STAGE114-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE114-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE114-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage114_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE114",
                    "current_phase_id": "IDS-STAGE114-P3",
                    "current_task_id": "IDS-V0_1-STAGE114-P3",
                    "next_gate_id": "IDS-STAGE114-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE114"
                and roadmap.get("current_phase_id") == "IDS-STAGE114-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE114-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE114-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage114_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE114",
                    "current_phase_id": "IDS-STAGE114-P4",
                    "current_task_id": "IDS-V0_1-STAGE114-P4",
                    "next_gate_id": "IDS-STAGE114-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE114"
                and roadmap.get("current_phase_id") == "IDS-STAGE114-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE114-REVIEW"
                and roadmap.get("next_gate_id") == "IDS-STAGE115-P1-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage114_review_state")
                == {
                    "current_stage_id": "IDS-STAGE114",
                    "current_phase_id": "IDS-STAGE114-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE114-REVIEW",
                    "next_gate_id": "IDS-STAGE115-P1-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE115"
                and roadmap.get("current_phase_id") == "IDS-STAGE115-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE115-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE115-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage115_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE115",
                    "current_phase_id": "IDS-STAGE115-P1",
                    "current_task_id": "IDS-V0_1-STAGE115-P1",
                    "next_gate_id": "IDS-STAGE115-P2-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE115"
                and roadmap.get("current_phase_id") == "IDS-STAGE115-P2"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE115-P2"
                and roadmap.get("next_gate_id") == "IDS-STAGE115-P3-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage115_phase2_state")
                == {
                    "current_stage_id": "IDS-STAGE115",
                    "current_phase_id": "IDS-STAGE115-P2",
                    "current_task_id": "IDS-V0_1-STAGE115-P2",
                    "next_gate_id": "IDS-STAGE115-P3-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE115"
                and roadmap.get("current_phase_id") == "IDS-STAGE115-P3"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE115-P3"
                and roadmap.get("next_gate_id") == "IDS-STAGE115-P4-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage115_phase3_state")
                == {
                    "current_stage_id": "IDS-STAGE115",
                    "current_phase_id": "IDS-STAGE115-P3",
                    "current_task_id": "IDS-V0_1-STAGE115-P3",
                    "next_gate_id": "IDS-STAGE115-P4-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE115"
                and roadmap.get("current_phase_id") == "IDS-STAGE115-P4"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE115-P4"
                and roadmap.get("next_gate_id") == "IDS-STAGE115-REVIEW-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage115_phase4_state")
                == {
                    "current_stage_id": "IDS-STAGE115",
                    "current_phase_id": "IDS-STAGE115-P4",
                    "current_task_id": "IDS-V0_1-STAGE115-P4",
                    "next_gate_id": "IDS-STAGE115-REVIEW-GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE115"
                and roadmap.get("current_phase_id") == "IDS-STAGE115-REVIEW"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE115-REVIEW"
                and roadmap.get("next_gate_id") == "UNASSIGNED_SUCCESSOR_GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage115_review_state")
                == {
                    "current_stage_id": "IDS-STAGE115",
                    "current_phase_id": "IDS-STAGE115-REVIEW",
                    "current_task_id": "IDS-V0_1-STAGE115-REVIEW",
                    "next_gate_id": "UNASSIGNED_SUCCESSOR_GATE",
                }
            )
            or (
                roadmap.get("current_stage_id") == "IDS-STAGE116"
                and roadmap.get("current_phase_id") == "IDS-STAGE116-P1"
                and roadmap.get("current_task_id") == "IDS-V0_1-STAGE116-P1"
                and roadmap.get("next_gate_id") == "IDS-STAGE116-P2-GATE"
                and isinstance(roadmap.get("current_transition_history"), dict)
                and roadmap["current_transition_history"].get("stage116_phase1_state")
                == {
                    "current_stage_id": "IDS-STAGE116",
                    "current_phase_id": "IDS-STAGE116-P1",
                    "current_task_id": "IDS-V0_1-STAGE116-P1",
                    "next_gate_id": "IDS-STAGE116-P2-GATE",
                }
            )
        ),
...
def _projection_checks() -> dict[str, bool]:
    ...
    stage097_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE097"
        and status.get("phase") == "IDS-STAGE097-P1"
        and status.get("task") == "IDS-V0_1-STAGE097-P1"
        and status.get("next_gate") == "IDS-STAGE097-P2-GATE"
        and status.get("evidence_status") == "STAGE097_ANSWER_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage097_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE097"
        and status.get("phase") == "IDS-STAGE097-P2"
        and status.get("task") == "IDS-V0_1-STAGE097-P2"
        and status.get("next_gate") == "IDS-STAGE097-P3-GATE"
        and status.get("evidence_status")
        == "STAGE097_ANSWER_CONTRACT_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage097_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE097"
        and status.get("phase") == "IDS-STAGE097-P3"
        and status.get("task") == "IDS-V0_1-STAGE097-P3"
        and status.get("next_gate") == "IDS-STAGE097-P4-GATE"
        and status.get("evidence_status")
        == "STAGE097_ANSWER_CONTRACT_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage097_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE097"
        and status.get("phase") == "IDS-STAGE097-P4"
        and status.get("task") == "IDS-V0_1-STAGE097-P4"
        and status.get("next_gate") == "IDS-STAGE097-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE097_ANSWER_CONTRACT_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage097_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE097"
        and status.get("phase") == "IDS-STAGE097-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE097-REVIEW"
        and status.get("next_gate") == "IDS-STAGE098-P1-GATE"
        and status.get("evidence_status")
        == "STAGE097_ANSWER_CONTRACT_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage098_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE098"
        and status.get("phase") == "IDS-STAGE098-P1"
        and status.get("task") == "IDS-V0_1-STAGE098-P1"
        and status.get("next_gate") == "IDS-STAGE098-P2-GATE"
        and status.get("evidence_status")
        == "STAGE098_PROMPT_VERSIONING_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage098_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE098"
        and status.get("phase") == "IDS-STAGE098-P2"
        and status.get("task") == "IDS-V0_1-STAGE098-P2"
        and status.get("next_gate") == "IDS-STAGE098-P3-GATE"
        and status.get("evidence_status")
        == "STAGE098_PROMPT_VERSIONING_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage098_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE098"
        and status.get("phase") == "IDS-STAGE098-P3"
        and status.get("task") == "IDS-V0_1-STAGE098-P3"
        and status.get("next_gate") == "IDS-STAGE098-P4-GATE"
        and status.get("evidence_status")
        == "STAGE098_PROMPT_VERSIONING_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage098_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE098"
        and status.get("phase") == "IDS-STAGE098-P4"
        and status.get("task") == "IDS-V0_1-STAGE098-P4"
        and status.get("next_gate") == "IDS-STAGE098-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE098_PROMPT_VERSIONING_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage098_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE098"
        and status.get("phase") == "IDS-STAGE098-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE098-REVIEW"
        and status.get("next_gate") == "IDS-STAGE099-P1-GATE"
        and status.get("evidence_status")
        == "STAGE098_PROMPT_VERSIONING_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage099_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE099"
        and status.get("phase") == "IDS-STAGE099-P1"
        and status.get("task") == "IDS-V0_1-STAGE099-P1"
        and status.get("next_gate") == "IDS-STAGE099-P2-GATE"
        and status.get("evidence_status")
        == "STAGE099_INTERNAL_EVIDENCE_EXTERNAL_AUGMENTATION_SEPARATION_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage099_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE099"
        and status.get("phase") == "IDS-STAGE099-P2"
        and status.get("task") == "IDS-V0_1-STAGE099-P2"
        and status.get("next_gate") == "IDS-STAGE099-P3-GATE"
        and status.get("evidence_status")
        == "STAGE099_INTERNAL_EVIDENCE_EXTERNAL_AUGMENTATION_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage099_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE099"
        and status.get("phase") == "IDS-STAGE099-P3"
        and status.get("task") == "IDS-V0_1-STAGE099-P3"
        and status.get("next_gate") == "IDS-STAGE099-P4-GATE"
        and status.get("evidence_status")
        == "STAGE099_INTERNAL_EVIDENCE_EXTERNAL_AUGMENTATION_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage099_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE099"
        and status.get("phase") == "IDS-STAGE099-P4"
        and status.get("task") == "IDS-V0_1-STAGE099-P4"
        and status.get("next_gate") == "IDS-STAGE099-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE099_INTERNAL_EVIDENCE_EXTERNAL_AUGMENTATION_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage099_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE099"
        and status.get("phase") == "IDS-STAGE099-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE099-REVIEW"
        and status.get("next_gate") == "IDS-STAGE100-P1-GATE"
        and status.get("evidence_status")
        == "STAGE099_INTERNAL_EVIDENCE_EXTERNAL_AUGMENTATION_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage100_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE100"
        and status.get("phase") == "IDS-STAGE100-P1"
        and status.get("task") == "IDS-V0_1-STAGE100-P1"
        and status.get("next_gate") == "IDS-STAGE100-P2-GATE"
        and status.get("evidence_status")
        == "STAGE100_NO_INTERNAL_EVIDENCE_STRATEGY_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage100_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE100"
        and status.get("phase") == "IDS-STAGE100-P2"
        and status.get("task") == "IDS-V0_1-STAGE100-P2"
        and status.get("next_gate") == "IDS-STAGE100-P3-GATE"
        and status.get("evidence_status")
        == "STAGE100_NO_INTERNAL_EVIDENCE_STRATEGY_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage100_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE100"
        and status.get("phase") == "IDS-STAGE100-P3"
        and status.get("task") == "IDS-V0_1-STAGE100-P3"
        and status.get("next_gate") == "IDS-STAGE100-P4-GATE"
        and status.get("evidence_status")
        == "STAGE100_NO_INTERNAL_EVIDENCE_STRATEGY_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage100_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE100"
        and status.get("phase") == "IDS-STAGE100-P4"
        and status.get("task") == "IDS-V0_1-STAGE100-P4"
        and status.get("next_gate") == "IDS-STAGE100-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE100_NO_INTERNAL_EVIDENCE_STRATEGY_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage100_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE100"
        and status.get("phase") == "IDS-STAGE100-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE100-REVIEW"
        and status.get("next_gate") == "IDS-STAGE101-P1-GATE"
        and status.get("evidence_status")
        == "STAGE100_NO_INTERNAL_EVIDENCE_STRATEGY_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage101_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE101"
        and status.get("phase") == "IDS-STAGE101-P1"
        and status.get("task") == "IDS-V0_1-STAGE101-P1"
        and status.get("next_gate") == "IDS-STAGE101-P2-GATE"
        and status.get("evidence_status")
        == "STAGE101_RAG_REPRODUCIBILITY_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage101_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE101"
        and status.get("phase") == "IDS-STAGE101-P2"
        and status.get("task") == "IDS-V0_1-STAGE101-P2"
        and status.get("next_gate") == "IDS-STAGE101-P3-GATE"
        and status.get("evidence_status")
        == "STAGE101_RAG_REPRODUCIBILITY_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage101_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE101"
        and status.get("phase") == "IDS-STAGE101-P3"
        and status.get("task") == "IDS-V0_1-STAGE101-P3"
        and status.get("next_gate") == "IDS-STAGE101-P4-GATE"
        and status.get("evidence_status")
        == "STAGE101_RAG_REPRODUCIBILITY_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage101_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE101"
        and status.get("phase") == "IDS-STAGE101-P4"
        and status.get("task") == "IDS-V0_1-STAGE101-P4"
        and status.get("next_gate") == "IDS-STAGE101-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE101_RAG_REPRODUCIBILITY_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage101_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE101"
        and status.get("phase") == "IDS-STAGE101-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE101-REVIEW"
        and status.get("next_gate") == "IDS-STAGE102-P1-GATE"
        and status.get("evidence_status")
        == "STAGE101_RAG_REPRODUCIBILITY_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage102_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE102"
        and status.get("phase") == "IDS-STAGE102-P1"
        and status.get("task") == "IDS-V0_1-STAGE102-P1"
        and status.get("next_gate") == "IDS-STAGE102-P2-GATE"
        and status.get("evidence_status")
        == "STAGE102_DOCUMENT_PROMPT_INJECTION_DEFENSE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage102_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE102"
        and status.get("phase") == "IDS-STAGE102-P2"
        and status.get("task") == "IDS-V0_1-STAGE102-P2"
        and status.get("next_gate") == "IDS-STAGE102-P3-GATE"
        and status.get("evidence_status")
        == "STAGE102_DOCUMENT_PROMPT_INJECTION_DEFENSE_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage102_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE102"
        and status.get("phase") == "IDS-STAGE102-P3"
        and status.get("task") == "IDS-V0_1-STAGE102-P3"
        and status.get("next_gate") == "IDS-STAGE102-P4-GATE"
        and status.get("evidence_status")
        == "STAGE102_DOCUMENT_PROMPT_INJECTION_DEFENSE_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage102_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE102"
        and status.get("phase") == "IDS-STAGE102-P4"
        and status.get("task") == "IDS-V0_1-STAGE102-P4"
        and status.get("next_gate") == "IDS-STAGE102-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE102_DOCUMENT_PROMPT_INJECTION_DEFENSE_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage102_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE102"
        and status.get("phase") == "IDS-STAGE102-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE102-REVIEW"
        and status.get("next_gate") == "IDS-STAGE103-P1-GATE"
        and status.get("evidence_status")
        == "STAGE102_DOCUMENT_PROMPT_INJECTION_DEFENSE_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage103_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE103"
        and status.get("phase") == "IDS-STAGE103-P1"
        and status.get("task") == "IDS-V0_1-STAGE103-P1"
        and status.get("next_gate") == "IDS-STAGE103-P2-GATE"
        and status.get("evidence_status")
        == "STAGE103_MODEL_OUTPUT_PERMISSION_GATE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage103_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE103"
        and status.get("phase") == "IDS-STAGE103-P2"
        and status.get("task") == "IDS-V0_1-STAGE103-P2"
        and status.get("next_gate") == "IDS-STAGE103-P3-GATE"
        and status.get("evidence_status")
        == "STAGE103_MODEL_OUTPUT_PERMISSION_GATE_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage103_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE103"
        and status.get("phase") == "IDS-STAGE103-P3"
        and status.get("task") == "IDS-V0_1-STAGE103-P3"
        and status.get("next_gate") == "IDS-STAGE103-P4-GATE"
        and status.get("evidence_status")
        == "STAGE103_MODEL_OUTPUT_PERMISSION_GATE_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage103_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE103"
        and status.get("phase") == "IDS-STAGE103-P4"
        and status.get("task") == "IDS-V0_1-STAGE103-P4"
        and status.get("next_gate") == "IDS-STAGE103-REVIEW-GATE"
        and status.get("evidence_status")
        == "STAGE103_MODEL_OUTPUT_PERMISSION_GATE_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage103_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE103"
        and status.get("phase") == "IDS-STAGE103-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE103-REVIEW"
        and status.get("next_gate") == "IDS-STAGE104-P1-GATE"
        and status.get("evidence_status")
        == "PASS_REVIEWED_MODEL_OUTPUT_PERMISSION_GATE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage104_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE104"
        and status.get("phase") == "IDS-STAGE104-P1"
        and status.get("task") == "IDS-V0_1-STAGE104-P1"
        and status.get("next_gate") == "IDS-STAGE104-P2-GATE"
        and status.get("evidence_status")
        == "RAG_NEGATIVE_TEST_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage104_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE104"
        and status.get("phase") == "IDS-STAGE104-P2"
        and status.get("task") == "IDS-V0_1-STAGE104-P2"
        and status.get("next_gate") == "IDS-STAGE104-P3-GATE"
        and status.get("evidence_status")
        == "RAG_NEGATIVE_TEST_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage104_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE104"
        and status.get("phase") == "IDS-STAGE104-P3"
        and status.get("task") == "IDS-V0_1-STAGE104-P3"
        and status.get("next_gate") == "IDS-STAGE104-P4-GATE"
        and status.get("evidence_status")
        == "RAG_NEGATIVE_TEST_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage104_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE104"
        and status.get("phase") == "IDS-STAGE104-P4"
        and status.get("task") == "IDS-V0_1-STAGE104-P4"
        and status.get("next_gate") == "IDS-STAGE104-REVIEW-GATE"
        and status.get("evidence_status")
        == "RAG_NEGATIVE_TEST_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage104_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE104"
        and status.get("phase") == "IDS-STAGE104-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE104-REVIEW"
        and status.get("next_gate") == "IDS-STAGE105-P1-GATE"
        and status.get("evidence_status")
        == "PASS_REVIEWED_RAG_NEGATIVE_TEST_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage105_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE105"
        and status.get("phase") == "IDS-STAGE105-P1"
        and status.get("task") == "IDS-V0_1-STAGE105-P1"
        and status.get("next_gate") == "IDS-STAGE105-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_EVIDENCE_BINDING_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage105_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE105"
        and status.get("phase") == "IDS-STAGE105-P2"
        and status.get("task") == "IDS-V0_1-STAGE105-P2"
        and status.get("next_gate") == "IDS-STAGE105-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_EVIDENCE_BINDING_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage105_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE105"
        and status.get("phase") == "IDS-STAGE105-P3"
        and status.get("task") == "IDS-V0_1-STAGE105-P3"
        and status.get("next_gate") == "IDS-STAGE105-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_EVIDENCE_BINDING_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage105_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE105"
        and status.get("phase") == "IDS-STAGE105-P4"
        and status.get("task") == "IDS-V0_1-STAGE105-P4"
        and status.get("next_gate") == "IDS-STAGE105-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_EVIDENCE_BINDING_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage105_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE105"
        and status.get("phase") == "IDS-STAGE105-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE105-REVIEW"
        and status.get("next_gate") == "IDS-STAGE106-P1-GATE"
        and status.get("evidence_status")
        == "REPORT_EVIDENCE_BINDING_STAGE_REVIEW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage106_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE106"
        and status.get("phase") == "IDS-STAGE106-P1"
        and status.get("task") == "IDS-V0_1-STAGE106-P1"
        and status.get("next_gate") == "IDS-STAGE106-P2-GATE"
        and status.get("evidence_status")
        == "EXTERNAL_AUGMENTATION_OPINION_CHAPTER_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage106_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE106"
        and status.get("phase") == "IDS-STAGE106-P2"
        and status.get("task") == "IDS-V0_1-STAGE106-P2"
        and status.get("next_gate") == "IDS-STAGE106-P3-GATE"
        and status.get("evidence_status")
    ...
    stage106_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE106"
        and status.get("phase") == "IDS-STAGE106-P4"
        and status.get("task") == "IDS-V0_1-STAGE106-P4"
        and status.get("next_gate") == "IDS-STAGE106-REVIEW-GATE"
        and status.get("evidence_status")
        == "EXTERNAL_AUGMENTATION_OPINION_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage106_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE106"
        and status.get("phase") == "IDS-STAGE106-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE106-REVIEW"
        and status.get("next_gate") == "IDS-STAGE107-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_EXTERNAL_AUGMENTATION_OPINION_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage107_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE107"
        and status.get("phase") == "IDS-STAGE107-P1"
        and status.get("task") == "IDS-V0_1-STAGE107-P1"
        and status.get("next_gate") == "IDS-STAGE107-P2-GATE"
        and status.get("evidence_status")
        == "HUMAN_CONFIRMATION_ITEMS_CHAPTER_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage107_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE107"
        and status.get("phase") == "IDS-STAGE107-P2"
        and status.get("task") == "IDS-V0_1-STAGE107-P2"
        and status.get("next_gate") == "IDS-STAGE107-P3-GATE"
        and status.get("evidence_status")
        == "HUMAN_CONFIRMATION_ITEMS_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage107_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE107"
        and status.get("phase") == "IDS-STAGE107-P3"
        and status.get("task") == "IDS-V0_1-STAGE107-P3"
        and status.get("next_gate") == "IDS-STAGE107-P4-GATE"
        and status.get("evidence_status")
        == "HUMAN_CONFIRMATION_ITEMS_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage107_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE107"
        and status.get("phase") == "IDS-STAGE107-P4"
        and status.get("task") == "IDS-V0_1-STAGE107-P4"
        and status.get("next_gate") == "IDS-STAGE107-REVIEW-GATE"
        and status.get("evidence_status")
        == "HUMAN_CONFIRMATION_ITEMS_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage107_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE107"
        and status.get("phase") == "IDS-STAGE107-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE107-REVIEW"
        and status.get("next_gate") == "IDS-STAGE108-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_HUMAN_CONFIRMATION_ITEMS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage108_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE108"
        and status.get("phase") == "IDS-STAGE108-P1"
        and status.get("task") == "IDS-V0_1-STAGE108-P1"
        and status.get("next_gate") == "IDS-STAGE108-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_SNAPSHOT_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage108_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE108"
        and status.get("phase") == "IDS-STAGE108-P2"
        and status.get("task") == "IDS-V0_1-STAGE108-P2"
        and status.get("next_gate") == "IDS-STAGE108-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_SNAPSHOT_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage108_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE108"
        and status.get("phase") == "IDS-STAGE108-P3"
        and status.get("task") == "IDS-V0_1-STAGE108-P3"
        and status.get("next_gate") == "IDS-STAGE108-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_SNAPSHOT_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage108_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE108"
        and status.get("phase") == "IDS-STAGE108-P4"
        and status.get("task") == "IDS-V0_1-STAGE108-P4"
        and status.get("next_gate") == "IDS-STAGE108-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_SNAPSHOT_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage108_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE108"
        and status.get("phase") == "IDS-STAGE108-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE108-REVIEW"
        and status.get("next_gate") == "IDS-STAGE109-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REPORT_SNAPSHOT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage109_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE109"
        and status.get("phase") == "IDS-STAGE109-P1"
        and status.get("task") == "IDS-V0_1-STAGE109-P1"
        and status.get("next_gate") == "IDS-STAGE109-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_IMPACT_ANALYSIS_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage109_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE109"
        and status.get("phase") == "IDS-STAGE109-P2"
        and status.get("task") == "IDS-V0_1-STAGE109-P2"
        and status.get("next_gate") == "IDS-STAGE109-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_IMPACT_ANALYSIS_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage109_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE109"
        and status.get("phase") == "IDS-STAGE109-P3"
        and status.get("task") == "IDS-V0_1-STAGE109-P3"
        and status.get("next_gate") == "IDS-STAGE109-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_IMPACT_ANALYSIS_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage109_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE109"
        and status.get("phase") == "IDS-STAGE109-P4"
        and status.get("task") == "IDS-V0_1-STAGE109-P4"
        and status.get("next_gate") == "IDS-STAGE109-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_IMPACT_ANALYSIS_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage109_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE109"
        and status.get("phase") == "IDS-STAGE109-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE109-REVIEW"
        and status.get("next_gate") == "IDS-STAGE110-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REPORT_IMPACT_ANALYSIS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage110_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE110"
        and status.get("phase") == "IDS-STAGE110-P1"
        and status.get("task") == "IDS-V0_1-STAGE110-P1"
        and status.get("next_gate") == "IDS-STAGE110-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_QUALITY_SCORE_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage110_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE110"
        and status.get("phase") == "IDS-STAGE110-P2"
        and status.get("task") == "IDS-V0_1-STAGE110-P2"
        and status.get("next_gate") == "IDS-STAGE110-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_QUALITY_SCORE_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage110_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE110"
        and status.get("phase") == "IDS-STAGE110-P3"
        and status.get("task") == "IDS-V0_1-STAGE110-P3"
        and status.get("next_gate") == "IDS-STAGE110-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_QUALITY_SCORE_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage110_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE110"
        and status.get("phase") == "IDS-STAGE110-P4"
        and status.get("task") == "IDS-V0_1-STAGE110-P4"
        and status.get("next_gate") == "IDS-STAGE110-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_QUALITY_SCORE_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage110_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE110"
        and status.get("phase") == "IDS-STAGE110-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE110-REVIEW"
        and status.get("next_gate") == "IDS-STAGE111-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REPORT_QUALITY_SCORE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage111_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE111"
        and status.get("phase") == "IDS-STAGE111-P1"
        and status.get("task") == "IDS-V0_1-STAGE111-P1"
        and status.get("next_gate") == "IDS-STAGE111-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_REGENERATION_QUEUE_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage111_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE111"
        and status.get("phase") == "IDS-STAGE111-P2"
        and status.get("task") == "IDS-V0_1-STAGE111-P2"
        and status.get("next_gate") == "IDS-STAGE111-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_REGENERATION_QUEUE_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage111_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE111"
        and status.get("phase") == "IDS-STAGE111-P3"
        and status.get("task") == "IDS-V0_1-STAGE111-P3"
        and status.get("next_gate") == "IDS-STAGE111-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_REGENERATION_QUEUE_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage111_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE111"
        and status.get("phase") == "IDS-STAGE111-P4"
        and status.get("task") == "IDS-V0_1-STAGE111-P4"
        and status.get("next_gate") == "IDS-STAGE111-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_REGENERATION_QUEUE_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage111_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE111"
        and status.get("phase") == "IDS-STAGE111-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE111-REVIEW"
        and status.get("next_gate") == "IDS-STAGE112-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REPORT_REGENERATION_QUEUE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage112_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE112"
        and status.get("phase") == "IDS-STAGE112-P1"
        and status.get("task") == "IDS-V0_1-STAGE112-P1"
        and status.get("next_gate") == "IDS-STAGE112-P2-GATE"
        and status.get("evidence_status")
        == "REPORT_EXPORT_AUDIT_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage112_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE112"
        and status.get("phase") == "IDS-STAGE112-P2"
        and status.get("task") == "IDS-V0_1-STAGE112-P2"
        and status.get("next_gate") == "IDS-STAGE112-P3-GATE"
        and status.get("evidence_status")
        == "REPORT_EXPORT_AUDIT_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage112_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE112"
        and status.get("phase") == "IDS-STAGE112-P3"
        and status.get("task") == "IDS-V0_1-STAGE112-P3"
        and status.get("next_gate") == "IDS-STAGE112-P4-GATE"
        and status.get("evidence_status")
        == "REPORT_EXPORT_AUDIT_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage112_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE112"
        and status.get("phase") == "IDS-STAGE112-P4"
        and status.get("task") == "IDS-V0_1-STAGE112-P4"
        and status.get("next_gate") == "IDS-STAGE112-REVIEW-GATE"
        and status.get("evidence_status")
        == "REPORT_EXPORT_AUDIT_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage112_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE112"
        and status.get("phase") == "IDS-STAGE112-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE112-REVIEW"
        and status.get("next_gate") == "IDS-STAGE113-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REPORT_EXPORT_AUDIT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage113_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE113"
        and status.get("phase") == "IDS-STAGE113-P1"
        and status.get("task") == "IDS-V0_1-STAGE113-P1"
        and status.get("next_gate") == "IDS-STAGE113-P2-GATE"
        and status.get("evidence_status")
        == "REVIEW_QUEUE_SCHEMA_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage113_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE113"
        and status.get("phase") == "IDS-STAGE113-P2"
        and status.get("task") == "IDS-V0_1-STAGE113-P2"
        and status.get("next_gate") == "IDS-STAGE113-P3-GATE"
        and status.get("evidence_status")
        == "REVIEW_QUEUE_SCHEMA_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage113_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE113"
        and status.get("phase") == "IDS-STAGE113-P3"
        and status.get("task") == "IDS-V0_1-STAGE113-P3"
        and status.get("next_gate") == "IDS-STAGE113-P4-GATE"
        and status.get("evidence_status")
        == "REVIEW_QUEUE_SCHEMA_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage113_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE113"
        and status.get("phase") == "IDS-STAGE113-P4"
        and status.get("task") == "IDS-V0_1-STAGE113-P4"
        and status.get("next_gate") == "IDS-STAGE113-REVIEW-GATE"
        and status.get("evidence_status")
        == "REVIEW_QUEUE_SCHEMA_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage113_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE113"
        and status.get("phase") == "IDS-STAGE113-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE113-REVIEW"
        and status.get("next_gate") == "IDS-STAGE114-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REVIEW_QUEUE_SCHEMA_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage114_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE114"
        and status.get("phase") == "IDS-STAGE114-P1"
        and status.get("task") == "IDS-V0_1-STAGE114-P1"
        and status.get("next_gate") == "IDS-STAGE114-P2-GATE"
        and status.get("evidence_status")
        == "REVIEW_WORKFLOW_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage114_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE114"
        and status.get("phase") == "IDS-STAGE114-P2"
        and status.get("task") == "IDS-V0_1-STAGE114-P2"
        and status.get("next_gate") == "IDS-STAGE114-P3-GATE"
        and status.get("evidence_status")
        == "REVIEW_WORKFLOW_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage114_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE114"
        and status.get("phase") == "IDS-STAGE114-P3"
        and status.get("task") == "IDS-V0_1-STAGE114-P3"
        and status.get("next_gate") == "IDS-STAGE114-P4-GATE"
        and status.get("evidence_status")
        == "REVIEW_WORKFLOW_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage114_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE114"
        and status.get("phase") == "IDS-STAGE114-P4"
        and status.get("task") == "IDS-V0_1-STAGE114-P4"
        and status.get("next_gate") == "IDS-STAGE114-REVIEW-GATE"
        and status.get("evidence_status")
        == "REVIEW_WORKFLOW_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage114_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE114"
        and status.get("phase") == "IDS-STAGE114-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE114-REVIEW"
        and status.get("next_gate") == "IDS-STAGE115-P1-GATE"
        and status.get("evidence_status")
        == "REVIEWED_REVIEW_WORKFLOW_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage115_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE115"
        and status.get("phase") == "IDS-STAGE115-P1"
        and status.get("task") == "IDS-V0_1-STAGE115-P1"
        and status.get("next_gate") == "IDS-STAGE115-P2-GATE"
        and status.get("evidence_status")
        == "REVIEW_UI_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage115_phase2_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE115"
        and status.get("phase") == "IDS-STAGE115-P2"
        and status.get("task") == "IDS-V0_1-STAGE115-P2"
        and status.get("next_gate") == "IDS-STAGE115-P3-GATE"
        and status.get("evidence_status")
        == "REVIEW_UI_CONTROL_SLICE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage115_phase3_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE115"
        and status.get("phase") == "IDS-STAGE115-P3"
        and status.get("task") == "IDS-V0_1-STAGE115-P3"
        and status.get("next_gate") == "IDS-STAGE115-P4-GATE"
        and status.get("evidence_status")
        == "REVIEW_UI_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage115_phase4_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE115"
        and status.get("phase") == "IDS-STAGE115-P4"
        and status.get("task") == "IDS-V0_1-STAGE115-P4"
        and status.get("next_gate") == "IDS-STAGE115-REVIEW-GATE"
        and status.get("evidence_status")
        == "REVIEW_UI_DELIVERY_EVIDENCE_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage115_review_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE115"
        and status.get("phase") == "IDS-STAGE115-REVIEW"
        and status.get("task") == "IDS-V0_1-STAGE115-REVIEW"
        and status.get("next_gate") == "UNASSIGNED_SUCCESSOR_GATE"
        and status.get("evidence_status")
        == "REVIEWED_REVIEW_UI_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage116_phase1_status = (
        isinstance(status, dict)
        and status.get("stage") == "IDS-STAGE116"
        and status.get("phase") == "IDS-STAGE116-P1"
        and status.get("task") == "IDS-V0_1-STAGE116-P1"
        and status.get("next_gate") == "IDS-STAGE116-P2-GATE"
        and status.get("evidence_status")
        == "REVIEW_AUDIT_CONTRACT_RUNTIME_DISABLED"
        and status.get("runtime_enabled") is False
        and status.get("push_allowed") is False
    )
    stage097_phase1_plan = (
        ...
        and plan.get("phase") == "IDS-STAGE097-P1"
        and plan.get("task") == "IDS-V0_1-STAGE097-P1"
        and "IDS-STAGE097-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage097_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE097"
        and plan.get("phase") == "IDS-STAGE097-P2"
        and plan.get("task") == "IDS-V0_1-STAGE097-P2"
        and "IDS-STAGE097-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage097_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE097"
        and plan.get("phase") == "IDS-STAGE097-P3"
        and plan.get("task") == "IDS-V0_1-STAGE097-P3"
        and "IDS-STAGE097-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage097_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE097"
        and plan.get("phase") == "IDS-STAGE097-P4"
        and plan.get("task") == "IDS-V0_1-STAGE097-P4"
        and "IDS-STAGE097-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage097_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE097"
        and plan.get("phase") == "IDS-STAGE097-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE097-REVIEW"
        and "IDS-STAGE098-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage098_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE098"
        and plan.get("phase") == "IDS-STAGE098-P1"
        and plan.get("task") == "IDS-V0_1-STAGE098-P1"
        and "IDS-STAGE098-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage098_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE098"
        and plan.get("phase") == "IDS-STAGE098-P2"
        and plan.get("task") == "IDS-V0_1-STAGE098-P2"
        and "IDS-STAGE098-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage098_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE098"
        and plan.get("phase") == "IDS-STAGE098-P3"
        and plan.get("task") == "IDS-V0_1-STAGE098-P3"
        and "IDS-STAGE098-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage098_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE098"
        and plan.get("phase") == "IDS-STAGE098-P4"
        and plan.get("task") == "IDS-V0_1-STAGE098-P4"
        and "IDS-STAGE098-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage098_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE098"
        and plan.get("phase") == "IDS-STAGE098-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE098-REVIEW"
        and "IDS-STAGE099-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage099_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE099"
        and plan.get("phase") == "IDS-STAGE099-P1"
        and plan.get("task") == "IDS-V0_1-STAGE099-P1"
        and "IDS-STAGE099-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage099_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE099"
        and plan.get("phase") == "IDS-STAGE099-P2"
        and plan.get("task") == "IDS-V0_1-STAGE099-P2"
        and "IDS-STAGE099-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage099_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE099"
        and plan.get("phase") == "IDS-STAGE099-P3"
        and plan.get("task") == "IDS-V0_1-STAGE099-P3"
        and "IDS-STAGE099-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage099_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE099"
        and plan.get("phase") == "IDS-STAGE099-P4"
        and plan.get("task") == "IDS-V0_1-STAGE099-P4"
        and "IDS-STAGE099-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage099_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE099"
        and plan.get("phase") == "IDS-STAGE099-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE099-REVIEW"
        and "IDS-STAGE100-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage100_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE100"
        and plan.get("phase") == "IDS-STAGE100-P1"
        and plan.get("task") == "IDS-V0_1-STAGE100-P1"
        and "IDS-STAGE100-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage100_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE100"
        and plan.get("phase") == "IDS-STAGE100-P2"
        and plan.get("task") == "IDS-V0_1-STAGE100-P2"
        and "IDS-STAGE100-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage100_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE100"
        and plan.get("phase") == "IDS-STAGE100-P3"
        and plan.get("task") == "IDS-V0_1-STAGE100-P3"
        and "IDS-STAGE100-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage100_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE100"
        and plan.get("phase") == "IDS-STAGE100-P4"
        and plan.get("task") == "IDS-V0_1-STAGE100-P4"
        and "IDS-STAGE100-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage100_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE100"
        and plan.get("phase") == "IDS-STAGE100-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE100-REVIEW"
        and "IDS-STAGE101-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage101_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE101"
        and plan.get("phase") == "IDS-STAGE101-P1"
        and plan.get("task") == "IDS-V0_1-STAGE101-P1"
        and "IDS-STAGE101-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage101_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE101"
        and plan.get("phase") == "IDS-STAGE101-P2"
        and plan.get("task") == "IDS-V0_1-STAGE101-P2"
        and "IDS-STAGE101-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage101_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE101"
        and plan.get("phase") == "IDS-STAGE101-P3"
        and plan.get("task") == "IDS-V0_1-STAGE101-P3"
        and "IDS-STAGE101-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage101_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE101"
        and plan.get("phase") == "IDS-STAGE101-P4"
        and plan.get("task") == "IDS-V0_1-STAGE101-P4"
        and "IDS-STAGE101-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage101_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE101"
        and plan.get("phase") == "IDS-STAGE101-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE101-REVIEW"
        and "IDS-STAGE102-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage102_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE102"
        and plan.get("phase") == "IDS-STAGE102-P1"
        and plan.get("task") == "IDS-V0_1-STAGE102-P1"
        and "IDS-STAGE102-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage102_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE102"
        and plan.get("phase") == "IDS-STAGE102-P2"
        and plan.get("task") == "IDS-V0_1-STAGE102-P2"
        and "IDS-STAGE102-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage102_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE102"
        and plan.get("phase") == "IDS-STAGE102-P3"
        and plan.get("task") == "IDS-V0_1-STAGE102-P3"
        and "IDS-STAGE102-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage102_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE102"
        and plan.get("phase") == "IDS-STAGE102-P4"
        and plan.get("task") == "IDS-V0_1-STAGE102-P4"
        and "IDS-STAGE102-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage102_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE102"
        and plan.get("phase") == "IDS-STAGE102-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE102-REVIEW"
        and "IDS-STAGE103-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage103_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE103"
        and plan.get("phase") == "IDS-STAGE103-P1"
        and plan.get("task") == "IDS-V0_1-STAGE103-P1"
        and "IDS-STAGE103-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage103_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE103"
        and plan.get("phase") == "IDS-STAGE103-P2"
        and plan.get("task") == "IDS-V0_1-STAGE103-P2"
        and "IDS-STAGE103-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage103_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE103"
        and plan.get("phase") == "IDS-STAGE103-P3"
        and plan.get("task") == "IDS-V0_1-STAGE103-P3"
        and "IDS-STAGE103-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage103_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE103"
        and plan.get("phase") == "IDS-STAGE103-P4"
        and plan.get("task") == "IDS-V0_1-STAGE103-P4"
        and "IDS-STAGE103-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage103_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE103"
        and plan.get("phase") == "IDS-STAGE103-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE103-REVIEW"
        and "IDS-STAGE104-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage104_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE104"
        and plan.get("phase") == "IDS-STAGE104-P1"
        and plan.get("task") == "IDS-V0_1-STAGE104-P1"
        and "IDS-STAGE104-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage104_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE104"
        and plan.get("phase") == "IDS-STAGE104-P2"
        and plan.get("task") == "IDS-V0_1-STAGE104-P2"
        and "IDS-STAGE104-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage104_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE104"
        and plan.get("phase") == "IDS-STAGE104-P3"
        and plan.get("task") == "IDS-V0_1-STAGE104-P3"
        and "IDS-STAGE104-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage104_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE104"
        and plan.get("phase") == "IDS-STAGE104-P4"
        and plan.get("task") == "IDS-V0_1-STAGE104-P4"
        and "IDS-STAGE104-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage104_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE104"
        and plan.get("phase") == "IDS-STAGE104-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE104-REVIEW"
        and "IDS-STAGE105-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage105_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE105"
        and plan.get("phase") == "IDS-STAGE105-P1"
        and plan.get("task") == "IDS-V0_1-STAGE105-P1"
        and "IDS-STAGE105-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage105_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE105"
        and plan.get("phase") == "IDS-STAGE105-P2"
        and plan.get("task") == "IDS-V0_1-STAGE105-P2"
        and "IDS-STAGE105-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage105_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE105"
        and plan.get("phase") == "IDS-STAGE105-P3"
        and plan.get("task") == "IDS-V0_1-STAGE105-P3"
        and "IDS-STAGE105-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage105_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE105"
        and plan.get("phase") == "IDS-STAGE105-P4"
        and plan.get("task") == "IDS-V0_1-STAGE105-P4"
        and "IDS-STAGE105-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage105_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE105"
        and plan.get("phase") == "IDS-STAGE105-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE105-REVIEW"
        and "IDS-STAGE106-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage106_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE106"
        and plan.get("phase") == "IDS-STAGE106-P1"
        and plan.get("task") == "IDS-V0_1-STAGE106-P1"
        and "IDS-STAGE106-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage106_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE106"
    ...
    stage106_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE106"
        and plan.get("phase") == "IDS-STAGE106-P4"
        and plan.get("task") == "IDS-V0_1-STAGE106-P4"
        and "IDS-STAGE106-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage106_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE106"
        and plan.get("phase") == "IDS-STAGE106-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE106-REVIEW"
        and "IDS-STAGE107-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage107_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE107"
        and plan.get("phase") == "IDS-STAGE107-P1"
        and plan.get("task") == "IDS-V0_1-STAGE107-P1"
        and "IDS-STAGE107-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage107_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE107"
        and plan.get("phase") == "IDS-STAGE107-P2"
        and plan.get("task") == "IDS-V0_1-STAGE107-P2"
        and "IDS-STAGE107-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage107_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE107"
        and plan.get("phase") == "IDS-STAGE107-P3"
        and plan.get("task") == "IDS-V0_1-STAGE107-P3"
        and "IDS-STAGE107-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage107_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE107"
        and plan.get("phase") == "IDS-STAGE107-P4"
        and plan.get("task") == "IDS-V0_1-STAGE107-P4"
        and "IDS-STAGE107-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage107_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE107"
        and plan.get("phase") == "IDS-STAGE107-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE107-REVIEW"
        and "IDS-STAGE108-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage108_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE108"
        and plan.get("phase") == "IDS-STAGE108-P1"
        and plan.get("task") == "IDS-V0_1-STAGE108-P1"
        and "IDS-STAGE108-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage108_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE108"
        and plan.get("phase") == "IDS-STAGE108-P2"
        and plan.get("task") == "IDS-V0_1-STAGE108-P2"
        and "IDS-STAGE108-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage108_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE108"
        and plan.get("phase") == "IDS-STAGE108-P3"
        and plan.get("task") == "IDS-V0_1-STAGE108-P3"
        and "IDS-STAGE108-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage108_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE108"
        and plan.get("phase") == "IDS-STAGE108-P4"
        and plan.get("task") == "IDS-V0_1-STAGE108-P4"
        and "IDS-STAGE108-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage108_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE108"
        and plan.get("phase") == "IDS-STAGE108-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE108-REVIEW"
        and "IDS-STAGE109-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage109_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE109"
        and plan.get("phase") == "IDS-STAGE109-P1"
        and plan.get("task") == "IDS-V0_1-STAGE109-P1"
        and "IDS-STAGE109-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage109_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE109"
        and plan.get("phase") == "IDS-STAGE109-P2"
        and plan.get("task") == "IDS-V0_1-STAGE109-P2"
        and "IDS-STAGE109-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage109_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE109"
        and plan.get("phase") == "IDS-STAGE109-P3"
        and plan.get("task") == "IDS-V0_1-STAGE109-P3"
        and "IDS-STAGE109-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage109_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE109"
        and plan.get("phase") == "IDS-STAGE109-P4"
        and plan.get("task") == "IDS-V0_1-STAGE109-P4"
        and "IDS-STAGE109-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage109_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE109"
        and plan.get("phase") == "IDS-STAGE109-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE109-REVIEW"
        and "IDS-STAGE110-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage110_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE110"
        and plan.get("phase") == "IDS-STAGE110-P1"
        and plan.get("task") == "IDS-V0_1-STAGE110-P1"
        and "IDS-STAGE110-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage110_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE110"
        and plan.get("phase") == "IDS-STAGE110-P2"
        and plan.get("task") == "IDS-V0_1-STAGE110-P2"
        and "IDS-STAGE110-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage110_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE110"
        and plan.get("phase") == "IDS-STAGE110-P3"
        and plan.get("task") == "IDS-V0_1-STAGE110-P3"
        and "IDS-STAGE110-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage110_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE110"
        and plan.get("phase") == "IDS-STAGE110-P4"
        and plan.get("task") == "IDS-V0_1-STAGE110-P4"
        and "IDS-STAGE110-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage110_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE110"
        and plan.get("phase") == "IDS-STAGE110-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE110-REVIEW"
        and "IDS-STAGE111-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage111_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE111"
        and plan.get("phase") == "IDS-STAGE111-P1"
        and plan.get("task") == "IDS-V0_1-STAGE111-P1"
        and "IDS-STAGE111-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage111_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE111"
        and plan.get("phase") == "IDS-STAGE111-P2"
        and plan.get("task") == "IDS-V0_1-STAGE111-P2"
        and "IDS-STAGE111-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage111_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE111"
        and plan.get("phase") == "IDS-STAGE111-P3"
        and plan.get("task") == "IDS-V0_1-STAGE111-P3"
        and "IDS-STAGE111-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage111_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE111"
        and plan.get("phase") == "IDS-STAGE111-P4"
        and plan.get("task") == "IDS-V0_1-STAGE111-P4"
        and "IDS-STAGE111-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage111_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE111"
        and plan.get("phase") == "IDS-STAGE111-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE111-REVIEW"
        and "IDS-STAGE112-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage112_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE112"
        and plan.get("phase") == "IDS-STAGE112-P1"
        and plan.get("task") == "IDS-V0_1-STAGE112-P1"
        and "IDS-STAGE112-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage112_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE112"
        and plan.get("phase") == "IDS-STAGE112-P2"
        and plan.get("task") == "IDS-V0_1-STAGE112-P2"
        and "IDS-STAGE112-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage112_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE112"
        and plan.get("phase") == "IDS-STAGE112-P3"
        and plan.get("task") == "IDS-V0_1-STAGE112-P3"
        and "IDS-STAGE112-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage112_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE112"
        and plan.get("phase") == "IDS-STAGE112-P4"
        and plan.get("task") == "IDS-V0_1-STAGE112-P4"
        and "IDS-STAGE112-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage112_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE112"
        and plan.get("phase") == "IDS-STAGE112-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE112-REVIEW"
        and "IDS-STAGE113-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage113_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE113"
        and plan.get("phase") == "IDS-STAGE113-P1"
        and plan.get("task") == "IDS-V0_1-STAGE113-P1"
        and "IDS-STAGE113-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage113_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE113"
        and plan.get("phase") == "IDS-STAGE113-P2"
        and plan.get("task") == "IDS-V0_1-STAGE113-P2"
        and "IDS-STAGE113-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage113_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE113"
        and plan.get("phase") == "IDS-STAGE113-P3"
        and plan.get("task") == "IDS-V0_1-STAGE113-P3"
        and "IDS-STAGE113-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage113_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE113"
        and plan.get("phase") == "IDS-STAGE113-P4"
        and plan.get("task") == "IDS-V0_1-STAGE113-P4"
        and "IDS-STAGE113-REVIEW-GATE"
        in str(plan.get("stop_condition", ""))
    )
    stage113_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE113"
        and plan.get("phase") == "IDS-STAGE113-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE113-REVIEW"
        and "IDS-STAGE114-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage114_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE114"
        and plan.get("phase") == "IDS-STAGE114-P1"
        and plan.get("task") == "IDS-V0_1-STAGE114-P1"
        and "IDS-STAGE114-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage114_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE114"
        and plan.get("phase") == "IDS-STAGE114-P2"
        and plan.get("task") == "IDS-V0_1-STAGE114-P2"
        and "IDS-STAGE114-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage114_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE114"
        and plan.get("phase") == "IDS-STAGE114-P3"
        and plan.get("task") == "IDS-V0_1-STAGE114-P3"
        and "IDS-STAGE114-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage114_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE114"
        and plan.get("phase") == "IDS-STAGE114-P4"
        and plan.get("task") == "IDS-V0_1-STAGE114-P4"
        and "IDS-STAGE114-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage114_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE114"
        and plan.get("phase") == "IDS-STAGE114-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE114-REVIEW"
        and "IDS-STAGE115-P1-GATE" in str(plan.get("stop_condition", ""))
    )
    stage115_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE115"
        and plan.get("phase") == "IDS-STAGE115-P1"
        and plan.get("task") == "IDS-V0_1-STAGE115-P1"
        and "IDS-STAGE115-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    stage115_phase2_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE115"
        and plan.get("phase") == "IDS-STAGE115-P2"
        and plan.get("task") == "IDS-V0_1-STAGE115-P2"
        and "IDS-STAGE115-P3-GATE" in str(plan.get("stop_condition", ""))
    )
    stage115_phase3_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE115"
        and plan.get("phase") == "IDS-STAGE115-P3"
        and plan.get("task") == "IDS-V0_1-STAGE115-P3"
        and "IDS-STAGE115-P4-GATE" in str(plan.get("stop_condition", ""))
    )
    stage115_phase4_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE115"
        and plan.get("phase") == "IDS-STAGE115-P4"
        and plan.get("task") == "IDS-V0_1-STAGE115-P4"
        and "IDS-STAGE115-REVIEW-GATE" in str(plan.get("stop_condition", ""))
    )
    stage115_review_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE115"
        and plan.get("phase") == "IDS-STAGE115-REVIEW"
        and plan.get("task") == "IDS-V0_1-STAGE115-REVIEW"
        and "UNASSIGNED_SUCCESSOR_GATE" in str(plan.get("stop_condition", ""))
    )
    stage116_phase1_plan = (
        isinstance(plan, dict)
        and plan.get("stage") == "IDS-STAGE116"
        and plan.get("phase") == "IDS-STAGE116-P1"
        and plan.get("task") == "IDS-V0_1-STAGE116-P1"
        and "IDS-STAGE116-P2-GATE" in str(plan.get("stop_condition", ""))
    )
    ...
    return {
        "status_projection": (
            stage097_phase1_status
            or stage097_phase2_status
            or stage097_phase3_status
            or stage097_phase4_status
            or stage097_review_status
            or stage098_phase1_status
            or stage098_phase2_status
            or stage098_phase3_status
            or stage098_phase4_status
            or stage098_review_status
            or stage099_phase1_status
            or stage099_phase2_status
            or stage099_phase3_status
            or stage099_phase4_status
            or stage099_review_status
            or stage100_phase1_status
            or stage100_phase2_status
            or stage100_phase3_status
            or stage100_phase4_status
            or stage100_review_status
            or stage101_phase1_status
            or stage101_phase2_status
            or stage101_phase3_status
            or stage101_phase4_status
            or stage101_review_status
            or stage102_phase1_status
            or stage102_phase2_status
            or stage102_phase3_status
            or stage102_phase4_status
            or stage102_review_status
            or stage103_phase1_status
            or stage103_phase2_status
            or stage103_phase3_status
            or stage103_phase4_status
            or stage103_review_status
            or stage104_phase1_status
            or stage104_phase2_status
            or stage104_phase3_status
            or stage104_phase4_status
            or stage104_review_status
            or stage105_phase1_status
            or stage105_phase2_status
            or stage105_phase3_status
            or stage105_phase4_status
            or stage105_review_status
            or stage106_phase1_status
            or stage106_phase2_status
            or stage106_phase3_status
            or stage106_phase4_status
            or stage106_review_status
            or stage107_phase1_status
            or stage107_phase2_status
            or stage107_phase3_status
            or stage107_phase4_status
            or stage107_review_status
            or stage108_phase1_status
            or stage108_phase2_status
            or stage108_phase3_status
            or stage108_phase4_status
            or stage108_review_status
            or stage109_phase1_status
            or stage109_phase2_status
            or stage109_phase3_status
            or stage109_phase4_status
            or stage109_review_status
            or stage110_phase1_status
            or stage110_phase2_status
            or stage110_phase3_status
            or stage110_phase4_status
            or stage110_review_status
            or stage111_phase1_status
            or stage111_phase2_status
            or stage111_phase3_status
            or stage111_phase4_status
            or stage111_review_status
            or stage112_phase1_status
            or stage112_phase2_status
            or stage112_phase3_status
            or stage112_phase4_status
            or stage112_review_status
            or stage113_phase1_status
            or stage113_phase2_status
            or stage113_phase3_status
            or stage113_phase4_status
            or stage113_review_status
            or stage114_phase1_status
            or stage114_phase2_status
            or stage114_phase3_status
            or stage114_phase4_status
            or stage114_review_status
            or stage115_phase1_status
            or stage115_phase2_status
            or stage115_phase3_status
            or stage115_phase4_status
            or stage115_review_status
            or stage116_phase1_status
            or successor_status
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE095"
                and status.get("phase") == "IDS-STAGE095-P1"
                and status.get("task") == "IDS-V0_1-STAGE095-P1"
                and status.get("next_gate") == "IDS-STAGE095-P2-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE095"
                and status.get("phase") == "IDS-STAGE095-P2"
                and status.get("task") == "IDS-V0_1-STAGE095-P2"
                and status.get("next_gate") == "IDS-STAGE095-P3-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE095"
                and status.get("phase") == "IDS-STAGE095-P3"
                and status.get("task") == "IDS-V0_1-STAGE095-P3"
                and status.get("next_gate") == "IDS-STAGE095-P4-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE095"
                and status.get("phase") == "IDS-STAGE095-P4"
                and status.get("task") == "IDS-V0_1-STAGE095-P4"
                and status.get("next_gate") == "IDS-STAGE095-REVIEW-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE095"
                and status.get("phase") == "IDS-STAGE095-REVIEW"
                and status.get("task") == "IDS-V0_1-STAGE095-REVIEW"
                and status.get("next_gate") == "IDS-STAGE096-P1-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE096"
                and status.get("phase") == "IDS-STAGE096-P1"
                and status.get("task") == "IDS-V0_1-STAGE096-P1"
                and status.get("next_gate") == "IDS-STAGE096-P2-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE096"
                and status.get("phase") == "IDS-STAGE096-REVIEW"
                and status.get("task") == "IDS-V0_1-STAGE096-REVIEW"
                and status.get("next_gate") == "IDS-STAGE097-P1-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE096"
                and status.get("phase") == "IDS-STAGE096-P4"
                and status.get("task") == "IDS-V0_1-STAGE096-P4"
                and status.get("next_gate") == "IDS-STAGE096-REVIEW-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE096"
                and status.get("phase") == "IDS-STAGE096-P2"
                and status.get("task") == "IDS-V0_1-STAGE096-P2"
                and status.get("next_gate") == "IDS-STAGE096-P3-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE096"
                and status.get("phase") == "IDS-STAGE096-P3"
                and status.get("task") == "IDS-V0_1-STAGE096-P3"
                and status.get("next_gate") == "IDS-STAGE096-P4-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            ...
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE094"
                and status.get("phase") == "IDS-STAGE094-REVIEW"
                and status.get("task") == "IDS-V0_1-STAGE094-REVIEW"
                and status.get("next_gate") == "IDS-STAGE095-P1-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE094"
                and status.get("phase") == "IDS-STAGE094-P3"
                and status.get("task") == "IDS-V0_1-STAGE094-P3"
                and status.get("next_gate") == "IDS-STAGE094-P4-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE094"
                and status.get("phase") == "IDS-STAGE094-P4"
                and status.get("task") == "IDS-V0_1-STAGE094-P4"
                and status.get("next_gate") == "IDS-STAGE094-REVIEW-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
                isinstance(status, dict)
                and status.get("stage") == "IDS-STAGE094"
                and status.get("phase") == "IDS-STAGE094-P2"
                and status.get("task") == "IDS-V0_1-STAGE094-P2"
                and status.get("next_gate") == "IDS-STAGE094-P3-GATE"
                and status.get("runtime_enabled") is False
                and status.get("push_allowed") is False
            )
            or (
        ...
        "plan_projection": (
            stage097_phase1_plan
            or stage097_phase2_plan
            or stage097_phase3_plan
            or stage097_phase4_plan
            or stage097_review_plan
            or stage098_phase1_plan
            or stage098_phase2_plan
            or stage098_phase3_plan
            or stage098_phase4_plan
            or stage098_review_plan
            or stage099_phase1_plan
            or stage099_phase2_plan
            or stage099_phase3_plan
            or stage099_phase4_plan
            or stage099_review_plan
            or stage100_phase1_plan
            or stage100_phase2_plan
            or stage100_phase3_plan
            or stage100_phase4_plan
            or stage100_review_plan
            or stage101_phase1_plan
            or stage101_phase2_plan
            or stage101_phase3_plan
            or stage101_phase4_plan
            or stage101_review_plan
            or stage102_phase1_plan
            or stage102_phase2_plan
            or stage102_phase3_plan
            or stage102_phase4_plan
            or stage102_review_plan
            or stage103_phase1_plan
            or stage103_phase2_plan
            or stage103_phase3_plan
           or stage103_phase4_plan
           or stage103_review_plan
            or stage104_phase1_plan
            or stage104_phase2_plan
           or stage104_phase3_plan
           or stage104_phase4_plan
           or stage104_review_plan
           or stage105_phase1_plan
           or stage105_phase2_plan
           or stage105_phase3_plan
           or stage105_phase4_plan
           or stage105_review_plan
           or stage106_phase1_plan
           or stage106_phase2_plan
           or stage106_phase3_plan
           or stage106_phase4_plan
           or stage106_review_plan
           or stage107_phase1_plan
           or stage107_phase2_plan
           or stage107_phase3_plan
           or stage107_phase4_plan
           or stage107_review_plan
           or stage108_phase1_plan
           or stage108_phase2_plan
           or stage108_phase3_plan
           or stage108_phase4_plan
           or stage108_review_plan
           or stage109_phase1_plan
           or stage109_phase2_plan
           or stage109_phase3_plan
           or stage109_phase4_plan
           or stage109_review_plan
           or stage110_phase1_plan
           or stage110_phase2_plan
           or stage110_phase3_plan
           or stage110_phase4_plan
           or stage110_review_plan
           or stage111_phase1_plan
           or stage111_phase2_plan
           or stage111_phase3_plan
           or stage111_phase4_plan
           or stage111_review_plan
           or stage112_phase1_plan
           or stage112_phase2_plan
           or stage112_phase3_plan
           or stage112_phase4_plan
           or stage112_review_plan
           or stage113_phase1_plan
           or stage113_phase2_plan
           or stage113_phase3_plan
           or stage113_phase4_plan
           or stage113_review_plan
           or stage114_phase1_plan
           or stage114_phase2_plan
           or stage114_phase3_plan
           or stage114_phase4_plan
           or stage114_review_plan
           or stage115_phase1_plan
           or stage115_phase2_plan
           or stage115_phase3_plan
           or stage115_phase4_plan
           or stage115_review_plan
           or stage116_phase1_plan
           or successor_plan
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE095"
                and plan.get("phase") == "IDS-STAGE095-P1"
                and plan.get("task") == "IDS-V0_1-STAGE095-P1"
                and "IDS-STAGE095-P2-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE095"
                and plan.get("phase") == "IDS-STAGE095-P2"
                and plan.get("task") == "IDS-V0_1-STAGE095-P2"
                and "IDS-STAGE095-P3-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE095"
                and plan.get("phase") == "IDS-STAGE095-P3"
                and plan.get("task") == "IDS-V0_1-STAGE095-P3"
                and "IDS-STAGE095-P4-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE095"
                and plan.get("phase") == "IDS-STAGE095-P4"
                and plan.get("task") == "IDS-V0_1-STAGE095-P4"
                and "IDS-STAGE095-REVIEW-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE095"
                and plan.get("phase") == "IDS-STAGE095-REVIEW"
                and plan.get("task") == "IDS-V0_1-STAGE095-REVIEW"
                and "IDS-STAGE096-P1-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE096"
                and plan.get("phase") == "IDS-STAGE096-P1"
                and plan.get("task") == "IDS-V0_1-STAGE096-P1"
                and "IDS-STAGE096-P2-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE096"
                and plan.get("phase") == "IDS-STAGE096-P2"
                and plan.get("task") == "IDS-V0_1-STAGE096-P2"
                and "IDS-STAGE096-P3-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE096"
                and plan.get("phase") == "IDS-STAGE096-P3"
                and plan.get("task") == "IDS-V0_1-STAGE096-P3"
                and "IDS-STAGE096-P4-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE096"
                and plan.get("phase") == "IDS-STAGE096-P4"
                and plan.get("task") == "IDS-V0_1-STAGE096-P4"
                and "IDS-STAGE096-REVIEW-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE096"
                and plan.get("phase") == "IDS-STAGE096-REVIEW"
                and plan.get("task") == "IDS-V0_1-STAGE096-REVIEW"
                and "IDS-STAGE097-P1-GATE"
                in str(plan.get("stop_condition", ""))
            )
           ...
           or (
            ...
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE094"
                and plan.get("phase") == "IDS-STAGE094-P2"
                and plan.get("task") == "IDS-V0_1-STAGE094-P2"
                and "IDS-STAGE094-P3-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE094"
                and plan.get("phase") == "IDS-STAGE094-P3"
                and plan.get("task") == "IDS-V0_1-STAGE094-P3"
                and "IDS-STAGE094-P4-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE094"
                and plan.get("phase") == "IDS-STAGE094-P4"
                and plan.get("task") == "IDS-V0_1-STAGE094-P4"
                and "IDS-STAGE094-REVIEW-GATE"
                in str(plan.get("stop_condition", ""))
            )
            or (
                isinstance(plan, dict)
                and plan.get("stage") == "IDS-STAGE094"
                and plan.get("phase") == "IDS-STAGE094-REVIEW"
                and plan.get("task") == "IDS-V0_1-STAGE094-REVIEW"
                and "IDS-STAGE095-P1-GATE"
                in str(plan.get("stop_condition", ""))
            )
        ),
        "roadmap_projection": (
