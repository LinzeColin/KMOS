...
def _ready_records(report: dict[str, Any]) -> list[dict[str, Any]]:
    return [record for record in report["records"] if record["state"] == "FINGERPRINT_READY"]
...
def _same_name_different_hash(left_uri: str, right_uri: str, first_seen_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "state": "FINGERPRINT_HASH_CONFLICT" if conflict else report["overall_state"],
        "valid": conflict,
...
def _same_hash_different_path(left_uri: str, right_uri: str, first_seen_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "state": "FINGERPRINT_DUPLICATE_CONTENT" if duplicate else report["overall_state"],
        "valid": duplicate,
...
def build_stage013_scenario_report(
    *,
    same_file_uri: str,
    ...
    """Validate Phase 3 fingerprint scenarios without persistence side effects."""
    ...
    same_file = evaluate_file_fingerprints(
    ...
    same_file_scenario = {
        ...
        "valid": (
            same_file["overall_state"] == "FINGERPRINT_READY"
    ...
    hash_stable = {
        ...
        "state": "FINGERPRINT_READY" if before_sha256 == after_sha256 else "FINGERPRINT_UNKNOWN",
    ...
    return {
        "schema_version": "ids.stage013.file_fingerprint_scenarios.v1",
        "stage": "STAGE-013",
        "phase": "Phase 3",
        "acceptance_id": "ACC-STAGE-013",
        "entrance": OPERATIONS_ENTRANCE,
