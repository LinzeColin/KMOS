# STAGE-074 · 本地 Embedding 兜底合同

- 本地编号：D12-S006
- 当前版本：v0.1
- 能力域：D12 · Embedding 与外部 API 策略
- 入口：IDS 系统运营入口
- Acceptance ID：ACC-STAGE-074
- 建议并行度：是
...
预留本地 embedding 路线，避免商业化时完全依赖外部 API。
