# STAGE-064 · Chunk 身份与版本

- 本地编号：D11-S002
- 当前版本：v0.1
- 能力域：D11 · Chunking 与语义资产
- 入口：IDS 系统运营入口
- Acceptance ID：ACC-STAGE-064
- 建议并行度：否
...
每个 chunk 有 chunk_id、chunk_hash、document_id、page、section、version。
