# STAGE-058 · 表格 Schema 推断

- 本地编号：D10-S002
- 当前版本：v0.1
- 能力域：D10 · 结构化数据与表格事实库
- 入口：IDS 系统运营入口
- Acceptance ID：ACC-STAGE-058
- 建议并行度：是
- 并行说明：可与 STAGE-051~056 的 OCR 样例和回归语料准备并行；至少在 STAGE-083 前完成。
- 预计实际执行开发时间：12-24 小时

## 追求目标（Pursuing Goal）

识别列名、字段类型、日期、单位、材料、设备、工序、质量结果。
