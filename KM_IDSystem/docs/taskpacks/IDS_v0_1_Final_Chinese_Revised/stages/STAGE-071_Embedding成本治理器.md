# STAGE-071 · Embedding 成本治理器

- 本地编号：D12-S003
- 当前版本：v0.1
- 能力域：D12 · Embedding 与外部 API 策略
- 入口：IDS 系统运营入口
- Acceptance ID：ACC-STAGE-071
- 建议并行度：是
...
控制外部 API 预算，支持本批次成本估算、月预算、单任务上限。
