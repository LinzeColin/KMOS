# STAGE-089 · 证据账本 Schema

- 本地编号：D15-S001
- 当前版本：v0.1
- 能力域：D15 · 证据账本与可信等级
- 入口：IDS 系统运营入口
- Acceptance ID：ACC-STAGE-089
- 建议并行度：否
...
建立 evidence_id、document_id、chunk_id、fact_id、report_id、source_type、evidence_grade。
...
### Phase 3：证据账本 Schema 专项验证与异常场景
1. 验证无内部证据、低 OCR、旧版本、冲突资料、撤回资料和恶意资料场景。
2. 验证撤回证据会影响报告状态。
3. 验证高可信结论不能使用低等级证据伪装。

### Phase 4：证据账本 Schema 交付证据、回滚与中文反馈
