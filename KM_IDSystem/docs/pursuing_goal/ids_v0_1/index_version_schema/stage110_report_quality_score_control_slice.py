...
SCHEMA_VERSION = "ids.stage110.report_quality_score.phase2.v1"
RECORD_KIND = "CONTROL_ONLY_IN_MEMORY_REPORT_QUALITY_SCORE"
CONTROL_ADAPTER_VERSION = "stage110-p2-control-slice-v1"
PASS_RESULT = "PASS_IN_MEMORY_REPORT_QUALITY_SCORE_CONTROL_SLICE_RUNTIME_DISABLED"
REJECTED_RESULT = "REJECTED_IN_MEMORY_REPORT_QUALITY_SCORE_CONTROL_SLICE"
CONTROL_PREFIX = ":control:stage110-p2:"
CONTROL_FIELDS = ("report_quality_score_control_requests",)
...
CONTROL_SCENARIO_CONFIGURATION = {
    ...
    "report_quality_score_and_export_reference_only": {"binding_mode": "evidence_id"},
}
...
REPORT_QUALITY_SCORE_AND_LIFECYCLE_INPUT_FIELDS = (
    "control_scenario",
    "binding_mode",
    "report_id_ref",
    "report_snapshot_ref",
...
REPORT_QUALITY_SCORE_AND_LIFECYCLE_STATES = {
    ...
    "automatic_quality_metric_calculation_allowed": False,
    "automatic_quality_formula_definition_allowed": False,
    ...
    "actual_internal_evidence_coverage_rate_calculated": False,
    "actual_citation_completeness_rate_calculated": False,
    "actual_external_augmentation_ratio_calculated": False,
    "actual_evidence_gap_count_calculated": False,
    "actual_quality_metric_definition_recorded": False,
    "actual_quality_formula_defined": False,
    "actual_quality_weight_defined": False,
    "actual_quality_threshold_defined": False,
    "actual_report_quality_scored": False,
    "actual_quality_score_explanation_persisted": False,
...
PROJECTION_FIELDS = tuple(
    (
        prefix,
        tuple(
            (*input_fields, *state_values.keys())
...
def _zero_actual_counts() -> dict[str, int]:
    return {
        ...
        "actual_internal_evidence_coverage_calculation_count": 0,
        "actual_citation_completeness_calculation_count": 0,
        "actual_external_augmentation_ratio_calculation_count": 0,
        "actual_evidence_gap_count_calculation_count": 0,
        "actual_quality_formula_weight_threshold_definition_count": 0,
...
def _project(request: Mapping[str, Optional[str]]) -> dict[str, dict[str, Any]]:
    ...
    for prefix, input_fields, state_values in PROJECTION_SPECS:
        record: dict[str, Any] = {
            field: request[field] for field in input_fields
        }
...
def execute_report_quality_score_control_slice(
