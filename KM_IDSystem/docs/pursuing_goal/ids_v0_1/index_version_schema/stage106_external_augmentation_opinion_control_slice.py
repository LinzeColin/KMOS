"""Stage106 P2：外部增强意见章节的纯内存受控最小切片。

本模块只机械投影冻结的控制引用。它不读取业务资料、外部参考、模型推理、
证据账本、报告或 PDF，不生成、展示、导出、保存或撤回报告，也不连接数据库、
外部服务、模型或 OVH。
"""
...
SCHEMA_VERSION = "ids.stage106.external_augmentation_opinion.phase2.v1"
RECORD_KIND = "CONTROL_ONLY_IN_MEMORY_EXTERNAL_AUGMENTATION_OPINION"
CONTROL_ADAPTER_VERSION = "stage106-p2-control-slice-v1"
PASS_RESULT = "PASS_IN_MEMORY_EXTERNAL_AUGMENTATION_OPINION_CONTROL_SLICE_RUNTIME_DISABLED"
REJECTED_RESULT = "REJECTED_IN_MEMORY_EXTERNAL_AUGMENTATION_OPINION_CONTROL_SLICE"
CONTROL_PREFIX = ":control:stage106-p2:"
CONTROL_FIELDS = ("external_augmentation_opinion_control_requests",)

CONTROL_SCENARIOS = (
    "evidence_id_report_binding_reference_only",
    "evidence_gap_report_binding_reference_only",
    "external_augmentation_opinion_chapter_reference_only",
    "human_confirmation_reference_only",
    "report_export_audit_reference_only",
)
CONTROL_SCENARIO_CONFIGURATION = {
    "evidence_id_report_binding_reference_only": {"binding_mode": "evidence_id"},
    "evidence_gap_report_binding_reference_only": {"binding_mode": "evidence_gap"},
    "external_augmentation_opinion_chapter_reference_only": {
        "binding_mode": "evidence_id"
    },
    "human_confirmation_reference_only": {"binding_mode": "evidence_id"},
    "report_export_audit_reference_only": {"binding_mode": "evidence_id"},
}
...
PHASE2_ADDED_CONTROL_REFERENCE_FIELDS = ("evidence_grade_ref",)
INPUT_FIELDS = (
    "control_scenario",
    "binding_mode",
    *PHASE1_CONTROL_REFERENCE_FIELDS,
...
REPORT_EVIDENCE_BINDING_AND_CHAPTER_FIELDS = (
    "control_scenario",
    "report_id_ref",
    "external_augmentation_opinion_section_ref",
    "external_augmentation_item_ref",
    ...
    "external_augmentation_opinion_chapter_output_state",
    "pdf_citation_source_and_page_display_state",
    "actual_report_evidence_binding_performed",
    "actual_chapter_output_written",
)
...
REPORT_LIFECYCLE_AND_EXPORT_AUDIT_FIELDS = (
    "control_scenario",
    "report_id_ref",
    "report_status_impact_ref",
    "report_quality_score_ref",
...
PROJECTION_FIELDS = (
    (
        "report_evidence_binding_and_chapter",
        REPORT_EVIDENCE_BINDING_AND_CHAPTER_FIELDS,
    ),
    ("generation_snapshot", GENERATION_SNAPSHOT_FIELDS),
    ("report_lifecycle_and_export_audit", REPORT_LIFECYCLE_AND_EXPORT_AUDIT_FIELDS),
    (
...
RUNTIME_CLOSED_FIELDS = (
    ...
    "external_augmentation_opinion_generated",
...
def _control_request(scenario: str) -> dict[str, Optional[str]]:
    ...
    return {
        ...
        "external_augmentation_item_ref": _control_ref(
            "external-augmentation-item", scenario
        ),
        "external_augmentation_display_label_ref": _control_ref(
            "external-augmentation-display-label", scenario
        ),
        ...
        "underlying_source_type_ref": _control_ref("underlying-source-type", scenario),
...
def _project(request: Mapping[str, Optional[str]]) -> dict[str, dict[str, Any]]:
    ...
    return {
        "report_evidence_binding_and_chapter": {
            ...
            "external_augmentation_item_ref": request[
                "external_augmentation_item_ref"
            ],
            "external_augmentation_display_label_ref": request[
                "external_augmentation_display_label_ref"
            ],
            ...
            "actual_chapter_output_written": False,
        },
        "generation_snapshot": {
            "control_scenario": scenario,
            "report_id_ref": request["report_id_ref"],
        ...
        "report_lifecycle_and_export_audit": {
            "control_scenario": scenario,
            "report_id_ref": request["report_id_ref"],
        ...
        "external_augmentation_and_whitebox_gate": {
            ...
            "underlying_source_type_ref": request["underlying_source_type_ref"],
            ...
            "actual_external_augmentation_opinion_generated": False,
...
def execute_external_augmentation_opinion_control_slice(
