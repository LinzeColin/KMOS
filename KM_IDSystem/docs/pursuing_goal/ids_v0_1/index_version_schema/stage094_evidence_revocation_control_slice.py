"""Stage094 P2 的纯内存证据撤回控制切片。

模块只投影自身定义的固定、非业务、reference-only 控制输入。它承接
Stage094 P1 静态合同和 Stage093 已复审可信等级控制工件，不读取真实资料、
检索结果或证据账本，不连接数据库，不计算真实风险，不执行撤回、降级、恢复、
...
SCHEMA_VERSION = "ids.stage094.evidence_revocation.phase2.v1"
RECORD_KIND = "CONTROL_ONLY_IN_MEMORY_EVIDENCE_REVOCATION"
CONTROL_ADAPTER_VERSION = "ids.evidence_revocation.control_adapter.v0_1.stage094.p2"
CONTROL_PREFIX = ":control:stage094-p2:"
CONTROL_FIELDS = ("evidence_revocation_control_requests",)
PHASE1_EVIDENCE_REVOCATION_CONTRACT_CONTROL_REF = (
    ":control:stage094-p2:stage094-phase1-evidence-revocation-contract:reference-only"
)
STAGE093_REVIEW_CONTROL_REF = (
    ":control:stage094-p2:stage093-reviewed-evidence-grade:reference-only"
)

EVIDENCE_REVOCATION_SCHEMA_BINDING_FIELDS = (
    "phase1_evidence_revocation_contract_ref",
    "stage093_review_control_ref",
    "evidence_ledger_ref",
    "evidence_id_ref",
    "evidence_gap_ref",
...
EVIDENCE_REVOCATION_RELATION_FIELDS = (
    "evidence_ledger_ref",
    "evidence_id_ref",
    "evidence_gap_ref",
    "critical_conclusion_ref",
...
FUTURE_INTEGRATION_FIELDS = (
    "phase1_evidence_revocation_route_ref",
    "stage093_evidence_grade_route_ref",
...
CONTROL_SCENARIO_CONFIGURATION = {
    "internal_material_insufficient_revocation_pending_whitebox_review_reference_only": {
        ...
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_PENDING_EVIDENCE_GAP_WHITEBOX_REVIEW",
    ...
    "low_trust_evidence_degraded_reference_only": {
        ...
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_LOW_TRUST_NOT_EXECUTED",
    ...
    "conflict_evidence_degraded_reference_only": {
        ...
        "include_evidence_id_ref": True,
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_CONFLICT_NOT_EXECUTED",
    ...
    "expired_evidence_degraded_reference_only": {
        ...
        "include_evidence_id_ref": True,
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_EXPIRED_NOT_EXECUTED",
    ...
    "revoked_evidence_revocation_and_degradation_reference_only": {
        ...
        "include_evidence_id_ref": True,
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_REVOKED_NOT_EXECUTED",
        "degradation_state": "CONTROL_DEGRADED_REVOKED_NOT_ACCEPTED",
        "report_status_impact_state": "CONTROL_REPORT_STATUS_REFERENCE_REVOKED_PENDING_WHITEBOX_REVIEW",
    },
    "suspected_poisoning_evidence_quarantined_reference_only": {
        "evidence_grade_label": "E",
        "include_evidence_id_ref": True,
        "revocation_state": "CONTROL_REVOCATION_REFERENCE_SUSPECTED_POISONING_NOT_EXECUTED",
...
def _control_request(scenario: str) -> dict[str, Optional[str]]:
    ...
    return {
        ...
        "degradation_status_ref": _control_ref("degradation-status", scenario),
        "recovery_reference_ref": _control_ref("recovery-reference", scenario),
...
def _rejected_result() -> dict[str, Any]:
    ...
    return {
        ...
        "execution_state": "REJECTED_IN_MEMORY_EVIDENCE_REVOCATION_CONTROL_SLICE",
...
def _project(
    ...
    configuration = CONTROL_SCENARIO_CONFIGURATION[scenario]
    evidence_revocation_schema_binding = {
        "phase1_evidence_revocation_contract_ref": (
            PHASE1_EVIDENCE_REVOCATION_CONTRACT_CONTROL_REF
        ),
        "stage093_review_control_ref": STAGE093_REVIEW_CONTROL_REF,
        ...
        "degradation_status_ref": request["degradation_status_ref"],
        "schema_binding_state": "CONTROL_PHASE1_EVIDENCE_REVOCATION_SHAPE_BOUND",
    }
    evidence_revocation_relation = {
        field: request[field] for field in EVIDENCE_REVOCATION_RELATION_FIELDS
    }
    ...
    evidence_grade_binding = {
        field: request[field] for field in EVIDENCE_GRADE_BINDING_FIELDS
    }
    revocation_control = {
        "revocation_status_ref": request["revocation_status_ref"],
        "revocation_reason_ref": request["revocation_reason_ref"],
        "evidence_ledger_ref": request["evidence_ledger_ref"],
        "evidence_id_ref": request["evidence_id_ref"],
        "evidence_gap_ref": request["evidence_gap_ref"],
        ...
        "degradation_status_ref": request["degradation_status_ref"],
        "recovery_reference_ref": request["recovery_reference_ref"],
        "report_status_impact_ref": request["report_status_impact_ref"],
        "revocation_state": configuration["revocation_state"],
    }
    poisoning_defense = {
        ...
        "defense_state": "CONTROL_POISONING_DEFENSE_ROUTE_DECLARED_NOT_EXECUTED",
    }
    ...
    future_integration = {
        ...
        "stage093_evidence_grade_route_ref": STAGE093_REVIEW_CONTROL_REF,
        ...
        "recovery_route_ref": _control_ref("recovery-route", scenario),
    ...
    return {
        "evidence_revocation_schema_binding": evidence_revocation_schema_binding,
        "evidence_revocation_relation": evidence_revocation_relation,
        "retrieval_evidence_capture_binding": retrieval_evidence_capture_binding,
        "risk_reference_binding": risk_reference_binding,
        "evidence_grade_binding": evidence_grade_binding,
...
def execute_evidence_revocation_control_slice(
    ...
    return {
        ...
        "control_adapter_version": CONTROL_ADAPTER_VERSION,
        "input_accepted": True,
        "execution_state": "CONTROL_EVIDENCE_REVOCATION_PROJECTIONS_DECLARED",
        "failure_state": None,
