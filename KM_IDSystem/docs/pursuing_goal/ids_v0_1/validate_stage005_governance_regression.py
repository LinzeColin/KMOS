            ...
            or (
                ...
                and (
                    ...
                    or (
                        ...
                        and roadmap.get("next_gate_id")
                        == "IDS-STAGE049-P1-GATE"
                    )
                    or (
                        roadmap.get("current_stage_id") == "IDS-STAGE049"
                        and roadmap.get("current_phase_id")
                        == "IDS-STAGE049-P1"
                        and roadmap.get("current_task_id")
                        == "IDS-V0_1-STAGE049-P1"
                        and roadmap.get("next_gate_id")
                        == "IDS-STAGE049-P2-GATE"
                    )
                    or (
                        roadmap.get("current_stage_id") == "IDS-STAGE049"
                        and roadmap.get("current_phase_id")
                        == "IDS-STAGE049-P2"
                        and roadmap.get("current_task_id")
                        == "IDS-V0_1-STAGE049-P2"
                        and roadmap.get("next_gate_id")
                        == "IDS-STAGE049-P3-GATE"
                    )
                    or (
                        roadmap.get("current_stage_id") == "IDS-STAGE049"
                        and roadmap.get("current_phase_id")
                        == "IDS-STAGE049-P3"
                        and roadmap.get("current_task_id")
                        == "IDS-V0_1-STAGE049-P3"
                        and roadmap.get("next_gate_id")
                        == "IDS-STAGE049-P4-GATE"
                    )
                    or (
                        roadmap.get("current_stage_id") == "IDS-STAGE049"
                        and roadmap.get("current_phase_id")
...
REQUIRED_EVENT_IDS = (
    ...
    "EVT-IDS-V0_1-STAGE048-REVIEW-20260812-001",
    "EVT-IDS-V0_1-STAGE049-P1-20260812-001",
    "EVT-IDS-V0_1-STAGE049-P2-20260812-001",
    "EVT-IDS-V0_1-STAGE049-P3-20260812-001",
...
ALLOWED_CHANGED_PREFIXES = (
    ...
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_",
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE050_",
    ...
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/",
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/prompt_injection_marker/",
    ...
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_",
    "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage050_",
    "KM_IDSystem/scripts/check_backpressure_policy.py",
    "KM_IDSystem/scripts/check_backpressure_runtime.py",
    "KM_IDSystem/scripts/check_backpressure_scenarios.py",
    "KM_IDSystem/scripts/check_original_raw_identity.py",
...
def evaluate_required_event_semantics(events: list[dict]) -> list[str]:
    ...
    event_specs = {
        ...
        "EVT-IDS-V0_1-STAGE048-REVIEW-20260812-001": {
            ...
            "acceptance_id": "ACC-STAGE-048",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE048_STAGE_REVIEW.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/parser_fallback/stage048_fallback_stage_review.py",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage048_parser_fallback_stage_review.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage048-review-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "STAGE048_REVIEWED_LOCAL_FALLBACK_RUNTIME_DISABLED",
                "review_valid": "true",
        ...
        "EVT-IDS-V0_1-STAGE049-P1-20260812-001": {
            "event_type": "phase_completed",
            "allow_stage_gate": True,
            "task_id": "IDS-V0_1-STAGE049-P1",
            "acceptance_id": "ACC-STAGE-049",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE1_DIFFERENTIAL_PARSER_EVALUATION_SCOPE_BOUNDARY.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_contract.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage049-p1-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "PHASE1_DIFFERENTIAL_PARSER_EVALUATION_BOUNDARY_RUNTIME_DISABLED",
                "second_authoritative_source_created": "false",
                "reference_only_candidate_field_count": "7",
                "parse_product_core_field_count": "6",
                "minimum_candidate_parser_versions": "2",
                ...
                "github_upload_allowed": "false",
                "push_allowed": "false",
                "next_gate": "IDS-STAGE049-P2-GATE",
            },
        },
        "EVT-IDS-V0_1-STAGE049-P2-20260812-001": {
            "event_type": "phase_completed",
            "allow_stage_gate": True,
            "task_id": "IDS-V0_1-STAGE049-P2",
            "acceptance_id": "ACC-STAGE-049",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE2_DIFFERENTIAL_PARSER_EVALUATION_SLICE.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_slice_contract.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_slice.py",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_slice.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage049-p2-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "PHASE2_CONTROLLED_DIFFERENTIAL_ELIGIBILITY_RUNTIME_DISABLED",
                "second_authoritative_source_created": "false",
                "control_candidate_count": "2",
                "differential_parser_eligibility_slice_implemented": "true",
                "control_parser_versions_recorded": "true",
                "control_parser_confidences_recorded": "true",
                "in_memory_controlled_differential_eligibility_evaluated": "true",
                ...
                "github_upload_allowed": "false",
                "push_allowed": "false",
                "next_gate": "IDS-STAGE049-P3-GATE",
            },
        },
        "EVT-IDS-V0_1-STAGE049-P3-20260812-001": {
            "event_type": "phase_completed",
            "allow_stage_gate": True,
            "task_id": "IDS-V0_1-STAGE049-P3",
            "acceptance_id": "ACC-STAGE-049",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE3_DIFFERENTIAL_PARSER_EVALUATION_SCENARIOS.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_scenarios_contract.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_scenarios.py",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_scenarios.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage049-p3-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "PHASE3_CONTROLLED_DIFFERENTIAL_SCENARIOS_RUNTIME_DISABLED",
                "second_authoritative_source_created": "false",
                "controlled_differential_scenarios_evaluated": "true",
                "format_labelled_control_scenario_count": "11",
                "explicit_disposition_count": "11",
                "silent_drop_count": "0",
                "low_quality_review_scenario_count": "3",
                "ineligible_or_invalid_scenario_count": "2",
                "instruction_disposition_invariance": "true",
                "fallback_owner_preserved": "STAGE048",
                "actual_parse_product_comparison_performed": "false",
                "parser_execution_performed": "false",
                "fallback_execution_performed": "false",
                "quality_gate_evaluation_performed": "false",
        ...
        "EVT-IDS-V0_1-STAGE049-P4-20260812-001": {
            "event_type": "stage_closeout",
            "allow_stage_gate": True,
            "task_id": "IDS-V0_1-STAGE049-P4",
            "acceptance_id": "ACC-STAGE-049",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE4_CLOSEOUT.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_delivery_contract.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_delivery.py",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_delivery.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage049-p4-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "PHASE4_DIFFERENTIAL_EVALUATION_CLOSEOUT_EVIDENCE_ENABLED_REAL_PARSER_QUALITY_AND_PERSISTENCE_DISABLED",
                "second_authoritative_source_created": "false",
                "phase3_controlled_scenarios_replayed": "true",
                "candidate_parse_product_samples_derived": "true",
                "candidate_parse_product_sample_count": "20",
                "fallback_log_sample_count": "11",
                "explicit_disposition_count": "11",
                "silent_drop_count": "0",
                "failure_classification_count": "5",
                "control_format_label_count": "8",
                "runtime_supported_format_count": "0",
                "actual_parse_product_comparison_performed": "false",
                "parser_execution_performed": "false",
                "fallback_execution_performed": "false",
        ...
        "EVT-IDS-V0_1-STAGE049-REVIEW-20260812-001": {
            ...
            "acceptance_id": "ACC-STAGE-049",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_STAGE_REVIEW.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_stage_review.py",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_stage_review.py",
                "KM_IDSystem/machine/runs/2026-08-12-stage049-review-local.json",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/BATCH041_050_UPLOAD_LOCK.yaml",
                "KM_IDSystem/docs/governance/roadmap.yaml",
                "KM_IDSystem/docs/governance/events.jsonl",
            },
            ...
            "required_note_assignments": {
                "contract_state": "STAGE049_REVIEWED_LOCAL_DIFFERENTIAL_EVALUATION_RUNTIME_DISABLED",
                "review_valid": "true",
                "review_finding_count": "0",
                "phase1_contract_valid": "true",
                "phase2_slice_valid": "true",
                ...
                "schema_sample_and_log_boundary_preserved": "true",
                "rollback_chain_preserved": "true",
                "source_file_open_performed": "false",
                "parser_execution_performed": "false",
                "actual_parse_product_comparison_performed": "false",
        ...
        "EVT-IDS-V0_1-STAGE050-P1-20260812-001": {
            "event_type": "phase_completed",
            "allow_stage_gate": True,
            "task_id": "IDS-V0_1-STAGE050-P1",
            "acceptance_id": "ACC-STAGE-050",
            "required_changed_files": {
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE050_PHASE1_PROMPT_INJECTION_MARKER_SCOPE_BOUNDARY.md",
                "KM_IDSystem/docs/pursuing_goal/ids_v0_1/prompt_injection_marker/stage050_prompt_injection_marker_contract.json",
            ...
            "required_note_assignments": {
                "contract_state": "PHASE1_PROMPT_INJECTION_MARKER_BOUNDARY_RUNTIME_DISABLED",
                "second_authoritative_source_created": "false",
                "reference_only_candidate_field_count": "7",
                "parse_product_core_field_count": "6",
...
def evaluate_current_state_consistency(
    ...
    stage048_review_current = (
        current_stage_id == "IDS-STAGE048"
        and roadmap_phase == "IDS-STAGE048-REVIEW"
    )
    stage049_phase1_current = (
        current_stage_id == "IDS-STAGE049"
        and roadmap_phase == "IDS-STAGE049-P1"
    )
    stage049_phase2_current = (
        current_stage_id == "IDS-STAGE049"
        and roadmap_phase == "IDS-STAGE049-P2"
    )
    stage049_phase3_current = (
        current_stage_id == "IDS-STAGE049"
        and roadmap_phase == "IDS-STAGE049-P3"
    )
    stage049_phase4_current = (
        current_stage_id == "IDS-STAGE049"
        and roadmap_phase == "IDS-STAGE049-P4"
    )
    stage049_review_current = (
        current_stage_id == "IDS-STAGE049"
        and roadmap_phase == "IDS-STAGE049-REVIEW"
    )
    stage050_phase1_current = (
    ...
    governed_current = (
        ...
        or stage048_review_current
        or stage049_phase1_current
        or stage049_phase2_current
        or stage049_phase3_current
    ...
    expected_completed_phase = {
        ...
        "IDS-STAGE048-REVIEW": "Phase 4",
        "IDS-STAGE049-P1": "Phase 1",
        "IDS-STAGE049-P2": "Phase 2",
        "IDS-STAGE049-P3": "Phase 3",
    ...
    expected_stage048_review_result_block = (
        "聚焦 Stage048 复审直接单元用例通过 10/10；P1-P4 前序兼容用例通过 38/38；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    expected_stage049_phase1_result_block = (
        "聚焦 P1 直接单元用例通过 7/7；Stage048 P1-P4 及复审前序兼容用例通过 48/48；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    expected_stage049_phase2_result_block = (
        "聚焦 P2 直接单元用例通过 8/8；Stage049 P1 前序兼容用例通过 7/7；Stage048 P1-P4 及复审前序兼容用例通过 48/48；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    expected_stage049_phase3_result_block = (
        "聚焦 P3 直接单元用例通过 9/9；Stage049 P1/P2 前序兼容用例通过 15/15；Stage048 P1-P4 及复审前序兼容用例通过 48/48；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    expected_stage049_phase4_result_block = (
        "聚焦 P4 直接单元用例通过 13/13；Stage049 P1-P3 前序兼容用例通过 24/24；Stage048 P1-P4 及复审前序兼容用例通过 48/48；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    expected_stage049_review_result_block = (
        "聚焦 Stage049 复审直接单元用例通过 10/10；P1-P4 前序兼容用例通过 37/37；Stage048 P1-P4 及复审兼容用例通过 48/48；治理回归报告 valid=true；中文视图已重渲染 7 个文件。"
    )
    ...
    expected_governed_result_block = {
        ...
        "IDS-STAGE048-REVIEW": expected_stage048_review_result_block,
        "IDS-STAGE049-P1": expected_stage049_phase1_result_block,
        "IDS-STAGE049-P2": expected_stage049_phase2_result_block,
        "IDS-STAGE049-P3": expected_stage049_phase3_result_block,
    ...
    required_stage048_review_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE048_STAGE_REVIEW.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/parser_fallback/stage048_fallback_stage_review.py",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage048_parser_fallback_stage_review.py",
        "KM_IDSystem/machine/runs/2026-08-12-stage048-review-local.json",
    }
    required_stage049_phase1_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE1_DIFFERENTIAL_PARSER_EVALUATION_SCOPE_BOUNDARY.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_contract.json",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation.py",
        "KM_IDSystem/machine/runs/2026-08-12-stage049-p1-local.json",
    }
    required_stage049_phase2_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE2_DIFFERENTIAL_PARSER_EVALUATION_SLICE.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_slice_contract.json",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_slice.py",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_slice.py",
    ...
    required_stage049_phase3_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE3_DIFFERENTIAL_PARSER_EVALUATION_SCENARIOS.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_scenarios_contract.json",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_scenarios.py",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_scenarios.py",
    ...
    required_stage049_phase4_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_PHASE4_CLOSEOUT.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_delivery_contract.json",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_delivery.py",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_delivery.py",
    ...
    required_stage049_review_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE049_STAGE_REVIEW.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/differential_parser_evaluation/stage049_differential_parser_evaluation_stage_review.py",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage049_differential_parser_evaluation_stage_review.py",
        "KM_IDSystem/machine/runs/2026-08-12-stage049-review-local.json",
    }
    required_stage050_phase1_evidence = {
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/STAGE050_PHASE1_PROMPT_INJECTION_MARKER_SCOPE_BOUNDARY.md",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/prompt_injection_marker/stage050_prompt_injection_marker_contract.json",
        "KM_IDSystem/docs/pursuing_goal/ids_v0_1/tests/test_stage050_prompt_injection_marker.py",
        "KM_IDSystem/machine/runs/2026-08-12-stage050-p1-local.json",
    ...
    required_governed_evidence = {
        ...
        "IDS-STAGE048-REVIEW": required_stage048_review_evidence,
        "IDS-STAGE049-P1": required_stage049_phase1_evidence,
        "IDS-STAGE049-P2": required_stage049_phase2_evidence,
        "IDS-STAGE049-P3": required_stage049_phase3_evidence,
...
def evaluate_phase_state(
    ...
    batch031_040_main_handoff_to_stage041 = (
        ...
        and (
            ...
            or (
                'current_stage_id: "IDS-STAGE048"' in roadmap_text
                and 'current_phase_id: "IDS-STAGE048-REVIEW"'
                in roadmap_text
                and 'current_task_id: "IDS-V0_1-STAGE048-REVIEW"'
                in roadmap_text
                and 'next_gate_id: "IDS-STAGE049-P1-GATE"'
                in roadmap_text
            )
        )
    )
    ...
    stage048_reviewed_local = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage048_completed_reviewed_local"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE048-REVIEW"' in batch_text
        and 'next_gate: "IDS-STAGE049-P1-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE049-P1"' in batch_text
        and 'acceptance_status: "completed_reviewed_local"' in batch_text
        and 'review_status: "passed"' in batch_text
        and 'contract_state: "STAGE048_REVIEWED_LOCAL_FALLBACK_RUNTIME_DISABLED"'
        in batch_text
        and 'parser_fallback_stage_review_schema: "ids.stage048.parser_fallback.stage_review.v1"'
        in batch_text
        and 'stage_review_valid: true' in batch_text
        and 'stage_review_finding_count: 0' in batch_text
        and 'stage_review_phase1_to_phase4_contracts_valid: true' in batch_text
        and 'stage_review_rollback_chain_preserved: true' in batch_text
        and 'stage_review_instruction_text_invariance_preserved: true' in batch_text
        and 'stage_review_runtime_and_external_actions_disabled: true' in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'parser_execution_performed: false' in batch_text
        and 'fallback_execution_performed: false' in batch_text
        ...
        and 'stage049_started: false' in batch_text
        and 'stage049_entry_authorized: false' in batch_text
        and 'github_upload_allowed: false' in batch_text
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE048"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE048-REVIEW"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE048-REVIEW"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE049-P1-GATE"' in roadmap_text
    )
    stage049_phase1_active = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage049_phase1_completed"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P1"' in batch_text
        and 'next_gate: "IDS-STAGE049-P2-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE049-P2"' in batch_text
        and 'acceptance_status: "phase1_differential_parser_evaluation_boundary_complete"'
        in batch_text
        and 'contract_state: "PHASE1_DIFFERENTIAL_PARSER_EVALUATION_BOUNDARY_RUNTIME_DISABLED"'
        in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'reference_only_candidate_field_count: 7' in batch_text
        and 'parse_product_core_field_count: 6' in batch_text
        and 'minimum_candidate_parser_versions: 2' in batch_text
        and 'comparison_execution_allowed: false' in batch_text
        ...
        and 'github_upload_allowed: false' in batch_text
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE049"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE049-P1"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P1"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE049-P2-GATE"' in roadmap_text
    )
    stage049_phase2_active = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage049_phase2_completed"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P2"' in batch_text
        and 'next_gate: "IDS-STAGE049-P3-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE049-P3"' in batch_text
        and 'acceptance_status: "phase2_controlled_differential_eligibility_slice_complete"'
        in batch_text
        and 'contract_state: "PHASE2_CONTROLLED_DIFFERENTIAL_ELIGIBILITY_RUNTIME_DISABLED"'
        in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'reference_only_candidate_field_count: 7' in batch_text
        and 'parse_product_core_field_count: 6' in batch_text
        and 'control_candidate_count: 2' in batch_text
        and 'differential_parser_eligibility_slice_implemented: true' in batch_text
        and 'in_memory_controlled_differential_eligibility_evaluated: true' in batch_text
        and 'actual_parse_product_comparison_performed: false' in batch_text
        and 'parser_execution_performed: false' in batch_text
        and 'fallback_execution_performed: false' in batch_text
        and 'quality_gate_evaluation_performed: false' in batch_text
        and 'evidence_promotion_performed: false' in batch_text
        ...
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE049"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE049-P2"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P2"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE049-P3-GATE"' in roadmap_text
    )
    stage049_phase3_active = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage049_phase3_completed"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P3"' in batch_text
        and 'next_gate: "IDS-STAGE049-P4-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE049-P4"' in batch_text
        and 'acceptance_status: "phase3_controlled_differential_scenarios_complete"'
        in batch_text
        and 'contract_state: "PHASE3_CONTROLLED_DIFFERENTIAL_SCENARIOS_RUNTIME_DISABLED"'
        in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'control_candidate_count: 2' in batch_text
        and 'controlled_differential_scenarios_evaluated: true' in batch_text
        and 'phase2_eligibility_slice_reexecuted: true' in batch_text
        and 'format_labelled_control_scenario_count: 11' in batch_text
        and 'taskpack_format_family_count: 8' in batch_text
        and 'image_variant_count: 3' in batch_text
        and 'explicit_disposition_count: 11' in batch_text
        and 'silent_drop_count: 0' in batch_text
        and 'low_quality_review_scenario_count: 3' in batch_text
        and 'ineligible_or_invalid_scenario_count: 2' in batch_text
        and 'instruction_disposition_invariance: true' in batch_text
        and 'fallback_owner_preserved: "STAGE048"' in batch_text
        and 'actual_parse_product_comparison_performed: false' in batch_text
        and 'parser_execution_performed: false' in batch_text
        and 'fallback_execution_performed: false' in batch_text
        and 'quality_gate_evaluation_performed: false' in batch_text
        ...
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE049"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE049-P3"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P3"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE049-P4-GATE"' in roadmap_text
    )
    stage049_phase4_active = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage049_phase4_completed_review_pending"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P4"' in batch_text
        and 'next_gate: "IDS-STAGE049-REVIEW-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE049-REVIEW"' in batch_text
        and 'acceptance_status: "phase4_differential_evaluation_closeout_complete"'
        in batch_text
        and 'contract_state: "PHASE4_DIFFERENTIAL_EVALUATION_CLOSEOUT_EVIDENCE_ENABLED_REAL_PARSER_QUALITY_AND_PERSISTENCE_DISABLED"'
        in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'controlled_differential_scenarios_evaluated: true' in batch_text
        and 'phase4_delivery_valid: true' in batch_text
        and 'candidate_parse_product_samples_derived: true' in batch_text
        and 'candidate_parse_product_sample_count: 20' in batch_text
        and 'fallback_log_sample_count: 11' in batch_text
        and 'failure_classification_count: 5' in batch_text
        and 'control_format_label_count: 8' in batch_text
        and 'runtime_supported_format_count: 0' in batch_text
        and 'explicit_disposition_count: 11' in batch_text
        and 'silent_drop_count: 0' in batch_text
        and 'actual_parse_product_comparison_performed: false' in batch_text
        ...
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE049"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE049-P4"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE049-P4"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE049-REVIEW-GATE"' in roadmap_text
    )
    stage049_reviewed_local = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage049_completed_reviewed_local"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE049-REVIEW"' in batch_text
        and 'next_gate: "IDS-STAGE050-P1-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE050-P1"' in batch_text
        and 'acceptance_status: "completed_reviewed_local"' in batch_text
        and 'review_status: "passed"' in batch_text
        and 'contract_state: "STAGE049_REVIEWED_LOCAL_DIFFERENTIAL_EVALUATION_RUNTIME_DISABLED"'
        in batch_text
        and 'differential_parser_evaluation_stage_review_schema: "ids.stage049.differential_parser_evaluation.stage_review.v1"'
        in batch_text
        and 'stage_review_valid: true' in batch_text
        and 'stage_review_finding_count: 0' in batch_text
        and 'stage_review_phase1_contract_valid: true' in batch_text
        and 'stage_review_phase2_slice_valid: true' in batch_text
        and 'stage_review_phase3_scenarios_valid: true' in batch_text
        and 'stage_review_phase4_delivery_valid: true' in batch_text
        and 'stage_review_phase1_to_phase4_contracts_valid: true' in batch_text
        and 'stage_review_single_authority_boundary_preserved: true' in batch_text
        and 'stage_review_schema_sample_and_log_boundary_preserved: true'
        in batch_text
        and 'stage_review_rollback_chain_preserved: true' in batch_text
        and 'stage_review_runtime_and_external_actions_disabled: true'
        in batch_text
        and 'second_authoritative_source_created: false' in batch_text
        and 'source_body_or_path_allowed: false' in batch_text
        and 'parser_execution_performed: false' in batch_text
        ...
        and 'ovh_deployment_performed: false' in batch_text
        and 'whole_stage_review_performed: true' in batch_text
        and 'stage050_started: false' in batch_text
        and 'stage050_entry_authorized: false' in batch_text
        and 'github_upload_allowed: false' in batch_text
        and 'push_allowed: false' in batch_text
        and 'current_stage_id: "IDS-STAGE049"' in roadmap_text
        and 'current_phase_id: "IDS-STAGE049-REVIEW"' in roadmap_text
        and 'current_task_id: "IDS-V0_1-STAGE049-REVIEW"' in roadmap_text
        and 'next_gate_id: "IDS-STAGE050-P1-GATE"' in roadmap_text
    )
    stage050_phase1_active = (
        'batch_id: "IDS-V0_1-BATCH-041-050"' in batch_text
        and 'status: "stage050_phase1_completed"' in batch_text
        and 'current_task_id: "IDS-V0_1-STAGE050-P1"' in batch_text
        and 'next_gate: "IDS-STAGE050-P2-GATE"' in batch_text
        and 'next_allowed_task_id: "IDS-V0_1-STAGE050-P2"' in batch_text
        and 'acceptance_status: "phase1_prompt_injection_marker_boundary_complete"'
        in batch_text
        and 'contract_state: "PHASE1_PROMPT_INJECTION_MARKER_BOUNDARY_RUNTIME_DISABLED"'
        in batch_text
        ...
        and 'reference_only_candidate_field_count: 7' in batch_text
        and 'parse_product_core_field_count: 6' in batch_text
        and 'evidence_text_label: "UNTRUSTED_EVIDENCE_TEXT"' in batch_text
        and 'evidence_text_interpretation: "EVIDENCE_ONLY"' in batch_text
        and 'prompt_injection_marker_application_performed: false' in batch_text
        and 'parser_execution_performed: false' in batch_text
        and 'fallback_execution_performed: false' in batch_text
        and 'differential_evaluation_performed: false' in batch_text
        and 'quality_gate_evaluation_performed: false' in batch_text
        ...
        and 'current_phase_id: "IDS-STAGE050-P1"' in roadmap_text
    ...
    later_stage_state = (
        ...
        or stage048_reviewed_local
        or stage049_phase1_active
        or stage049_phase2_active
        or stage049_phase3_active
