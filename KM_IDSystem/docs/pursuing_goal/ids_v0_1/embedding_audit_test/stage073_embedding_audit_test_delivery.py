"""Stage073 P4 Embedding 审计测试的 metadata-only 交付证据。
...
RECORD_KIND = "EMBEDDING_AUDIT_TEST_DELIVERY_EVIDENCE_REPORT"
PASS_RESULT = "PASS_PHASE4_EMBEDDING_AUDIT_TEST_DELIVERY_RUNTIME_DISABLED"
FAIL_RESULT = "FAIL_EMBEDDING_AUDIT_TEST_DELIVERY_EVIDENCE"
ENTRY_GATE = "IDS-STAGE073-P4-GATE"
NEXT_GATE = "IDS-STAGE073-REVIEW-GATE"
P3_PASS_RESULT = "PASS_PHASE3_EMBEDDING_AUDIT_TEST_CONTROLLED_SCENARIOS_RUNTIME_DISABLED"
P2_EXECUTION_STATE = "COMPLETED_IN_MEMORY_EMBEDDING_AUDIT_TEST_CONTROL_SLICE"

POLICY_SAMPLE_KIND = "DELIVERY_METADATA_ONLY_EMBEDDING_AUDIT_TEST_POLICY_SAMPLE_NOT_REAL_PAYLOAD"
AUDIT_LOG_SAMPLE_KIND = "CONTROL_EMBEDDING_AUDIT_TEST_AUDIT_LOG_SAMPLE_NOT_PERSISTED"
COST_ESTIMATE_SAMPLE_KIND = "CONTROL_ZERO_COST_ESTIMATE_NOT_PROVIDER_PRICE"
FAILURE_HANDLING_KIND = "CONTROL_EMBEDDING_AUDIT_TEST_FAILURE_HANDLING_NOT_REAL_FAILURE_RECORD"
NON_EXTERNALIZED_DATA_KIND = "CONTROL_NON_EXTERNALIZED_EMBEDDING_AUDIT_TEST_REFERENCE_NOT_REAL_DATA"
QUERY_INSTRUCTION_KIND = "EMBEDDING_AUDIT_TEST_EXTERNALIZATION_RECORD_QUERY_INSTRUCTIONS_IN_MEMORY_CONTROL_ONLY"
ROLLBACK_INSTRUCTION_KIND = "EMBEDDING_AUDIT_TEST_POLICY_ROLLBACK_INSTRUCTIONS_CONTROL_REPLAY_ONLY"

EXPECTED_SCENARIO_IDS = (
    "denied-policy-blocks-embedding-audit-test-egress-control",
...
def build_embedding_audit_test_phase4_delivery_report(
    ...
    report: dict[str, Any] = {
        ...
        "embedding_audit_test_policy_samples": policy_samples,
...
def _default_phase3_report_provider() -> Mapping[str, Any]:
    module = _load_module("stage073_embedding_audit_test_scenarios.py")
    return module.build_embedding_audit_test_phase3_report()


def _default_phase2_report_provider() -> Mapping[str, Any]:
    module = _load_module("stage073_embedding_audit_test_slice.py")
    return module.execute_embedding_audit_test_control_slice(module.build_control_input())
...
def _phase3_report_is_valid(report: Mapping[str, Any]) -> bool:
    ...
    return (
        ...
        and report.get("embedding_audit_test_scenario_can_replace_source_document") is False
        and report.get("embedding_audit_test_scenario_can_become_business_fact_authority") is False
        and report.get("stage073_started") is True
        ...
        and all(
            ...
            and all(
                ...
                and ":control:stage073-p2:" in item[field]
                for field in refs
            )
...
def _audit_log_sample(
    ...
    return {
        ...
        "audit_reference_fields_are_control_only": all(
            ...
            and ":control:stage073-p2:" in projection[field]
            for field in (
                "external_api_audit_ref",
                "data_source_ref",
                "document_ref",
...
def _chinese_feedback() -> list[str]:
    return [
        ...
        "预算不足时外部 API 候选保持暂停；本步骤可回退到 Stage073 P3，不影响来源资料、OVH 或生产状态。",
    ]
