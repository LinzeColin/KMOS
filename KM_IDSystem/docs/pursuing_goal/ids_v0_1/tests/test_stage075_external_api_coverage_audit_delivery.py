    ...
    def test_machine_and_governance_projection_match_p4(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ('IDS-V0_1-STAGE076-P1', 'IDS-V0_1-STAGE076-P1', 'IDS-STAGE076-P2-GATE'), ('IDS-V0_1-STAGE076-P2', 'IDS-V0_1-STAGE076-P2', 'IDS-STAGE076-P3-GATE'),
            ),
        )
        self.assertIn(
            plan["task"],
            ("IDS-V0_1-STAGE075-P4", "IDS-V0_1-STAGE075-REVIEW", 'IDS-V0_1-STAGE076-P1', 'IDS-V0_1-STAGE076-P2'),
        )
        self.assertIn(
            acceptance["task"],
            ("IDS-V0_1-STAGE075-P4", "IDS-V0_1-STAGE075-REVIEW", 'IDS-V0_1-STAGE076-P1', 'IDS-V0_1-STAGE076-P2'),
        ...
        self.assertIn('current_phase_id: "IDS-STAGE075-P4"', roadmap)
        self.assertIn('current_task_id: "IDS-V0_1-STAGE075-P4"', roadmap)
        self.assertIn('next_gate_id: "IDS-STAGE075-REVIEW-GATE"', roadmap)
