    ...
    def test_machine_and_governance_projection_match_p4(self):
        ...
        self.assertIn(
            ...
            ("IDS-V0_1-STAGE075-P4", "IDS-V0_1-STAGE075-REVIEW", 'IDS-V0_1-STAGE076-P1', 'IDS-V0_1-STAGE076-P2', 'IDS-V0_1-STAGE076-P3', 'IDS-V0_1-STAGE076-P4', 'IDS-V0_1-STAGE076-REVIEW',
                'IDS-V0_1-STAGE077-P1', 'IDS-V0_1-STAGE077-P2', 'IDS-V0_1-STAGE077-P3', 'IDS-V0_1-STAGE077-P4', "IDS-V0_1-STAGE077-REVIEW", "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2"),
        )
        self.assertIn(
            acceptance["task"],
            ...
            'IDS-V0_1-STAGE077-P2', 'IDS-V0_1-STAGE077-P3', 'IDS-V0_1-STAGE077-P4', "IDS-V0_1-STAGE077-REVIEW", "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2"),
        )
        self.assertTrue(
            {
                "ACC-STAGE-075",
