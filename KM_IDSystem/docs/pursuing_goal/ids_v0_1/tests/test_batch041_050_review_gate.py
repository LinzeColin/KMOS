...
class Batch041050ReviewGateTests(unittest.TestCase):
    ...
    def test_document_and_governance_route_to_stage051_without_upload(self):
        ...
        self.assertTrue(
            (
                'current_phase_id: "IDS-V0_1-BATCH-051-060-REVIEW-GATE"'
                in roadmap
                and 'next_gate_id: "IDS-STAGE061-P1-GATE"' in roadmap
            )
            or (
            ...
            or (
                'current_phase_id: "IDS-STAGE054-P1"' in roadmap
                and 'next_gate_id: "IDS-STAGE054-P2-GATE"' in roadmap
            )
            or (
                'current_phase_id: "IDS-STAGE054-P2"' in roadmap
                and 'next_gate_id: "IDS-STAGE054-P3-GATE"' in roadmap
            )
            or (
                'current_phase_id: "IDS-STAGE062-REVIEW"' in roadmap
                and 'next_gate_id: "IDS-STAGE063-P1-GATE"' in roadmap
            )
        )
