...
class Stage038WorkerQueueRuntimePhase2Tests(unittest.TestCase):
    ...
    def test_phase2_docs_governance_and_event_advance_only_to_phase3(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE038-P2", stage["current_task_id"])
        ...
        self.assertEqual("IDS-V0_1-STAGE038-P3", batch["decision"]["next_allowed_task_id"])
