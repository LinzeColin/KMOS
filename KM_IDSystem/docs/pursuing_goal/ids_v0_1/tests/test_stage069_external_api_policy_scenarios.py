...
class Stage069ExternalApiPolicyPhase3Tests(unittest.TestCase):
    ...
    def test_current_governance_projects_phase3_without_upload_or_runtime(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE069-P3", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE069-P3", status["task"])
        self.assertEqual("IDS-STAGE069-P4-GATE", status["next_gate"])
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertEqual("IDS-STAGE069", plan["stage"])
        self.assertEqual("IDS-V0_1-STAGE069-P3", plan["phase"])
        self.assertEqual("IDS-V0_1-STAGE069-P3", plan["task"])
        self.assertIn("IDS-STAGE069-P4-GATE", plan["stop_condition"])
