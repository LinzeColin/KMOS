...
class Stage065EngineeringSemanticAssetClassificationPhase2Tests(unittest.TestCase):
    ...
    def test_current_governance_preserves_phase2_evidence(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE065-P2", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE065-P2", status["task"])
        self.assertEqual("IDS-STAGE065-P3-GATE", status["next_gate"])
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertEqual("IDS-STAGE065", plan["stage"])
        self.assertEqual("IDS-V0_1-STAGE065-P2", plan["phase"])
        self.assertEqual("IDS-V0_1-STAGE065-P2", plan["task"])
        self.assertIn("IDS-STAGE065-P3-GATE", plan["stop_condition"])
        ...
        self.assertIn('current_phase_id: "IDS-STAGE065-P2"', roadmap_text)
        self.assertIn('next_gate_id: "IDS-STAGE065-P3-GATE"', roadmap_text)
