...
("IDS-V0_1-STAGE071-P4", "IDS-V0_1-STAGE071-P4"),
                ...
                ("IDS-V0_1-STAGE072-P4", "IDS-V0_1-STAGE072-P4"), ("IDS-V0_1-STAGE072-REVIEW", "IDS-V0_1-STAGE072-REVIEW"), ("IDS-V0_1-STAGE073-P1", "IDS-V0_1-STAGE073-P1"),),
        ...
        self.assertTrue(
            ...
            or "IDS-STAGE072-P2-GATE" in plan["stop_condition"]
               ...
               or "IDS-STAGE073-P1-GATE" in plan["stop_condition"]) or "IDS-STAGE073-P2-GATE" in plan["stop_condition"]
        )
        self.assertTrue(
            {
                "ACC-STAGE067-P1-01",
