...
("IDS-STAGE071", "IDS-V0_1-STAGE071-P3", "IDS-V0_1-STAGE071-P3", "IDS-STAGE071-P4-GATE"),
        ...
        self.assertIn(plan["stage"], ("IDS-STAGE068", "IDS-STAGE069", "IDS-STAGE070", "IDS-STAGE071", "IDS-STAGE072", "IDS-STAGE073"))
        self.assertIn(
...
("IDS-V0_1-STAGE071-P4", "IDS-V0_1-STAGE071-P4"),
                ...
                ("IDS-V0_1-STAGE072-P4", "IDS-V0_1-STAGE072-P4"), ("IDS-V0_1-STAGE072-REVIEW", "IDS-V0_1-STAGE072-REVIEW"), ("IDS-V0_1-STAGE073-P1", "IDS-V0_1-STAGE073-P1"), ("IDS-V0_1-STAGE073-P2", "IDS-V0_1-STAGE073-P2"),),
        ...
        self.assertTrue(
            ...
            or "IDS-STAGE072-P2-GATE" in plan["stop_condition"]
               ...
               or "IDS-STAGE073-P1-GATE" in plan["stop_condition"]) or "IDS-STAGE073-P2-GATE" in plan["stop_condition"] or "IDS-STAGE073-P3-GATE" in plan["stop_condition"]
        )
        self.assertTrue(
            {
                "ACC-STAGE067-P1-01",
