...
class Stage064ChunkIdentityVersionPhase3Tests(unittest.TestCase):
    ...
    def test_current_governance_tracks_phase3_evidence(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE064-P3", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE064-P3", status["task"])
        self.assertEqual("IDS-STAGE064-P4-GATE", status["next_gate"])
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertEqual("IDS-STAGE064", plan["stage"])
        self.assertEqual("IDS-V0_1-STAGE064-P3", plan["phase"])
        self.assertEqual("IDS-V0_1-STAGE064-P3", plan["task"])
        self.assertIn("IDS-STAGE064-P4-GATE", plan["stop_condition"])
        ...
        self.assertIn('current_phase_id: "IDS-STAGE064-P3"', roadmap_text)
        self.assertIn('next_gate_id: "IDS-STAGE064-P4-GATE"', roadmap_text)
