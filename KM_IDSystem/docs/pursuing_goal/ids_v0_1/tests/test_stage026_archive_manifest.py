...
class Stage026ArchiveManifestPhase1Tests(unittest.TestCase):
    ...
    def test_roadmap_and_events_track_stage026_phase1_local_gate(self):
        ...
        self.assertTrue(any(term in roadmap_text for term in allowed_current_terms[10:20]), allowed_current_terms[10:20])
        self.assertTrue(any(term in roadmap_text for term in allowed_current_terms[20:]), allowed_current_terms[20:])
    ...
    def test_roadmap_and_events_track_stage026_phase4_closeout_without_batch_upload(self):
        ...
        self.assertTrue(any(term in roadmap_text for term in allowed_current_terms[3:10]), allowed_current_terms[3:10])
        self.assertTrue(any(term in roadmap_text for term in allowed_current_terms[10:17]), allowed_current_terms[10:17])
