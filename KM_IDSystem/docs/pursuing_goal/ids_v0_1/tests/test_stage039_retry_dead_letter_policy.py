...
class Stage039RetryDeadLetterPolicyTests(unittest.TestCase):
    ...
    def test_governance_routes_only_to_separate_phase2(self):
        ...
        self.assertIn('status: "stage039_phase1_completed"', batch)
        self.assertIn('current_task_id: "IDS-V0_1-STAGE039-P1"', batch)
        self.assertIn('next_gate: "IDS-STAGE039-P2-GATE"', batch)
        self.assertIn('current_stage_id: "IDS-STAGE039"', roadmap)
        self.assertIn('current_phase_id: "IDS-STAGE039-P1"', roadmap)
        self.assertIn('current_task_id: "IDS-V0_1-STAGE039-P1"', roadmap)
        self.assertIn('next_gate_id: "IDS-STAGE039-P2-GATE"', roadmap)
