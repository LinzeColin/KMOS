    ...
    def test_phase3_history_remains_valid_when_phase4_is_current(self):
        ...
        self.assertIn(
            ...
            (
                ...
                {"stage": "IDS-STAGE082", "phase": "IDS-STAGE082-P2", "task": "IDS-V0_1-STAGE082-P2", "next_gate": "IDS-STAGE082-P3-GATE"}, {"stage": "IDS-STAGE082", "phase": "IDS-STAGE082-P3", "task": "IDS-V0_1-STAGE082-P3", "next_gate": "IDS-STAGE082-P4-GATE"}),
        )
