    ...
    def test_phase3_history_remains_valid_when_phase4_is_current(self):
        ...
        self.assertIn(
            ...
            , {'stage': 'IDS-STAGE084', 'phase': 'IDS-STAGE084-P3', 'task': 'IDS-V0_1-STAGE084-P3', 'next_gate': 'IDS-STAGE084-P4-GATE'}, {'stage': 'IDS-STAGE084', 'phase': 'IDS-STAGE084-P4', 'task': 'IDS-V0_1-STAGE084-P4', 'next_gate': 'IDS-STAGE084-REVIEW-GATE'},
                ...
                {'stage': 'IDS-STAGE086', 'phase': 'IDS-STAGE086-P1', 'task': 'IDS-V0_1-STAGE086-P1', 'next_gate': 'IDS-STAGE086-P2-GATE'}, {'stage': 'IDS-STAGE086', 'phase': 'IDS-STAGE086-P2', 'task': 'IDS-V0_1-STAGE086-P2', 'next_gate': 'IDS-STAGE086-P3-GATE'}, {'stage': 'IDS-STAGE086', 'phase': 'IDS-STAGE086-P3', 'task': 'IDS-V0_1-STAGE086-P3', 'next_gate': 'IDS-STAGE086-P4-GATE'}, {'stage': 'IDS-STAGE086', 'phase': 'IDS-STAGE086-P4', 'task': 'IDS-V0_1-STAGE086-P4', 'next_gate': 'IDS-STAGE086-REVIEW-GATE'}, {'stage': 'IDS-STAGE086', 'phase': 'IDS-STAGE086-REVIEW', 'task': 'IDS-V0_1-STAGE086-REVIEW', 'next_gate': 'IDS-STAGE087-P1-GATE'},
             {"stage": "IDS-STAGE087", "phase": "IDS-STAGE087-P1", "task": "IDS-V0_1-STAGE087-P1", "next_gate": "IDS-STAGE087-P2-GATE"}),
        )
        ...
        if status["phase"] == "IDS-STAGE084-P4":
            expected_phrases = (
        ...
        if status["phase"] == "IDS-STAGE085-P3":
            expected_phrases = (
        ...
        if status["phase"] == "IDS-STAGE086-P1":
            expected_phrases = (
