...
class Stage060TableRagSummaryContractPhase1Tests(unittest.TestCase):
    ...
    def test_governance_run_and_event_record_only_local_phase1_evidence(self):
        ...
        self.assertIn(
            status["phase"],
            ("IDS-V0_1-STAGE060-P1", "IDS-V0_1-STAGE060-P2", "IDS-V0_1-STAGE060-P3", "IDS-V0_1-STAGE060-P4", "IDS-V0_1-STAGE060-REVIEW", "IDS-V0_1-STAGE066-P1", "IDS-V0_1-STAGE066-P2", "IDS-V0_1-STAGE066-P3", "IDS-V0_1-STAGE066-P4", "IDS-STAGE066-REVIEW", "IDS-V0_1-STAGE067-P1", "IDS-V0_1-STAGE067-P2", "IDS-V0_1-STAGE067-P3", "IDS-V0_1-STAGE067-P4", "IDS-V0_1-STAGE067-REVIEW", "IDS-V0_1-STAGE068-P1"),
        )
        self.assertIn(
            status["task"],
            ("IDS-V0_1-STAGE060-P1", "IDS-V0_1-STAGE060-P2", "IDS-V0_1-STAGE060-P3", "IDS-V0_1-STAGE060-P4", "IDS-V0_1-STAGE060-REVIEW", "IDS-V0_1-STAGE066-P1", "IDS-V0_1-STAGE066-P2", "IDS-V0_1-STAGE066-P3", "IDS-V0_1-STAGE066-P4", "IDS-V0_1-STAGE066-REVIEW", "IDS-V0_1-STAGE067-P1", "IDS-V0_1-STAGE067-P2", "IDS-V0_1-STAGE067-P3", "IDS-V0_1-STAGE067-P4", "IDS-V0_1-STAGE067-REVIEW", "IDS-V0_1-STAGE068-P1"),
        )
        self.assertIn(
            status["next_gate"],
            ("IDS-STAGE060-P2-GATE", "IDS-STAGE060-P3-GATE", "IDS-STAGE060-P4-GATE", "IDS-STAGE060-REVIEW-GATE", "IDS-V0_1-BATCH-051-060-REVIEW-GATE", "IDS-STAGE066-P2-GATE", "IDS-STAGE066-P3-GATE", "IDS-STAGE066-P4-GATE", "IDS-STAGE066-REVIEW-GATE", "IDS-STAGE067-P1-GATE", "IDS-STAGE067-P2-GATE", "IDS-STAGE067-P3-GATE", "IDS-STAGE067-P4-GATE", "IDS-STAGE067-REVIEW-GATE", "IDS-STAGE068-P1-GATE", "IDS-STAGE068-P2-GATE"),
        )
