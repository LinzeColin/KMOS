...
class Stage060TableRagSummaryContractPhase1Tests(unittest.TestCase):
    ...
    def test_governance_run_and_event_record_only_local_phase1_evidence(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE060-P1", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE060-P1", status["task"])
        self.assertEqual("IDS-STAGE060-P2-GATE", status["next_gate"])
