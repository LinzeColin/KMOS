...
class Stage097AnswerContractPhase4DeliveryTests(unittest.TestCase):
    ...
    def test_current_governance_receipt_and_review_boundary_are_exact(self) -> None:
        ...
        if current == phase4_current:
            ...
            self.assertEqual("IDS-V0_1-STAGE099-P1", plan["task"])
            self.assertEqual(
            ...
            self.assertEqual("IDS-V0_1-STAGE099-P2", plan["task"])
            self.assertEqual(
            ...
            self.assertEqual("IDS-V0_1-STAGE099-P3", plan["task"])
            self.assertEqual(
        ...
        if current == stage098_phase1_current:
            ...
            self.assertIn('current_phase_id: "IDS-STAGE099-P1"', roadmap_text)
            self.assertIn('next_gate_id: "IDS-STAGE099-P2-GATE"', roadmap_text)
        elif current == stage099_phase2_current:
            self.assertIn("stage098_phase1_state:", roadmap_text)
            self.assertIn("stage098_phase2_state:", roadmap_text)
            self.assertIn("stage098_phase3_state:", roadmap_text)
            ...
            self.assertIn('current_phase_id: "IDS-STAGE099-P2"', roadmap_text)
            self.assertIn('next_gate_id: "IDS-STAGE099-P3-GATE"', roadmap_text)
        elif current == stage099_phase3_current:
            self.assertIn("stage098_phase1_state:", roadmap_text)
            self.assertIn("stage098_phase2_state:", roadmap_text)
            self.assertIn("stage098_phase3_state:", roadmap_text)
            ...
            self.assertIn('current_phase_id: "IDS-STAGE099-P3"', roadmap_text)
            self.assertIn('next_gate_id: "IDS-STAGE099-P4-GATE"', roadmap_text)
