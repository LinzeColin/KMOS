...
REVIEW_DOCUMENT = BASE / "STAGE077_STAGE_REVIEW.md"
MODULE = BASE / "index_version_schema" / "stage077_background_index_build_stage_review.py"
P1_CONTRACT = BASE / "index_version_schema" / "stage077_background_index_build_contract.json"
P2_CONTRACT = (
    BASE / "index_version_schema" / "stage077_background_index_build_slice_contract.json"
)
P3_CONTRACT = (
    BASE / "index_version_schema" / "stage077_background_index_build_scenarios_contract.json"
)
P4_CONTRACT = (
    BASE / "index_version_schema" / "stage077_background_index_build_delivery_contract.json"
)
P2_MODULE = BASE / "index_version_schema" / "stage077_background_index_build_slice.py"
P3_MODULE = BASE / "index_version_schema" / "stage077_background_index_build_scenarios.py"
P4_MODULE = BASE / "index_version_schema" / "stage077_background_index_build_delivery.py"
ROADMAP = ROOT / "docs" / "governance" / "roadmap.yaml"
EVENTS = ROOT / "docs" / "governance" / "events.jsonl"
STATUS = ROOT / "machine" / "facts" / "status.json"
PLAN = ROOT / "machine" / "facts" / "plan.json"
ACCEPTANCE = ROOT / "machine" / "facts" / "acceptance.json"
REVIEW_RUN = ROOT / "machine" / "runs" / "2026-08-21-stage077-review-local.json"
P4_RUN = ROOT / "machine" / "runs" / "2026-08-21-stage077-p4-local.json"


class Stage077ReviewTests(unittest.TestCase):
    def _module(self):
        spec = importlib.util.spec_from_file_location("stage077_review_test", MODULE)
    ...
    def test_phase_contracts_and_control_reports_pass(self):
        report = self._module().build_background_index_build_stage077_review_report()
        self.assertTrue(report["review_valid"])
        self.assertEqual({"P1": True, "P2": True, "P3": True, "P4": True}, report["phase_results"])
        self.assertEqual("PASS_REVIEWED_BACKGROUND_INDEX_BUILD_RUNTIME_DISABLED", report["result"])
        self.assertEqual("IDS-STAGE078-P1-GATE", report["next_gate"])
    ...
    def test_next_stage_stays_closed_except_for_gate(self):
        ...
        self.assertTrue(report["review_invariants"]["stage078_gate_only_opens_after_review"])
        self.assertFalse(report["stage078_started"])
    ...
    def test_invalid_phase4_contract_fails_closed(self):
        ...
        self.assertEqual("IDS-STAGE077-REVIEW-GATE", report["next_gate"])
    ...
    def test_governance_projection_records_stage_review_when_current(self):
        ...
        if current == (
            ...
            self.assertEqual("整阶段已复审", acceptance_by_id["ACC-STAGE-077"])
            self.assertEqual("已通过", acceptance_by_id["ACC-STAGE077-REVIEW-01"])
            self.assertEqual("已通过", acceptance_by_id["ACC-STAGE077-REVIEW-02"])
            self.assertEqual("已通过", acceptance_by_id["ACC-STAGE077-REVIEW-03"])
            self.assertEqual("已遵守", acceptance_by_id["ACC-STAGE077-REVIEW-04"])
            self.assertIn("EVT-IDS-V0_1-STAGE077-REVIEW-20260821-001", event_ids)
            self.assertEqual("IDS-STAGE078-P1-GATE", run["next_gate"])
            self.assertEqual(
                "PASS_REVIEWED_BACKGROUND_INDEX_BUILD_RUNTIME_DISABLED", run["result"]
            )
            self.assertTrue(all(value == 0 for value in run["runtime_counts"].values()))
            roadmap_text = ROADMAP.read_text(encoding="utf-8")
            self.assertIn('current_phase_id: "IDS-STAGE077-REVIEW"', roadmap_text)
            self.assertIn('next_gate_id: "IDS-STAGE078-P1-GATE"', roadmap_text)
        else:
            self.assertIn(
                current,
                (
                    ...
                    ), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P2', 'IDS-V0_1-STAGE078-P2', 'IDS-STAGE078-P3-GATE'), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P3', 'IDS-V0_1-STAGE078-P3', 'IDS-STAGE078-P4-GATE'), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P4', 'IDS-V0_1-STAGE078-P4', 'IDS-STAGE078-REVIEW-GATE'), ('IDS-STAGE078', 'IDS-STAGE078-REVIEW', 'IDS-V0_1-STAGE078-REVIEW', 'IDS-STAGE079-P1-GATE'),
                ...
                ("IDS-STAGE082", "IDS-STAGE082-REVIEW", "IDS-V0_1-STAGE082-REVIEW", "IDS-STAGE083-P1-GATE"), ("IDS-STAGE083", "IDS-STAGE083-P1", "IDS-V0_1-STAGE083-P1", "IDS-STAGE083-P2-GATE"), ("IDS-STAGE083", "IDS-STAGE083-P2", "IDS-V0_1-STAGE083-P2", "IDS-STAGE083-P3-GATE"), ("IDS-STAGE083", "IDS-STAGE083-P3", "IDS-V0_1-STAGE083-P3", "IDS-STAGE083-P4-GATE"), ("IDS-STAGE083", "IDS-STAGE083-P4", "IDS-V0_1-STAGE083-P4", "IDS-STAGE083-REVIEW-GATE"), ("IDS-STAGE083", "IDS-STAGE083-REVIEW", "IDS-V0_1-STAGE083-REVIEW", "IDS-STAGE084-P1-GATE"), ("IDS-STAGE084", "IDS-STAGE084-P1", "IDS-V0_1-STAGE084-P1", "IDS-STAGE084-P2-GATE"), ("IDS-STAGE084", "IDS-STAGE084-P2", "IDS-V0_1-STAGE084-P2", "IDS-STAGE084-P3-GATE")),
            )
            self.assertTrue(P4_RUN.is_file())
            self.assertIn(
                (plan["stage"], plan["phase"], plan["task"]),
                (
                    ("IDS-STAGE077", "IDS-V0_1-STAGE077-P4", "IDS-V0_1-STAGE077-P4"),
                    (
                        "IDS-STAGE077",
                        "IDS-V0_1-STAGE077-REVIEW",
                        "IDS-V0_1-STAGE077-REVIEW",
                    ),
                    ("IDS-STAGE078", "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P1"), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P2', 'IDS-V0_1-STAGE078-P2'), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P3', 'IDS-V0_1-STAGE078-P3'), ('IDS-STAGE078', 'IDS-V0_1-STAGE078-P4', 'IDS-V0_1-STAGE078-P4'),
                ('IDS-STAGE078', 'IDS-STAGE078-REVIEW', 'IDS-V0_1-STAGE078-REVIEW'),
                ...
                ("IDS-STAGE082", "IDS-STAGE082-REVIEW", "IDS-V0_1-STAGE082-REVIEW"), ("IDS-STAGE083", "IDS-STAGE083-P1", "IDS-V0_1-STAGE083-P1"), ("IDS-STAGE083", "IDS-STAGE083-P2", "IDS-V0_1-STAGE083-P2"), ("IDS-STAGE083", "IDS-STAGE083-P3", "IDS-V0_1-STAGE083-P3"), ("IDS-STAGE083", "IDS-STAGE083-P4", "IDS-V0_1-STAGE083-P4"), ("IDS-STAGE083", "IDS-STAGE083-REVIEW", "IDS-V0_1-STAGE083-REVIEW"), ("IDS-STAGE084", "IDS-STAGE084-P1", "IDS-V0_1-STAGE084-P1"), ("IDS-STAGE084", "IDS-STAGE084-P2", "IDS-V0_1-STAGE084-P2")),
            )
