    ...
    def test_chinese_feedback_and_p2_governance_evidence_survives_stage_review(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ('IDS-STAGE077', 'IDS-V0_1-STAGE077-P2', 'IDS-STAGE077-P3-GATE'),
            ),
        )
...
"IDS-STAGE073-P1-GATE" in plan["stop_condition"]
            ...
            or "IDS-STAGE075-P2-GATE" in plan["stop_condition"] or "IDS-STAGE075-P3-GATE" in plan["stop_condition"] or "IDS-STAGE075-P4-GATE" in plan["stop_condition"] or "IDS-STAGE075-REVIEW-GATE" in plan["stop_condition"] or "IDS-STAGE076-P1-GATE" in plan["stop_condition"] or "IDS-STAGE076-P2-GATE" in plan["stop_condition"] or "IDS-STAGE076-P3-GATE" in plan["stop_condition"] or "IDS-STAGE076-P4-GATE" in plan["stop_condition"] or "IDS-STAGE076-REVIEW-GATE" in plan["stop_condition"] or "IDS-STAGE077-P1-GATE" in plan["stop_condition"] or "IDS-STAGE077-P2-GATE" in plan["stop_condition"] or "IDS-STAGE077-P3-GATE" in plan["stop_condition"]
            )
        )
        self.assertTrue(
            {
