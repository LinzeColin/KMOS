    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ('IDS-V0_1-STAGE075-P1', 'IDS-STAGE075-P2-GATE'), ('IDS-V0_1-STAGE075-P2', 'IDS-STAGE075-P3-GATE'), ('IDS-V0_1-STAGE075-P3', 'IDS-STAGE075-P4-GATE'), ('IDS-V0_1-STAGE075-P4', 'IDS-STAGE075-REVIEW-GATE'),
            ),
        )
        self.assertIn(
            plan["phase"],
