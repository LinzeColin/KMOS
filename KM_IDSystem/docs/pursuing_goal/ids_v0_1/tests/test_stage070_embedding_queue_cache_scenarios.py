...
PHASE2_SLICE = BASE / "embedding_queue_cache" / "stage070_embedding_queue_cache_slice.py"
CONTRACT = (
    BASE / "embedding_queue_cache" / "stage070_embedding_queue_cache_scenarios_contract.json"
)
SCENARIOS = BASE / "embedding_queue_cache" / "stage070_embedding_queue_cache_scenarios.py"
SCOPE = BASE / "STAGE070_PHASE3_EMBEDDING_QUEUE_CACHE_CONTROLLED_SCENARIOS.md"
...
RUN = ROOT / "machine" / "runs" / "2026-08-15-stage070-p3-local.json"


class Stage070EmbeddingQueueCachePhase3Tests(unittest.TestCase):
    def _module(self):
        spec = importlib.util.spec_from_file_location(
            "stage070_embedding_queue_cache_scenarios", SCENARIOS
        )
    ...
    def _report(self):
        return self._module().build_embedding_queue_cache_phase3_report()
    ...
    def test_contract_is_executable_and_keeps_real_runtime_closed(self):
        ...
        self.assertEqual(
            "ids.stage070.embedding_queue_cache.phase3.v1", contract["schema_version"]
        )
        self.assertEqual("IDS-V0_1-STAGE070-P3", contract["task_id"])
        self.assertTrue(contract["scenario_executable"])
        self.assertFalse(contract["execution_ready"])
        self.assertEqual("IDS-STAGE070-P4-GATE", contract["next_gate"])
        ...
        self.assertEqual(5, replay["embedding_queue_record_count"])
        self.assertEqual(5, replay["cache_record_count"])
        self.assertEqual(5, replay["failed_retry_record_count"])
        ...
        self.assertEqual(29, scenarios["field_count"])
    ...
    def test_scenario_report_passes_all_taskpack_cases(self):
        ...
        self.assertTrue(report["payload_boundaries_preserved"])
        ...
        for scenario in report["scenario_results"]:
            with self.subTest(scenario=scenario["scenario_id"]):
                ...
                self.assertTrue(
                    scenario["referenced_policy_resolution_ref"].startswith(
                        "policy-resolution:control:"
                    )
                )
                self.assertTrue(
                    scenario["referenced_external_api_audit_ref"].startswith(
                        "external-api-audit:control:"
                    )
                )

    def test_denied_never_forms_an_external_payload_or_stateful_work(self):
        ...
        self.assertEqual(
            "NO_CONTROL_PAYLOAD_REFERENCE", scenario["observed_control_payload_scope"]
        )
        self.assertEqual("CONTROL_QUEUE_BLOCKED_POLICY_DENIED", scenario["observed_queue_state"])
        self.assertEqual(
            "CONTROL_CACHE_BLOCKED_POLICY_DENIED", scenario["observed_cache_disposition"]
        )
        self.assertEqual("CONTROL_RETRY_BLOCKED_POLICY_DENIED", scenario["observed_retry_state"])
    ...
    def test_full_text_and_budget_pause_keep_distinct_boundaries(self):
        ...
        self.assertEqual(
            ...
            budget_pause["observed_cache_disposition"],
        )
        self.assertEqual(
            "CONTROL_RETRY_PAUSED_BUDGET_INSUFFICIENT",
            budget_pause["observed_retry_state"],
        )
    ...
    def test_invalid_phase2_result_fails_closed(self):
        module = self._module()
        report = module.build_embedding_queue_cache_phase3_report(
    ...
    def test_no_runtime_side_effect_or_payload_content_is_created(self):
        ...
        self.assertFalse(report["embedding_queue_cache_scenario_can_replace_source_document"])
    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertTrue(
            all(
                any("一" <= character <= "鿿" for character in message)
        ...
        self.assertIn(
            ...
            (
                ...
                ("IDS-V0_1-STAGE073-P1", "IDS-STAGE073-P2-GATE"), ("IDS-V0_1-STAGE073-P2", "IDS-STAGE073-P3-GATE"), ('IDS-V0_1-STAGE073-P3', 'IDS-STAGE073-P4-GATE'), ('IDS-V0_1-STAGE073-P4', 'IDS-STAGE073-REVIEW-GATE'), ("IDS-V0_1-STAGE073-REVIEW", "IDS-STAGE074-P1-GATE"),
                ("IDS-V0_1-STAGE074-P1", "IDS-STAGE074-P2-GATE"), ("IDS-V0_1-STAGE074-P2", "IDS-STAGE074-P3-GATE"), ("IDS-V0_1-STAGE074-P3", "IDS-STAGE074-P4-GATE"), ("IDS-V0_1-STAGE074-P4", "IDS-STAGE074-REVIEW-GATE"), ("IDS-V0_1-STAGE074-REVIEW", "IDS-STAGE075-P1-GATE"),
                ('IDS-V0_1-STAGE075-P1', 'IDS-STAGE075-P2-GATE'), ('IDS-V0_1-STAGE075-P2', 'IDS-STAGE075-P3-GATE'), ('IDS-V0_1-STAGE075-P3', 'IDS-STAGE075-P4-GATE'), ('IDS-V0_1-STAGE075-P4', 'IDS-STAGE075-REVIEW-GATE'), ('IDS-V0_1-STAGE075-REVIEW', 'IDS-STAGE076-P1-GATE'), ('IDS-V0_1-STAGE076-P1', 'IDS-STAGE076-P2-GATE'), ('IDS-V0_1-STAGE076-P2', 'IDS-STAGE076-P3-GATE'), ('IDS-V0_1-STAGE076-P3', 'IDS-STAGE076-P4-GATE'),
                ('IDS-V0_1-STAGE076-P4', 'IDS-STAGE076-REVIEW-GATE'), ('IDS-V0_1-STAGE076-REVIEW', 'IDS-STAGE077-P1-GATE'),
                ('IDS-V0_1-STAGE076-P4', 'IDS-STAGE076-REVIEW-GATE'), ('IDS-V0_1-STAGE076-REVIEW', 'IDS-STAGE077-P1-GATE'),

                ('IDS-V0_1-STAGE077-P1', 'IDS-STAGE077-P2-GATE'),
                ('IDS-V0_1-STAGE077-P2', 'IDS-STAGE077-P3-GATE'), ('IDS-V0_1-STAGE077-P3', 'IDS-STAGE077-P4-GATE'), ('IDS-V0_1-STAGE077-P4', 'IDS-STAGE077-REVIEW-GATE'), ('IDS-V0_1-STAGE077-REVIEW', 'IDS-STAGE078-P1-GATE'), ('IDS-V0_1-STAGE078-P1', 'IDS-STAGE078-P2-GATE'), ('IDS-V0_1-STAGE078-P2', 'IDS-STAGE078-P3-GATE'), ('IDS-V0_1-STAGE078-P3', 'IDS-STAGE078-P4-GATE'), ('IDS-V0_1-STAGE078-P4', 'IDS-STAGE078-REVIEW-GATE'), ('IDS-STAGE078-REVIEW', 'IDS-STAGE079-P1-GATE'),
                ("IDS-V0_1-STAGE079-P1", "IDS-STAGE079-P2-GATE"), ("IDS-V0_1-STAGE079-P2", "IDS-STAGE079-P3-GATE"), ("IDS-V0_1-STAGE079-P3", "IDS-STAGE079-P4-GATE"), ("IDS-V0_1-STAGE079-P4", "IDS-STAGE079-REVIEW-GATE"),
                ...
                ("IDS-STAGE082-P2", "IDS-STAGE082-P3-GATE"), ("IDS-STAGE082-P3", "IDS-STAGE082-P4-GATE"), ("IDS-STAGE082-P4", "IDS-STAGE082-REVIEW-GATE"), ("IDS-STAGE082-REVIEW", "IDS-STAGE083-P1-GATE"), ("IDS-STAGE083-P1", "IDS-STAGE083-P2-GATE"), ("IDS-STAGE083-P2", "IDS-STAGE083-P3-GATE"), ("IDS-STAGE083-P3", "IDS-STAGE083-P4-GATE"), ("IDS-STAGE083-P4", "IDS-STAGE083-REVIEW-GATE"), ("IDS-STAGE083-REVIEW", "IDS-STAGE084-P1-GATE"), ("IDS-STAGE084-P1", "IDS-STAGE084-P2-GATE"), ("IDS-STAGE084-P2", "IDS-STAGE084-P3-GATE"), ('IDS-STAGE084-P3', 'IDS-STAGE084-P4-GATE'), ('IDS-STAGE084-P4', 'IDS-STAGE084-REVIEW-GATE'),
                    ('IDS-STAGE084-REVIEW', 'IDS-STAGE085-P3-GATE'),

                ('IDS-STAGE085-P2', 'IDS-STAGE085-P3-GATE'),
             ("IDS-STAGE085-P3", "IDS-STAGE085-P4-GATE"),
             ("IDS-STAGE085-P4", "IDS-STAGE085-REVIEW-GATE"), ("IDS-STAGE085-REVIEW", "IDS-STAGE086-P1-GATE"), ("IDS-STAGE086-P1", "IDS-STAGE086-P2-GATE"), ('IDS-STAGE086-P2', 'IDS-STAGE086-P3-GATE'), ('IDS-STAGE086-P3', 'IDS-STAGE086-P4-GATE'), ('IDS-STAGE086-P4', 'IDS-STAGE086-REVIEW-GATE'), ('IDS-STAGE086-REVIEW', 'IDS-STAGE087-P1-GATE'), ("IDS-STAGE087-P1", "IDS-STAGE087-P2-GATE")),
        )
        self.assertIn(
            plan["phase"],
            (
            ...
            , "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2", "IDS-V0_1-STAGE078-P3", "IDS-V0_1-STAGE078-P4", "IDS-STAGE078-REVIEW",
                ...
                'IDS-STAGE085-P2',
             "IDS-STAGE085-P3", "IDS-STAGE085-P4", "IDS-STAGE085-REVIEW", "IDS-STAGE086-P1", 'IDS-STAGE086-P2', 'IDS-STAGE086-P3', 'IDS-STAGE086-P4', 'IDS-STAGE086-REVIEW', "IDS-STAGE087-P1"),
        )
        self.assertTrue(
            (
"IDS-STAGE070-P4-GATE" in plan["stop_condition"]
        ...
        self.assertEqual("RUN-IDS-STAGE070-P3-LOCAL-20260815-001", run["run_id"])
        self.assertEqual("IDS-V0_1-STAGE070-P3", run["task_id"])
        self.assertEqual("IDS-STAGE070-P4-GATE", run["next_gate"])
        ...
        self.assertIn("stage070_phase3", BATCH.read_text(encoding="utf-8"))
        self.assertIn("IDS-V0_1-STAGE070-P3", ROADMAP.read_text(encoding="utf-8"))
        self.assertTrue(
            any(
                item.get("event_id") == "EVT-IDS-V0_1-STAGE070-P3-20260815-001"
                for item in events
            )
        )
