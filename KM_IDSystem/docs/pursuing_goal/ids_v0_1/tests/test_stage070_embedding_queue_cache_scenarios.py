    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertIn(
            ...
            (
             ...
             ("IDS-STAGE085-P4", "IDS-STAGE085-REVIEW-GATE"), ("IDS-STAGE085-REVIEW", "IDS-STAGE086-P1-GATE"), ("IDS-STAGE086-P1", "IDS-STAGE086-P2-GATE"), ('IDS-STAGE086-P2', 'IDS-STAGE086-P3-GATE'), ('IDS-STAGE086-P3', 'IDS-STAGE086-P4-GATE'), ('IDS-STAGE086-P4', 'IDS-STAGE086-REVIEW-GATE')),
        )
        self.assertIn(
            plan["phase"],
            (
            ...
            , "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2", "IDS-V0_1-STAGE078-P3", "IDS-V0_1-STAGE078-P4", "IDS-STAGE078-REVIEW",
                ...
                'IDS-STAGE085-P2',
             "IDS-STAGE085-P3", "IDS-STAGE085-P4", "IDS-STAGE085-REVIEW", "IDS-STAGE086-P1", 'IDS-STAGE086-P2', 'IDS-STAGE086-P3', 'IDS-STAGE086-P4'),
        )
        self.assertTrue(
            (
