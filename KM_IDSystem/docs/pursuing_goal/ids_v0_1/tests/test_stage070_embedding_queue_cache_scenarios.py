    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ("IDS-V0_1-STAGE074-P1", "IDS-STAGE074-P2-GATE"),
            ),
        )
        self.assertIn(
            plan["phase"],
            (
                ...
                "IDS-V0_1-STAGE072-P2", "IDS-V0_1-STAGE072-P3", "IDS-V0_1-STAGE072-P4", "IDS-V0_1-STAGE072-REVIEW", "IDS-V0_1-STAGE073-P1", "IDS-V0_1-STAGE073-P2", "IDS-V0_1-STAGE073-P3", "IDS-V0_1-STAGE073-P4", "IDS-V0_1-STAGE073-REVIEW", "IDS-V0_1-STAGE074-P1"),
        )
        self.assertTrue(
            ...
            or "IDS-STAGE072-P2-GATE" in plan["stop_condition"]
               ...
               or "IDS-STAGE073-P2-GATE" in plan["stop_condition"] or "IDS-STAGE073-P3-GATE" in plan["stop_condition"] or "IDS-STAGE073-P4-GATE" in plan["stop_condition"] or "IDS-STAGE073-REVIEW-GATE" in plan["stop_condition"] or "IDS-STAGE074-P1-GATE" in plan["stop_condition"] or "IDS-STAGE074-P2-GATE" in plan["stop_condition"]
        )
        self.assertTrue(
            {
                "ACC-STAGE070-P3-01",
