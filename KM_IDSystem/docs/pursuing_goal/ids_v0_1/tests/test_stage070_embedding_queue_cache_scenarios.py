    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ('IDS-V0_1-STAGE080-P2', 'IDS-STAGE080-P3-GATE'), ('IDS-V0_1-STAGE080-P3', 'IDS-STAGE080-P4-GATE'), ('IDS-V0_1-STAGE080-P4', 'IDS-STAGE080-REVIEW-GATE'), ('IDS-STAGE080-REVIEW', 'IDS-STAGE081-P1-GATE'), ("IDS-STAGE081-P1", "IDS-STAGE081-P2-GATE"), ("IDS-STAGE081-P2", "IDS-STAGE081-P3-GATE"), ("IDS-STAGE081-P3", "IDS-STAGE081-P4-GATE")),
        )
        self.assertIn(
            plan["phase"],
            (
            ...
            , "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2", "IDS-V0_1-STAGE078-P3", "IDS-V0_1-STAGE078-P4", "IDS-STAGE078-REVIEW",
                ...
                'IDS-V0_1-STAGE080-P3', 'IDS-V0_1-STAGE080-P4', 'IDS-STAGE080-REVIEW', 'IDS-STAGE081-P1', 'IDS-STAGE081-P2', 'IDS-STAGE081-P3'),
        )
        self.assertTrue(
            (
