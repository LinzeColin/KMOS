    ...
    def test_chinese_feedback_and_current_governance_preserve_phase3_evidence(self):
        ...
        self.assertIn(
            ...
            (
                ...
                ("IDS-STAGE082-P2", "IDS-STAGE082-P3-GATE"), ("IDS-STAGE082-P3", "IDS-STAGE082-P4-GATE"), ("IDS-STAGE082-P4", "IDS-STAGE082-REVIEW-GATE"), ("IDS-STAGE082-REVIEW", "IDS-STAGE083-P1-GATE"), ("IDS-STAGE083-P1", "IDS-STAGE083-P2-GATE")),
        )
        self.assertIn(
            plan["phase"],
            (
            ...
            , "IDS-V0_1-STAGE078-P1", "IDS-V0_1-STAGE078-P2", "IDS-V0_1-STAGE078-P3", "IDS-V0_1-STAGE078-P4", "IDS-STAGE078-REVIEW",
                ...
                'IDS-STAGE082-P2',
                'IDS-STAGE082-P3', 'IDS-STAGE082-P4', "IDS-STAGE082-REVIEW", "IDS-STAGE083-P1"),
        )
        self.assertTrue(
            (
