...
class Stage096ReviewTests(unittest.TestCase):
    ...
    def test_governance_projection_records_review_when_current(self) -> None:
        ...
        self.assertIn(
            current,
            (phase4_current, review_current, stage097_phase1_current, stage097_phase2_current),
        )
        if current in (review_current, stage097_phase1_current, stage097_phase2_current):
