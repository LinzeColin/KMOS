...
class Stage038WorkerQueuePhase3ScenarioTests(unittest.TestCase):
    ...
    def test_phase3_docs_and_event_remain_valid_after_phase4_closeout(self):
        ...
        self.assertTrue(
            ...
            or roadmap["next_gate_id"] == "IDS-STAGE043-P1-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE043-P2-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE043-P3-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE043-P4-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE043-REVIEW-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE044-P1-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE044-P2-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE044-P3-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE044-P4-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE044-REVIEW-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE045-P1-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE045-P2-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE045-P3-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE045-P4-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE045-REVIEW-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE046-P1-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE046-P2-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE046-P3-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE046-P4-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE046-REVIEW-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE047-P1-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE047-P2-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE047-P3-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE047-P4-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE047-REVIEW-GATE"
            or roadmap["next_gate_id"] == "IDS-STAGE048-P1-GATE"
