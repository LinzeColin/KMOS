...
class Stage058TableSchemaInferenceStageReviewTests(unittest.TestCase):
    ...
    def test_governance_closes_stage058_only_to_a_separate_stage059_run(self):
        ...
        self.assertIn(
            status["phase"],
            ("IDS-V0_1-STAGE058-REVIEW", "IDS-V0_1-STAGE059-P1", "IDS-V0_1-STAGE059-P2", "IDS-V0_1-STAGE059-P3", "IDS-V0_1-STAGE059-P4"),
        )
        self.assertIn(
            status["task"],
            ("IDS-V0_1-STAGE058-REVIEW", "IDS-V0_1-STAGE059-P1", "IDS-V0_1-STAGE059-P2", "IDS-V0_1-STAGE059-P3", "IDS-V0_1-STAGE059-P4"),
        ...
        self.assertIn(
            status["next_gate"],
            ("IDS-STAGE059-P1-GATE", "IDS-STAGE059-P2-GATE", "IDS-STAGE059-P3-GATE", "IDS-STAGE059-P4-GATE", "IDS-STAGE059-REVIEW-GATE"),
        )
