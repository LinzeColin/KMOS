...
class Stage063ChapterAwareChunkingPhase2Tests(unittest.TestCase):
    ...
    def test_current_governance_preserves_phase2_evidence_or_legal_phase3_successor(self):
        ...
        self.assertIn(plan["phase"], ("IDS-V0_1-STAGE063-P2", "IDS-V0_1-STAGE063-P3", "IDS-V0_1-STAGE063-P4"))
        self.assertIn(plan["task"], ("IDS-V0_1-STAGE063-P2", "IDS-V0_1-STAGE063-P3", "IDS-V0_1-STAGE063-P4"))
        self.assertTrue(
