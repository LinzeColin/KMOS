...
class Stage073EmbeddingAuditTestPhase4Tests(unittest.TestCase):
    ...
    def test_current_machine_and_governance_projection_match_p4(self):
        ...
        self.assertTrue(
            ...
            or "IDS-V0_1-STAGE085-P1" in plan["now"]
        )
        self.assertTrue(
        ...
        self.assertTrue(
            ...
            or 'current_phase_id: "IDS-STAGE085-P1"' in roadmap_text
        )
        self.assertTrue(
            ...
            or 'current_task_id: "IDS-V0_1-STAGE085-P1"' in roadmap_text
        )
        self.assertTrue(
            ...
            or 'next_gate_id: "IDS-STAGE085-P2-GATE"' in roadmap_text
        )
