...
class Stage073EmbeddingAuditTestPhase4Tests(unittest.TestCase):
    ...
    def test_current_machine_and_governance_projection_match_p4(self):
        ...
        self.assertTrue(
            ...
            or "IDS-V0_1-STAGE083-REVIEW" in plan["now"]
            or "IDS-V0_1-STAGE084-P1" in plan["now"]
            or 'IDS-V0_1-STAGE084-P2' in plan['now']
            or 'IDS-V0_1-STAGE084-P3' in plan['now']
            or 'IDS-V0_1-STAGE084-P4' in plan['now']
            or "IDS-V0_1-STAGE084-REVIEW" in plan["now"]
            or "IDS-V0_1-STAGE085-P2" in plan["now"]
            or "IDS-V0_1-STAGE085-P3" in plan["now"]
            or "IDS-V0_1-STAGE085-P4" in plan["now"]
            or "IDS-V0_1-STAGE085-REVIEW" in plan["now"]
            or "IDS-V0_1-STAGE086-P1" in plan["now"]
            or "IDS-V0_1-STAGE086-P2" in plan["now"]
            or "IDS-V0_1-STAGE086-P3" in plan["now"] or "IDS-V0_1-STAGE086-P4" in plan["now"]
        )
        self.assertTrue(
            ...
            or "IDS-V0_1-STAGE085-P2" in "\n".join(plan["scope"])
            or "IDS-V0_1-STAGE085-P3" in "\n".join(plan["scope"])
            or "IDS-V0_1-STAGE085-P4" in "\n".join(plan["scope"])
        )
        ...
        self.assertTrue(
            ...
            or 'current_phase_id: "IDS-STAGE084-P1"' in roadmap_text
            or 'current_phase_id: "IDS-STAGE084-P4"' in roadmap_text
            or 'current_phase_id: "IDS-STAGE085-P2"' in roadmap_text
            or 'current_phase_id: "IDS-STAGE085-P3"' in roadmap_text
            or 'current_phase_id: "IDS-STAGE085-P4"' in roadmap_text
            or 'current_phase_id: "IDS-STAGE085-REVIEW"' in roadmap_text
        )
        self.assertTrue(
            ...
            or 'current_task_id: "IDS-V0_1-STAGE084-P1"' in roadmap_text
            or 'current_task_id: "IDS-V0_1-STAGE084-P4"' in roadmap_text
            or 'current_task_id: "IDS-V0_1-STAGE085-P2"' in roadmap_text
            or 'current_task_id: "IDS-V0_1-STAGE085-P3"' in roadmap_text
            or 'current_task_id: "IDS-V0_1-STAGE085-P4"' in roadmap_text
            or 'current_task_id: "IDS-V0_1-STAGE085-REVIEW"' in roadmap_text
        )
        self.assertTrue(
            ...
            or 'next_gate_id: "IDS-STAGE084-P2-GATE"' in roadmap_text
            or 'next_gate_id: "IDS-STAGE084-REVIEW-GATE"' in roadmap_text
            or 'next_gate_id: "IDS-STAGE085-P3-GATE"' in roadmap_text
            or 'next_gate_id: "IDS-STAGE085-P4-GATE"' in roadmap_text
            or 'next_gate_id: "IDS-STAGE085-REVIEW-GATE"' in roadmap_text
            or 'next_gate_id: "IDS-STAGE086-P1-GATE"' in roadmap_text
        )
