    ...
    def test_phase4_history_is_preserved_after_whole_stage_review(self):
        ...
        self.assertTrue(
            ...
            or (
                ...
                and "IDS-V0_1-STAGE045-P2" in handoff
                and "IDS-V0_1-STAGE045-P3" in handoff
            )
            or (
