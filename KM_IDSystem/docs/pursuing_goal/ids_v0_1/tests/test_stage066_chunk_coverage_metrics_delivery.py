...
class Stage066ChunkCoverageMetricsPhase4Tests(unittest.TestCase):
    ...
    def test_governance_projection_records_phase4_local_only(self):
        ...
        self.assertIn(
            status["next_gate"],
            ("IDS-STAGE066-REVIEW-GATE", "IDS-STAGE067-P1-GATE", "IDS-STAGE067-P2-GATE", "IDS-STAGE067-P3-GATE", "IDS-STAGE067-P4-GATE", "IDS-STAGE067-REVIEW-GATE", "IDS-STAGE068-P1-GATE", "IDS-STAGE068-P2-GATE", "IDS-STAGE068-P3-GATE", "IDS-STAGE068-P4-GATE"),
        )
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertIn(
            plan["phase"],
            ("IDS-V0_1-STAGE066-P4", "IDS-V0_1-STAGE066-REVIEW", "IDS-V0_1-STAGE067-P1", "IDS-V0_1-STAGE067-P2", "IDS-V0_1-STAGE067-P3", "IDS-V0_1-STAGE067-P4", "IDS-V0_1-STAGE067-REVIEW", "IDS-V0_1-STAGE068-P1", "IDS-V0_1-STAGE068-P2", "IDS-V0_1-STAGE068-P3"),
        )
        self.assertTrue(
