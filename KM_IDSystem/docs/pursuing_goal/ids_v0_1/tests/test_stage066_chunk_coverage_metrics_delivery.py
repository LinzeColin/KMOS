...
"IDS-STAGE071-P4-GATE",
            ...
            'IDS-STAGE077-P3-GATE', 'IDS-STAGE077-P4-GATE', 'IDS-STAGE077-REVIEW-GATE', 'IDS-STAGE078-P1-GATE',
             "IDS-STAGE078-P2-GATE", "IDS-STAGE078-P3-GATE", "IDS-STAGE078-P4-GATE", "IDS-STAGE078-REVIEW-GATE", 'IDS-STAGE079-P1-GATE',
                ...
                'IDS-STAGE085-P3-GATE',
             "IDS-STAGE085-P4-GATE", "IDS-STAGE085-REVIEW-GATE", "IDS-STAGE086-P1-GATE", "IDS-STAGE086-P2-GATE", 'IDS-STAGE086-P3-GATE', 'IDS-STAGE086-P4-GATE', 'IDS-STAGE086-REVIEW-GATE', 'IDS-STAGE087-P1-GATE', "IDS-STAGE087-P2-GATE"),
        )
...
("IDS-STAGE066-REVIEW-GATE" in plan["stop_condition"]
        ...
        self.assertTrue(
            ...
            or 'status: "stage067_phase1_completed_local"' in BATCH.read_text(encoding="utf-8")
            or 'status: "stage067_completed_reviewed_local"' in BATCH.read_text(encoding="utf-8")
        )
