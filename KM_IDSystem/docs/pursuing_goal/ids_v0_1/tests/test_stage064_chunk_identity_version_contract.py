...
class Stage064ChunkIdentityVersionPhase1Tests(unittest.TestCase):
    ...
    def test_governance_records_phase1_and_preserves_local_only_boundary(self):
        ...
        self.assertIn(status["stage"], ("IDS-STAGE064", "IDS-STAGE065", "IDS-STAGE066", "IDS-STAGE067"))
        self.assertIn(
        ...
        self.assertIn(plan["stage"], ("IDS-STAGE064", "IDS-STAGE065", "IDS-STAGE066", "IDS-STAGE067"))
        self.assertIn(
        ...
        self.assertTrue(
            ...
            or ("IDS-STAGE067-P2-GATE" in plan["stop_condition"] or "IDS-STAGE067-P3-GATE" in plan["stop_condition"] or "IDS-STAGE067-P4-GATE" in plan["stop_condition"] or "IDS-STAGE067-REVIEW-GATE" in plan["stop_condition"])
        )
