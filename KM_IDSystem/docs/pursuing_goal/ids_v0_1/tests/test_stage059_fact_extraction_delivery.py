...
class Stage059FactExtractionPhase4DeliveryTests(unittest.TestCase):
    ...
    def test_governance_and_local_run_preserve_phase4(self):
        ...
        self.assertIn(
            status["phase"],
            ("IDS-V0_1-STAGE059-P4", "IDS-V0_1-STAGE059-REVIEW", "IDS-V0_1-STAGE060-P1", "IDS-V0_1-STAGE060-P2"),
        )
        self.assertIn(
            status["next_gate"],
            ("IDS-STAGE059-REVIEW-GATE", "IDS-STAGE060-P1-GATE", "IDS-STAGE060-P2-GATE", "IDS-STAGE060-P3-GATE"),
        )
