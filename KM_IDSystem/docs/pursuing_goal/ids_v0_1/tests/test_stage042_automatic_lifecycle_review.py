...
class Stage042AutomaticLifecycleStageReviewTests(unittest.TestCase):
    ...
    def test_governance_closes_stage_only_to_stage043_separate_run(self):
        ...
        self.assertTrue(
            ...
            or (
                "Completed task in this run: `IDS-V0_1-STAGE045-P3`"
                in handoff_top
                and "Next allowed task: `IDS-V0_1-STAGE045-P4`"
                in handoff_top
            )
            or (
                "Completed task in this run: `IDS-V0_1-STAGE045-P4`"
                in handoff_top
                and "Next allowed task: `IDS-V0_1-STAGE045-REVIEW`"
                in handoff_top
            )
            or (
            ...
            or (
                ...
                in handoff_top
                and "Next allowed task: `IDS-V0_1-STAGE048-P1`"
                in handoff_top
            )
        )
        ...
        self.assertTrue(
            ...
            or "`STAGE-041..STAGE-046` are locally reviewed" in staged_head
            or "`STAGE-041..STAGE-047` are locally reviewed" in staged_head,
            staged_head,
        )
        self.assertTrue(
            ...
            or "Current task: `IDS-V0_1-STAGE047-P3`" in staged_head
            or "Current task: `IDS-V0_1-STAGE047-P4`" in staged_head
            or "Current task: `IDS-V0_1-STAGE047-REVIEW`" in staged_head
        )
