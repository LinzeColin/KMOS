...
class Stage059FactExtractionContractPhase1Tests(unittest.TestCase):
    ...
    def test_governance_run_and_event_record_only_local_phase1_evidence(self):
        ...
        self.assertIn(
            status["phase"],
            ("IDS-V0_1-STAGE059-P1", "IDS-V0_1-STAGE059-P2", "IDS-V0_1-STAGE059-P3", "IDS-V0_1-STAGE059-P4", "IDS-V0_1-STAGE059-REVIEW", "IDS-V0_1-STAGE060-P1", "IDS-V0_1-STAGE060-P2", "IDS-V0_1-STAGE060-P3", "IDS-V0_1-STAGE060-P4"),
        )
        self.assertIn(
            status["task"],
            ("IDS-V0_1-STAGE059-P1", "IDS-V0_1-STAGE059-P2", "IDS-V0_1-STAGE059-P3", "IDS-V0_1-STAGE059-P4", "IDS-V0_1-STAGE059-REVIEW", "IDS-V0_1-STAGE060-P1", "IDS-V0_1-STAGE060-P2", "IDS-V0_1-STAGE060-P3", "IDS-V0_1-STAGE060-P4"),
        ...
        self.assertIn(
            status["next_gate"],
            ("IDS-STAGE059-P2-GATE", "IDS-STAGE059-P3-GATE", "IDS-STAGE059-P4-GATE", "IDS-STAGE059-REVIEW-GATE", "IDS-STAGE060-P1-GATE", "IDS-STAGE060-P2-GATE", "IDS-STAGE060-P3-GATE", "IDS-STAGE060-P4-GATE", "IDS-STAGE060-REVIEW-GATE"),
        )
