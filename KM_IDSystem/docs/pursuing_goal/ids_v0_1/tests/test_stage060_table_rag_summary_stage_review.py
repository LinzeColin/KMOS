    ...
    def test_governance_closes_stage060_and_allows_only_its_legal_successor(self):
        ...
        legal_stage072_phase4_successor = (
            ...
            in (
                ...
                ("IDS-V0_1-STAGE074-P1", "IDS-V0_1-STAGE074-P1", "IDS-STAGE074-P2-GATE"), ("IDS-V0_1-STAGE074-P2", "IDS-V0_1-STAGE074-P2", "IDS-STAGE074-P3-GATE"), ("IDS-V0_1-STAGE074-P3", "IDS-V0_1-STAGE074-P3", "IDS-STAGE074-P4-GATE"),
            )
        )
