...
class Stage071EmbeddingCostGovernorPhase1Tests(unittest.TestCase):
    ...
    def test_governance_projection_preserves_phase1_evidence_after_phase2(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE071-P2", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE071-P2", status["task"])
        self.assertEqual("IDS-STAGE071-P3-GATE", status["next_gate"])
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertEqual("IDS-V0_1-STAGE071-P2", plan["task"])
        ...
        self.assertIn('current_task_id: "IDS-V0_1-STAGE071-P2"', roadmap_text)
