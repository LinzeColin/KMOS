...
class Stage071EmbeddingCostGovernorPhase1Tests(unittest.TestCase):
    ...
    def test_governance_projection_preserves_phase1_evidence(self):
        ...
        self.assertEqual("IDS-V0_1-STAGE071-P1", status["phase"])
        self.assertEqual("IDS-V0_1-STAGE071-P1", status["task"])
        self.assertEqual("IDS-STAGE071-P2-GATE", status["next_gate"])
        self.assertFalse(status["runtime_enabled"])
        self.assertFalse(status["push_allowed"])
        self.assertEqual("IDS-V0_1-STAGE071-P1", plan["task"])
        ...
        self.assertIn('current_task_id: "IDS-V0_1-STAGE071-P1"', roadmap_text)
